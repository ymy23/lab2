...
main()
{
  ...
  scheduler();        
    ...
    8000040a:	5a8080e7          	jalr	1448(ra) # 800029ae <iinit>
    fileinit();      // file table
    8000040e:	00003097          	auipc	ra,0x3
    80000412:	5fa080e7          	jalr	1530(ra) # 80003a08 <fileinit>
    virtio_disk_init(); // emulated hard disk
...
forkret(void)
{
  ...
  usertrapret();
    ...
    80000ecc:	a66080e7          	jalr	-1434(ra) # 8000292e <fsinit>
...
000000008000105e <allocproc>:
{
  ...
  return p;
    ...
    8000110c:	330080e7          	jalr	816(ra) # 80006438 <release>
    return 0;
    ...
    80001124:	318080e7          	jalr	792(ra) # 80006438 <release>
    return 0;
...
000000008000112c <userinit>:
{
  ...
  p->cwd = namei("/");
    ...
    8000118e:	27a080e7          	jalr	634(ra) # 80003404 <namei>
  ...
  release(&p->lock);
    ...
    800011a0:	29c080e7          	jalr	668(ra) # 80006438 <release>
}
...
000000008000120a <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  for(i = 0; i < NOFILE; i++)
    ...
    800012a6:	196080e7          	jalr	406(ra) # 80006438 <release>
    return -1;
  ...
  for(i = 0; i < NOFILE; i++)
    ...
    800012be:	7e0080e7          	jalr	2016(ra) # 80003a9a <filedup>
  ...
  np->cwd = idup(p->cwd);
    ...
    800012d0:	8a2080e7          	jalr	-1886(ra) # 80002b6e <idup>
  ...
  release(&np->lock);
    ...
    800012f4:	148080e7          	jalr	328(ra) # 80006438 <release>
  acquire(&wait_lock);
    ...
    80001306:	082080e7          	jalr	130(ra) # 80006384 <acquire>
  np->parent = p;
    8000130a:	035a3c23          	sd	s5,56(s4)
  release(&wait_lock);
    8000130e:	8526                	mv	a0,s1
    80001310:	00005097          	auipc	ra,0x5
    80001314:	128080e7          	jalr	296(ra) # 80006438 <release>
  acquire(&np->lock);
    80001318:	8552                	mv	a0,s4
    8000131a:	00005097          	auipc	ra,0x5
    8000131e:	06a080e7          	jalr	106(ra) # 80006384 <acquire>
  np->state = RUNNABLE;
  ...
  release(&np->lock);
    ...
    8000132e:	10e080e7          	jalr	270(ra) # 80006438 <release>
}
...
000000008000134a <scheduler>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    800013b2:	08a080e7          	jalr	138(ra) # 80006438 <release>
    for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800013c4:	fc4080e7          	jalr	-60(ra) # 80006384 <acquire>
      if(p->state == RUNNABLE) {
...
00000000800013ea <sched>:
{
  ...
  if(!holding(&p->lock))
    ...
    80001406:	f08080e7          	jalr	-248(ra) # 8000630a <holding>
...
00000000800014c0 <yield>:
{
  ...
  acquire(&p->lock);
    ...
    800014d8:	eb0080e7          	jalr	-336(ra) # 80006384 <acquire>
  p->state = RUNNABLE;
  ...
  release(&p->lock);
    ...
    800014ee:	f4e080e7          	jalr	-178(ra) # 80006438 <release>
}
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  acquire(&p->lock);  //DOC: sleeplock1
    ...
    8000151c:	e6c080e7          	jalr	-404(ra) # 80006384 <acquire>
  release(lk);
    80001520:	854a                	mv	a0,s2
    80001522:	00005097          	auipc	ra,0x5
    80001526:	f16080e7          	jalr	-234(ra) # 80006438 <release>
  ...
  release(&p->lock);
    ...
    80001544:	ef8080e7          	jalr	-264(ra) # 80006438 <release>
  acquire(lk);
    80001548:	854a                	mv	a0,s2
    8000154a:	00005097          	auipc	ra,0x5
    8000154e:	e3a080e7          	jalr	-454(ra) # 80006384 <acquire>
}
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001590:	eac080e7          	jalr	-340(ra) # 80006438 <release>
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800015ae:	dda080e7          	jalr	-550(ra) # 80006384 <acquire>
      if(p->state == SLEEPING && p->chan == chan) {
...
0000000080001630 <exit>:
{
  ...
  if(p == initproc)
    ...
    8000166c:	7e4080e7          	jalr	2020(ra) # 80005e4c <panic>
      fileclose(f);
    80001670:	00002097          	auipc	ra,0x2
    80001674:	47c080e7          	jalr	1148(ra) # 80003aec <fileclose>
      p->ofile[fd] = 0;
  ...
  begin_op();
    ...
    8000168c:	f9c080e7          	jalr	-100(ra) # 80003624 <begin_op>
  iput(p->cwd);
    80001690:	1509b503          	ld	a0,336(s3)
    80001694:	00001097          	auipc	ra,0x1
    80001698:	77c080e7          	jalr	1916(ra) # 80002e10 <iput>
  end_op();
    8000169c:	00002097          	auipc	ra,0x2
    800016a0:	006080e7          	jalr	6(ra) # 800036a2 <end_op>
  p->cwd = 0;
  ...
  acquire(&wait_lock);
    ...
    800016b6:	cd2080e7          	jalr	-814(ra) # 80006384 <acquire>
  reparent(p);
  ...
  acquire(&p->lock);
    ...
    800016d6:	cb2080e7          	jalr	-846(ra) # 80006384 <acquire>
  p->xstate = status;
  ...
  release(&wait_lock);
    ...
    800016ea:	d52080e7          	jalr	-686(ra) # 80006438 <release>
  sched();
  ...
  panic("zombie exit");
    ...
    80001702:	74e080e7          	jalr	1870(ra) # 80005e4c <panic>
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    8000172c:	c5c080e7          	jalr	-932(ra) # 80006384 <acquire>
    if(p->pid == pid){
    ...
    8000173c:	d00080e7          	jalr	-768(ra) # 80006438 <release>
  for(p = proc; p < &proc[NPROC]; p++){
  ...
  return -1;
    ...
    8000176a:	cd2080e7          	jalr	-814(ra) # 80006438 <release>
      return 0;
...
setkilled(struct proc *p)
{
  ...
  acquire(&p->lock);
    ...
    80001788:	c00080e7          	jalr	-1024(ra) # 80006384 <acquire>
  p->killed = 1;
  ...
  release(&p->lock);
    ...
    80001796:	ca6080e7          	jalr	-858(ra) # 80006438 <release>
}
...
killed(struct proc *p)
{
  ...
  acquire(&p->lock);
    ...
    800017b6:	bd2080e7          	jalr	-1070(ra) # 80006384 <acquire>
  k = p->killed;
    800017ba:	0284a903          	lw	s2,40(s1)
  release(&p->lock);
    800017be:	8526                	mv	a0,s1
    800017c0:	00005097          	auipc	ra,0x5
    800017c4:	c78080e7          	jalr	-904(ra) # 80006438 <release>
  return k;
}
...
00000000800017d6 <wait>:
{
  ...
  acquire(&wait_lock);
    ...
    80001806:	b82080e7          	jalr	-1150(ra) # 80006384 <acquire>
    havekids = 0;
    ...
    800018a4:	ae4080e7          	jalr	-1308(ra) # 80006384 <acquire>
        if(pp->state == ZOMBIE){
    ...
    800018b4:	b88080e7          	jalr	-1144(ra) # 80006438 <release>
        havekids = 1;
    ...
    800018d6:	b66080e7          	jalr	-1178(ra) # 80006438 <release>
      return -1;
...
procdump(void)
{
  ...
  printf("\n");
    ...
    800019d2:	4c8080e7          	jalr	1224(ra) # 80005e96 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80001a14:	486080e7          	jalr	1158(ra) # 80005e96 <printf>
    printf("\n");
    80001a18:	8552                	mv	a0,s4
    80001a1a:	00004097          	auipc	ra,0x4
    80001a1e:	47c080e7          	jalr	1148(ra) # 80005e96 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80001ae6:	812080e7          	jalr	-2030(ra) # 800062f4 <initlock>
}
...
trapinithart(void)
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    80001afc:	78878793          	addi	a5,a5,1928 # 80005280 <kernelvec>
...
clockintr()
{
  ...
  acquire(&tickslock);
    ...
    80001bb8:	7d0080e7          	jalr	2000(ra) # 80006384 <acquire>
  ticks++;
  ...
  release(&tickslock);
    ...
    80001bd8:	864080e7          	jalr	-1948(ra) # 80006438 <release>
}
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    80001c1c:	770080e7          	jalr	1904(ra) # 80005388 <plic_claim>
...
0000000080001c88 <usertrap>:
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    80001ca2:	5e278793          	addi	a5,a5,1506 # 80005280 <kernelvec>
  ...
  if(killed(p))
    ...
    80001cec:	164080e7          	jalr	356(ra) # 80005e4c <panic>
    if(killed(p))
  ...
  asm volatile("csrr %0, scause" : "=r" (x) );
    ...
    80001d66:	134080e7          	jalr	308(ra) # 80005e96 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80001d7e:	11c080e7          	jalr	284(ra) # 80005e96 <printf>
    setkilled(p);
...
0000000080001d98 <kerneltrap>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001df2:	05e080e7          	jalr	94(ra) # 80005e4c <panic>
    ...
    80001e02:	04e080e7          	jalr	78(ra) # 80005e4c <panic>
    printf("scause %p\n", scause);
    ...
    80001e14:	086080e7          	jalr	134(ra) # 80005e96 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
...
argraw(int n)
{
  ...
  panic("argraw");
    ...
    80001ec8:	f88080e7          	jalr	-120(ra) # 80005e4c <panic>
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    80002038:	e62080e7          	jalr	-414(ra) # 80005e96 <printf>
            p->pid, p->name, num);
    p->trapframe->a0 = -1;
...
sys_sleep(void)
{
  ...
  acquire(&tickslock);
    ...
    80002148:	240080e7          	jalr	576(ra) # 80006384 <acquire>
  ticks0 = ticks;
  ...
  release(&tickslock);
    ...
    800021a2:	29a080e7          	jalr	666(ra) # 80006438 <release>
  return 0;
    ...
    800021c8:	274080e7          	jalr	628(ra) # 80006438 <release>
      return -1;
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80002210:	178080e7          	jalr	376(ra) # 80006384 <acquire>
  xticks = ticks;
  ...
  release(&tickslock);
    ...
    80002228:	214080e7          	jalr	532(ra) # 80006438 <release>
  return xticks;
}
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002260:	098080e7          	jalr	152(ra) # 800062f4 <initlock>
  ...
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    ...
    800022a4:	63e080e7          	jalr	1598(ra) # 800038de <initsleeplock>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    800022e8:	0a0080e7          	jalr	160(ra) # 80006384 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    80002328:	114080e7          	jalr	276(ra) # 80006438 <release>
      acquiresleep(&b->lock);
    8000232c:	01048513          	addi	a0,s1,16
    80002330:	00001097          	auipc	ra,0x1
    80002334:	5e8080e7          	jalr	1512(ra) # 80003918 <acquiresleep>
      return b;
  ...
  panic("bget: no buffers");
    ...
    80002366:	aea080e7          	jalr	-1302(ra) # 80005e4c <panic>
      b->dev = dev;
    ...
    80002386:	0b6080e7          	jalr	182(ra) # 80006438 <release>
      acquiresleep(&b->lock);
    8000238a:	01048513          	addi	a0,s1,16
    8000238e:	00001097          	auipc	ra,0x1
    80002392:	58a080e7          	jalr	1418(ra) # 80003918 <acquiresleep>
  struct buf *b;
  ...
  return b;
    ...
    800023b2:	294080e7          	jalr	660(ra) # 80005642 <virtio_disk_rw>
    b->valid = 1;
...
bwrite(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    ...
    800023ce:	5e8080e7          	jalr	1512(ra) # 800039b2 <holdingsleep>
  ...
  virtio_disk_rw(b, 1);
    ...
    800023dc:	26a080e7          	jalr	618(ra) # 80005642 <virtio_disk_rw>
}
    ...
    800023f6:	a5a080e7          	jalr	-1446(ra) # 80005e4c <panic>
...
brelse(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    ...
    80002412:	5a4080e7          	jalr	1444(ra) # 800039b2 <holdingsleep>
  ...
  release(&bcache.lock);
    ...
    80002478:	fc4080e7          	jalr	-60(ra) # 80006438 <release>
}
    ...
    80002494:	9bc080e7          	jalr	-1604(ra) # 80005e4c <panic>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    800024b0:	ed8080e7          	jalr	-296(ra) # 80006384 <acquire>
  b->refcnt++;
  ...
  release(&bcache.lock);
    ...
    800024c6:	f76080e7          	jalr	-138(ra) # 80006438 <release>
}
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    800024ec:	e9c080e7          	jalr	-356(ra) # 80006384 <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    80002502:	f3a080e7          	jalr	-198(ra) # 80006438 <release>
}
...
bfree(int dev, uint b)
{
  ...
  log_write(bp);
    ...
    80002562:	29c080e7          	jalr	668(ra) # 800037fa <log_write>
  brelse(bp);
    ...
    80002588:	8c8080e7          	jalr	-1848(ra) # 80005e4c <panic>
...
000000008000258c <balloc>:
{
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    800025d4:	22a080e7          	jalr	554(ra) # 800037fa <log_write>
        brelse(bp);
  ...
  log_write(bp);
    ...
    80002608:	1f6080e7          	jalr	502(ra) # 800037fa <log_write>
  brelse(bp);
  ...
  printf("balloc: out of blocks\n");
    ...
    800026b6:	7e4080e7          	jalr	2020(ra) # 80005e96 <printf>
  return 0;
...
bmap(struct inode *ip, uint bn)
{
  ...
  if(bn < NDIRECT){
    ...
    800026d4:	04b7e263          	bltu	a5,a1,80002718 <bmap+0x5a>
    ...
    800026e8:	00090c63          	beqz	s2,80002700 <bmap+0x42>
    brelse(bp);
    return addr;
  }
  ...
  panic("bmap: out of range");
    ...
    80002706:	e8a080e7          	jalr	-374(ra) # 8000258c <balloc>
    8000270a:	0005091b          	sext.w	s2,a0
      if(addr == 0)
    8000270e:	fc090fe3          	beqz	s2,800026ec <bmap+0x2e>
      ip->addrs[bn] = addr;
    80002712:	0524a823          	sw	s2,80(s1)
    80002716:	bfd9                	j	800026ec <bmap+0x2e>
  bn -= NDIRECT;
    80002718:	ff55849b          	addiw	s1,a1,-11
    8000271c:	0004871b          	sext.w	a4,s1
  if(bn < NINDIRECT){
    80002720:	0ff00793          	li	a5,255
    80002724:	06e7ec63          	bltu	a5,a4,8000279c <bmap+0xde>
    if((addr = ip->addrs[NDIRECT]) == 0){
    80002728:	07c52903          	lw	s2,124(a0)
    8000272c:	00091d63          	bnez	s2,80002746 <bmap+0x88>
      addr = balloc(ip->dev);
    80002730:	4108                	lw	a0,0(a0)
    80002732:	00000097          	auipc	ra,0x0
    80002736:	e5a080e7          	jalr	-422(ra) # 8000258c <balloc>
    8000273a:	0005091b          	sext.w	s2,a0
      if(addr == 0)
    8000273e:	fa0907e3          	beqz	s2,800026ec <bmap+0x2e>
      ip->addrs[NDIRECT] = addr;
    80002742:	0729ae23          	sw	s2,124(s3)
    bp = bread(ip->dev, addr);
    80002746:	85ca                	mv	a1,s2
    80002748:	0009a503          	lw	a0,0(s3)
    8000274c:	00000097          	auipc	ra,0x0
    80002750:	b7e080e7          	jalr	-1154(ra) # 800022ca <bread>
    80002754:	8a2a                	mv	s4,a0
    a = (uint*)bp->data;
    80002756:	05850793          	addi	a5,a0,88
    if((addr = a[bn]) == 0){
    8000275a:	02049713          	slli	a4,s1,0x20
    8000275e:	01e75493          	srli	s1,a4,0x1e
    80002762:	94be                	add	s1,s1,a5
    80002764:	0004a903          	lw	s2,0(s1)
    80002768:	00090863          	beqz	s2,80002778 <bmap+0xba>
    brelse(bp);
    8000276c:	8552                	mv	a0,s4
    8000276e:	00000097          	auipc	ra,0x0
    80002772:	c8c080e7          	jalr	-884(ra) # 800023fa <brelse>
    return addr;
    80002776:	bf9d                	j	800026ec <bmap+0x2e>
      addr = balloc(ip->dev);
    80002778:	0009a503          	lw	a0,0(s3)
    8000277c:	00000097          	auipc	ra,0x0
    80002780:	e10080e7          	jalr	-496(ra) # 8000258c <balloc>
    80002784:	0005091b          	sext.w	s2,a0
      if(addr){
    80002788:	fe0902e3          	beqz	s2,8000276c <bmap+0xae>
        a[bn] = addr;
    8000278c:	0124a023          	sw	s2,0(s1)
        log_write(bp);
    80002790:	8552                	mv	a0,s4
    80002792:	00001097          	auipc	ra,0x1
    80002796:	068080e7          	jalr	104(ra) # 800037fa <log_write>
    8000279a:	bfc9                	j	8000276c <bmap+0xae>
  bn -= NINDIRECT;
    8000279c:	ef55849b          	addiw	s1,a1,-267
    800027a0:	0004871b          	sext.w	a4,s1
  if(bn < NINDIRECT2){
    800027a4:	67c1                	lui	a5,0x10
    800027a6:	0af77e63          	bgeu	a4,a5,80002862 <bmap+0x1a4>
    if((addr = ip->addrs[NDIRECT+1]) == 0)
    800027aa:	08052583          	lw	a1,128(a0)
    800027ae:	c1a5                	beqz	a1,8000280e <bmap+0x150>
    bp = bread(ip->dev, addr);
    800027b0:	0009a503          	lw	a0,0(s3)
    800027b4:	00000097          	auipc	ra,0x0
    800027b8:	b16080e7          	jalr	-1258(ra) # 800022ca <bread>
    800027bc:	892a                	mv	s2,a0
    a = (uint*)bp->data;
    800027be:	05850a13          	addi	s4,a0,88
    if((addr = a[bn / NINDIRECT]) == 0){
    800027c2:	0084d79b          	srliw	a5,s1,0x8
    800027c6:	078a                	slli	a5,a5,0x2
    800027c8:	9a3e                	add	s4,s4,a5
    800027ca:	000a2a83          	lw	s5,0(s4) # 2000 <_entry-0x7fffe000>
    800027ce:	040a8a63          	beqz	s5,80002822 <bmap+0x164>
    brelse(bp);
    800027d2:	854a                	mv	a0,s2
    800027d4:	00000097          	auipc	ra,0x0
    800027d8:	c26080e7          	jalr	-986(ra) # 800023fa <brelse>
    bp = bread(ip->dev, addr);
    800027dc:	85d6                	mv	a1,s5
    800027de:	0009a503          	lw	a0,0(s3)
    800027e2:	00000097          	auipc	ra,0x0
    800027e6:	ae8080e7          	jalr	-1304(ra) # 800022ca <bread>
    800027ea:	8a2a                	mv	s4,a0
    a = (uint*)bp->data;
    800027ec:	05850793          	addi	a5,a0,88
    if((addr = a[bn % NINDIRECT]) == 0){
    800027f0:	0ff4f593          	zext.b	a1,s1
    800027f4:	058a                	slli	a1,a1,0x2
    800027f6:	00b784b3          	add	s1,a5,a1
    800027fa:	0004a903          	lw	s2,0(s1)
    800027fe:	04090263          	beqz	s2,80002842 <bmap+0x184>
    brelse(bp);
    80002802:	8552                	mv	a0,s4
    80002804:	00000097          	auipc	ra,0x0
    80002808:	bf6080e7          	jalr	-1034(ra) # 800023fa <brelse>
    return addr;
    8000280c:	b5c5                	j	800026ec <bmap+0x2e>
      ip->addrs[NDIRECT+1] = addr = balloc(ip->dev);
    8000280e:	4108                	lw	a0,0(a0)
    80002810:	00000097          	auipc	ra,0x0
    80002814:	d7c080e7          	jalr	-644(ra) # 8000258c <balloc>
    80002818:	0005059b          	sext.w	a1,a0
    8000281c:	08b9a023          	sw	a1,128(s3)
    80002820:	bf41                	j	800027b0 <bmap+0xf2>
      a[bn / NINDIRECT] = addr = balloc(ip->dev);
    80002822:	0009a503          	lw	a0,0(s3)
    80002826:	00000097          	auipc	ra,0x0
    8000282a:	d66080e7          	jalr	-666(ra) # 8000258c <balloc>
    8000282e:	00050a9b          	sext.w	s5,a0
    80002832:	015a2023          	sw	s5,0(s4)
      log_write(bp);
    80002836:	854a                	mv	a0,s2
    80002838:	00001097          	auipc	ra,0x1
    8000283c:	fc2080e7          	jalr	-62(ra) # 800037fa <log_write>
    80002840:	bf49                	j	800027d2 <bmap+0x114>
      a[bn % NINDIRECT] = addr = balloc(ip->dev);
    80002842:	0009a503          	lw	a0,0(s3)
    80002846:	00000097          	auipc	ra,0x0
    8000284a:	d46080e7          	jalr	-698(ra) # 8000258c <balloc>
    8000284e:	0005091b          	sext.w	s2,a0
    80002852:	0124a023          	sw	s2,0(s1)
      log_write(bp);
    80002856:	8552                	mv	a0,s4
    80002858:	00001097          	auipc	ra,0x1
    8000285c:	fa2080e7          	jalr	-94(ra) # 800037fa <log_write>
    80002860:	b74d                	j	80002802 <bmap+0x144>
  panic("bmap: out of range");
    80002862:	00006517          	auipc	a0,0x6
    80002866:	c8e50513          	addi	a0,a0,-882 # 800084f0 <syscalls+0x120>
    8000286a:	00003097          	auipc	ra,0x3
    8000286e:	5e2080e7          	jalr	1506(ra) # 80005e4c <panic>
...
0000000080002872 <iget>:
{
  ...
  acquire(&itable.lock);
    80002886:	00010517          	auipc	a0,0x10
    8000288a:	9c250513          	addi	a0,a0,-1598 # 80012248 <itable>
    8000288e:	00004097          	auipc	ra,0x4
    80002892:	af6080e7          	jalr	-1290(ra) # 80006384 <acquire>
  empty = 0;
    80002896:	4901                	li	s2,0
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    80002898:	00010497          	auipc	s1,0x10
    8000289c:	9c848493          	addi	s1,s1,-1592 # 80012260 <itable+0x18>
    800028a0:	00011697          	auipc	a3,0x11
    800028a4:	45068693          	addi	a3,a3,1104 # 80013cf0 <log>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    800028c4:	ff4713e3          	bne	a4,s4,800028aa <iget+0x38>
      ip->ref++;
    800028c8:	2785                	addiw	a5,a5,1 # 10001 <_entry-0x7ffeffff>
    800028ca:	c49c                	sw	a5,8(s1)
      release(&itable.lock);
    800028cc:	00010517          	auipc	a0,0x10
    800028d0:	97c50513          	addi	a0,a0,-1668 # 80012248 <itable>
    800028d4:	00004097          	auipc	ra,0x4
    800028d8:	b64080e7          	jalr	-1180(ra) # 80006438 <release>
      return ip;
  ...
  release(&itable.lock);
    800028fc:	00010517          	auipc	a0,0x10
    80002900:	94c50513          	addi	a0,a0,-1716 # 80012248 <itable>
    80002904:	00004097          	auipc	ra,0x4
    80002908:	b34080e7          	jalr	-1228(ra) # 80006438 <release>
}
    ...
    80002922:	bea50513          	addi	a0,a0,-1046 # 80008508 <syscalls+0x138>
    80002926:	00003097          	auipc	ra,0x3
    8000292a:	526080e7          	jalr	1318(ra) # 80005e4c <panic>
...
fsinit(int dev) {
  ...
  bp = bread(dev, 1);
    ...
    80002944:	98a080e7          	jalr	-1654(ra) # 800022ca <bread>
    80002948:	84aa                	mv	s1,a0
  memmove(sb, bp->data, sizeof(*sb));
    8000294a:	00010997          	auipc	s3,0x10
    8000294e:	8de98993          	addi	s3,s3,-1826 # 80012228 <sb>
    80002952:	02000613          	li	a2,32
    80002956:	05850593          	addi	a1,a0,88
    8000295a:	854e                	mv	a0,s3
    8000295c:	ffffe097          	auipc	ra,0xffffe
    80002960:	87a080e7          	jalr	-1926(ra) # 800001d6 <memmove>
  brelse(bp);
    80002964:	8526                	mv	a0,s1
    80002966:	00000097          	auipc	ra,0x0
    8000296a:	a94080e7          	jalr	-1388(ra) # 800023fa <brelse>
  if(sb.magic != FSMAGIC)
  ...
  initlog(dev, &sb);
    8000297e:	00010597          	auipc	a1,0x10
    80002982:	8aa58593          	addi	a1,a1,-1878 # 80012228 <sb>
    80002986:	854a                	mv	a0,s2
    80002988:	00001097          	auipc	ra,0x1
    8000298c:	bf6080e7          	jalr	-1034(ra) # 8000357e <initlog>
}
    ...
    800029a2:	b7a50513          	addi	a0,a0,-1158 # 80008518 <syscalls+0x148>
    800029a6:	00003097          	auipc	ra,0x3
    800029aa:	4a6080e7          	jalr	1190(ra) # 80005e4c <panic>
...
00000000800029ae <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    800029c0:	b7458593          	addi	a1,a1,-1164 # 80008530 <syscalls+0x160>
    800029c4:	00010517          	auipc	a0,0x10
    800029c8:	88450513          	addi	a0,a0,-1916 # 80012248 <itable>
    800029cc:	00004097          	auipc	ra,0x4
    800029d0:	928080e7          	jalr	-1752(ra) # 800062f4 <initlock>
  for(i = 0; i < NINODE; i++) {
    800029d4:	00010497          	auipc	s1,0x10
    800029d8:	89c48493          	addi	s1,s1,-1892 # 80012270 <itable+0x28>
    800029dc:	00011997          	auipc	s3,0x11
    800029e0:	32498993          	addi	s3,s3,804 # 80013d00 <log+0x10>
    initsleeplock(&itable.inode[i].lock, "inode");
    800029e4:	00006917          	auipc	s2,0x6
    800029e8:	b5490913          	addi	s2,s2,-1196 # 80008538 <syscalls+0x168>
    800029ec:	85ca                	mv	a1,s2
    800029ee:	8526                	mv	a0,s1
    800029f0:	00001097          	auipc	ra,0x1
    800029f4:	eee080e7          	jalr	-274(ra) # 800038de <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
0000000080002a0e <ialloc>:
{
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    ...
    80002a54:	87a080e7          	jalr	-1926(ra) # 800022ca <bread>
    ...
    80002a70:	98e080e7          	jalr	-1650(ra) # 800023fa <brelse>
  for(inum = 1; inum < sb.ninodes; inum++){
  ...
  printf("ialloc: no inodes\n");
    ...
    80002a86:	abe50513          	addi	a0,a0,-1346 # 80008540 <syscalls+0x170>
    80002a8a:	00003097          	auipc	ra,0x3
    80002a8e:	40c080e7          	jalr	1036(ra) # 80005e96 <printf>
  return 0;
    ...
    80002ab6:	6c8080e7          	jalr	1736(ra) # 8000017a <memset>
      dip->type = type;
    80002aba:	01799023          	sh	s7,0(s3)
      log_write(bp);   // mark it allocated on the disk
    80002abe:	854a                	mv	a0,s2
    80002ac0:	00001097          	auipc	ra,0x1
    80002ac4:	d3a080e7          	jalr	-710(ra) # 800037fa <log_write>
      brelse(bp);
    80002ac8:	854a                	mv	a0,s2
    80002aca:	00000097          	auipc	ra,0x0
    80002ace:	930080e7          	jalr	-1744(ra) # 800023fa <brelse>
...
0000000080002ae0 <iupdate>:
{
  ...
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80002af4:	0000f597          	auipc	a1,0xf
    80002af8:	74c5a583          	lw	a1,1868(a1) # 80012240 <sb+0x18>
    80002afc:	9dbd                	addw	a1,a1,a5
    80002afe:	4108                	lw	a0,0(a0)
    80002b00:	fffff097          	auipc	ra,0xfffff
    80002b04:	7ca080e7          	jalr	1994(ra) # 800022ca <bread>
    80002b08:	892a                	mv	s2,a0
  dip = (struct dinode*)bp->data + ip->inum%IPB;
    80002b0a:	05850793          	addi	a5,a0,88
    80002b0e:	40d8                	lw	a4,4(s1)
    80002b10:	8b3d                	andi	a4,a4,15
    80002b12:	071a                	slli	a4,a4,0x6
    80002b14:	97ba                	add	a5,a5,a4
  dip->type = ip->type;
    80002b16:	04449703          	lh	a4,68(s1)
    80002b1a:	00e79023          	sh	a4,0(a5)
  dip->major = ip->major;
    80002b1e:	04649703          	lh	a4,70(s1)
    80002b22:	00e79123          	sh	a4,2(a5)
  dip->minor = ip->minor;
    80002b26:	04849703          	lh	a4,72(s1)
    80002b2a:	00e79223          	sh	a4,4(a5)
  dip->nlink = ip->nlink;
    80002b2e:	04a49703          	lh	a4,74(s1)
    80002b32:	00e79323          	sh	a4,6(a5)
  dip->size = ip->size;
    80002b36:	44f8                	lw	a4,76(s1)
    80002b38:	c798                	sw	a4,8(a5)
  memmove(dip->addrs, ip->addrs, sizeof(ip->addrs));
    80002b3a:	03400613          	li	a2,52
    80002b3e:	05048593          	addi	a1,s1,80
    80002b42:	00c78513          	addi	a0,a5,12
    80002b46:	ffffd097          	auipc	ra,0xffffd
    80002b4a:	690080e7          	jalr	1680(ra) # 800001d6 <memmove>
  log_write(bp);
    80002b4e:	854a                	mv	a0,s2
    80002b50:	00001097          	auipc	ra,0x1
    80002b54:	caa080e7          	jalr	-854(ra) # 800037fa <log_write>
  brelse(bp);
    80002b58:	854a                	mv	a0,s2
    80002b5a:	00000097          	auipc	ra,0x0
    80002b5e:	8a0080e7          	jalr	-1888(ra) # 800023fa <brelse>
}
...
0000000080002b6e <idup>:
{
  ...
  acquire(&itable.lock);
    80002b7a:	0000f517          	auipc	a0,0xf
    80002b7e:	6ce50513          	addi	a0,a0,1742 # 80012248 <itable>
    80002b82:	00004097          	auipc	ra,0x4
    80002b86:	802080e7          	jalr	-2046(ra) # 80006384 <acquire>
  ip->ref++;
    80002b8a:	449c                	lw	a5,8(s1)
    80002b8c:	2785                	addiw	a5,a5,1
    80002b8e:	c49c                	sw	a5,8(s1)
  release(&itable.lock);
    80002b90:	0000f517          	auipc	a0,0xf
    80002b94:	6b850513          	addi	a0,a0,1720 # 80012248 <itable>
    80002b98:	00004097          	auipc	ra,0x4
    80002b9c:	8a0080e7          	jalr	-1888(ra) # 80006438 <release>
}
...
0000000080002bac <ilock>:
{
  ...
  if(ip == 0 || ip->ref < 1)
    80002bb8:	c115                	beqz	a0,80002bdc <ilock+0x30>
    80002bba:	84aa                	mv	s1,a0
    80002bbc:	451c                	lw	a5,8(a0)
    80002bbe:	00f05f63          	blez	a5,80002bdc <ilock+0x30>
  acquiresleep(&ip->lock);
    80002bc2:	0541                	addi	a0,a0,16
    80002bc4:	00001097          	auipc	ra,0x1
    80002bc8:	d54080e7          	jalr	-684(ra) # 80003918 <acquiresleep>
  if(ip->valid == 0){
    80002bcc:	40bc                	lw	a5,64(s1)
    80002bce:	cf99                	beqz	a5,80002bec <ilock+0x40>
}
    ...
    80002be0:	97c50513          	addi	a0,a0,-1668 # 80008558 <syscalls+0x188>
    80002be4:	00003097          	auipc	ra,0x3
    80002be8:	268080e7          	jalr	616(ra) # 80005e4c <panic>
    bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    80002bec:	40dc                	lw	a5,4(s1)
    80002bee:	0047d79b          	srliw	a5,a5,0x4
    80002bf2:	0000f597          	auipc	a1,0xf
    80002bf6:	64e5a583          	lw	a1,1614(a1) # 80012240 <sb+0x18>
    80002bfa:	9dbd                	addw	a1,a1,a5
    80002bfc:	4088                	lw	a0,0(s1)
    80002bfe:	fffff097          	auipc	ra,0xfffff
    80002c02:	6cc080e7          	jalr	1740(ra) # 800022ca <bread>
    80002c06:	892a                	mv	s2,a0
    dip = (struct dinode*)bp->data + ip->inum%IPB;
    80002c08:	05850593          	addi	a1,a0,88
    80002c0c:	40dc                	lw	a5,4(s1)
    80002c0e:	8bbd                	andi	a5,a5,15
    80002c10:	079a                	slli	a5,a5,0x6
    80002c12:	95be                	add	a1,a1,a5
    ip->type = dip->type;
    80002c14:	00059783          	lh	a5,0(a1)
    80002c18:	04f49223          	sh	a5,68(s1)
    ip->major = dip->major;
    80002c1c:	00259783          	lh	a5,2(a1)
    80002c20:	04f49323          	sh	a5,70(s1)
    ip->minor = dip->minor;
    80002c24:	00459783          	lh	a5,4(a1)
    80002c28:	04f49423          	sh	a5,72(s1)
    ip->nlink = dip->nlink;
    80002c2c:	00659783          	lh	a5,6(a1)
    80002c30:	04f49523          	sh	a5,74(s1)
    ip->size = dip->size;
    80002c34:	459c                	lw	a5,8(a1)
    80002c36:	c4fc                	sw	a5,76(s1)
    memmove(ip->addrs, dip->addrs, sizeof(ip->addrs));
    80002c38:	03400613          	li	a2,52
    80002c3c:	05b1                	addi	a1,a1,12
    80002c3e:	05048513          	addi	a0,s1,80
    80002c42:	ffffd097          	auipc	ra,0xffffd
    80002c46:	594080e7          	jalr	1428(ra) # 800001d6 <memmove>
    brelse(bp);
    80002c4a:	854a                	mv	a0,s2
    80002c4c:	fffff097          	auipc	ra,0xfffff
    80002c50:	7ae080e7          	jalr	1966(ra) # 800023fa <brelse>
    ip->valid = 1;
    80002c54:	4785                	li	a5,1
    80002c56:	c0bc                	sw	a5,64(s1)
    if(ip->type == 0)
    80002c58:	04449783          	lh	a5,68(s1)
    80002c5c:	fbb5                	bnez	a5,80002bd0 <ilock+0x24>
      panic("ilock: no type");
    80002c5e:	00006517          	auipc	a0,0x6
    80002c62:	90250513          	addi	a0,a0,-1790 # 80008560 <syscalls+0x190>
    80002c66:	00003097          	auipc	ra,0x3
    80002c6a:	1e6080e7          	jalr	486(ra) # 80005e4c <panic>

0000000080002c6e <iunlock>:
{
  ...
  if(ip == 0 || !holdingsleep(&ip->lock) || ip->ref < 1)
    80002c7a:	c905                	beqz	a0,80002caa <iunlock+0x3c>
    80002c7c:	84aa                	mv	s1,a0
    80002c7e:	01050913          	addi	s2,a0,16
    80002c82:	854a                	mv	a0,s2
    80002c84:	00001097          	auipc	ra,0x1
    80002c88:	d2e080e7          	jalr	-722(ra) # 800039b2 <holdingsleep>
    80002c8c:	cd19                	beqz	a0,80002caa <iunlock+0x3c>
    80002c8e:	449c                	lw	a5,8(s1)
    80002c90:	00f05d63          	blez	a5,80002caa <iunlock+0x3c>
  releasesleep(&ip->lock);
    80002c94:	854a                	mv	a0,s2
    80002c96:	00001097          	auipc	ra,0x1
    80002c9a:	cd8080e7          	jalr	-808(ra) # 8000396e <releasesleep>
}
    ...
    80002cae:	8c650513          	addi	a0,a0,-1850 # 80008570 <syscalls+0x1a0>
    80002cb2:	00003097          	auipc	ra,0x3
    80002cb6:	19a080e7          	jalr	410(ra) # 80005e4c <panic>

0000000080002cba <itrunc>:
...
{
    80002cba:	715d                	addi	sp,sp,-80
    80002cbc:	e486                	sd	ra,72(sp)
    80002cbe:	e0a2                	sd	s0,64(sp)
    80002cc0:	fc26                	sd	s1,56(sp)
    80002cc2:	f84a                	sd	s2,48(sp)
    80002cc4:	f44e                	sd	s3,40(sp)
    80002cc6:	f052                	sd	s4,32(sp)
    80002cc8:	ec56                	sd	s5,24(sp)
    80002cca:	e85a                	sd	s6,16(sp)
    80002ccc:	e45e                	sd	s7,8(sp)
    80002cce:	e062                	sd	s8,0(sp)
  ...
  for(i = 0; i < NDIRECT; i++){
    ...
    80002cd8:	07c50913          	addi	s2,a0,124
    80002cdc:	a021                	j	80002ce4 <itrunc+0x2a>
    80002cde:	0491                	addi	s1,s1,4
    80002ce0:	01248d63          	beq	s1,s2,80002cfa <itrunc+0x40>
    if(ip->addrs[i]){
    80002ce4:	408c                	lw	a1,0(s1)
    80002ce6:	dde5                	beqz	a1,80002cde <itrunc+0x24>
      bfree(ip->dev, ip->addrs[i]);
    80002ce8:	0009a503          	lw	a0,0(s3)
    80002cec:	00000097          	auipc	ra,0x0
    80002cf0:	824080e7          	jalr	-2012(ra) # 80002510 <bfree>
      ip->addrs[i] = 0;
    80002cf4:	0004a023          	sw	zero,0(s1)
    80002cf8:	b7dd                	j	80002cde <itrunc+0x24>
    }
  }

  if(ip->addrs[NDIRECT]){
    80002cfa:	07c9a583          	lw	a1,124(s3)
    80002cfe:	e59d                	bnez	a1,80002d2c <itrunc+0x72>
  ...
  if(ip->addrs[NDIRECT+1]){
    ...
    80002d04:	eda5                	bnez	a1,80002d7c <itrunc+0xc2>
    brelse(bp);
  ...
  ip->size = 0;
    80002d06:	0409a623          	sw	zero,76(s3)
  iupdate(ip);
    80002d0a:	854e                	mv	a0,s3
    80002d0c:	00000097          	auipc	ra,0x0
    80002d10:	dd4080e7          	jalr	-556(ra) # 80002ae0 <iupdate>
}
    80002d14:	60a6                	ld	ra,72(sp)
    80002d16:	6406                	ld	s0,64(sp)
    80002d18:	74e2                	ld	s1,56(sp)
    80002d1a:	7942                	ld	s2,48(sp)
    80002d1c:	79a2                	ld	s3,40(sp)
    80002d1e:	7a02                	ld	s4,32(sp)
    80002d20:	6ae2                	ld	s5,24(sp)
    80002d22:	6b42                	ld	s6,16(sp)
    80002d24:	6ba2                	ld	s7,8(sp)
    80002d26:	6c02                	ld	s8,0(sp)
    80002d28:	6161                	addi	sp,sp,80
    80002d2a:	8082                	ret
    bp = bread(ip->dev, ip->addrs[NDIRECT]);
    80002d2c:	0009a503          	lw	a0,0(s3)
    80002d30:	fffff097          	auipc	ra,0xfffff
    80002d34:	59a080e7          	jalr	1434(ra) # 800022ca <bread>
    80002d38:	8a2a                	mv	s4,a0
    for(j = 0; j < NINDIRECT; j++){
    80002d3a:	05850493          	addi	s1,a0,88
    80002d3e:	45850913          	addi	s2,a0,1112
    80002d42:	a021                	j	80002d4a <itrunc+0x90>
    80002d44:	0491                	addi	s1,s1,4
    80002d46:	01248b63          	beq	s1,s2,80002d5c <itrunc+0xa2>
      if(a[j])
    80002d4a:	408c                	lw	a1,0(s1)
    80002d4c:	dde5                	beqz	a1,80002d44 <itrunc+0x8a>
        bfree(ip->dev, a[j]);
    80002d4e:	0009a503          	lw	a0,0(s3)
    80002d52:	fffff097          	auipc	ra,0xfffff
    80002d56:	7be080e7          	jalr	1982(ra) # 80002510 <bfree>
    80002d5a:	b7ed                	j	80002d44 <itrunc+0x8a>
    brelse(bp);
    80002d5c:	8552                	mv	a0,s4
    80002d5e:	fffff097          	auipc	ra,0xfffff
    80002d62:	69c080e7          	jalr	1692(ra) # 800023fa <brelse>
    bfree(ip->dev, ip->addrs[NDIRECT]);
    80002d66:	07c9a583          	lw	a1,124(s3)
    80002d6a:	0009a503          	lw	a0,0(s3)
    80002d6e:	fffff097          	auipc	ra,0xfffff
    80002d72:	7a2080e7          	jalr	1954(ra) # 80002510 <bfree>
    ip->addrs[NDIRECT] = 0;
    80002d76:	0609ae23          	sw	zero,124(s3)
    80002d7a:	b759                	j	80002d00 <itrunc+0x46>
    bp = bread(ip->dev, ip->addrs[NDIRECT+1]);
    80002d7c:	0009a503          	lw	a0,0(s3)
    80002d80:	fffff097          	auipc	ra,0xfffff
    80002d84:	54a080e7          	jalr	1354(ra) # 800022ca <bread>
    80002d88:	8c2a                	mv	s8,a0
    for(j = 0; j < NINDIRECT; j++){
    80002d8a:	05850a13          	addi	s4,a0,88
    80002d8e:	45850b13          	addi	s6,a0,1112
    80002d92:	a83d                	j	80002dd0 <itrunc+0x116>
        for(int k = 0; k < NINDIRECT; k++){
    80002d94:	0491                	addi	s1,s1,4
    80002d96:	00990b63          	beq	s2,s1,80002dac <itrunc+0xf2>
          if(a2[k])
    80002d9a:	408c                	lw	a1,0(s1)
    80002d9c:	dde5                	beqz	a1,80002d94 <itrunc+0xda>
            bfree(ip->dev, a2[k]);
    80002d9e:	0009a503          	lw	a0,0(s3)
    80002da2:	fffff097          	auipc	ra,0xfffff
    80002da6:	76e080e7          	jalr	1902(ra) # 80002510 <bfree>
    80002daa:	b7ed                	j	80002d94 <itrunc+0xda>
        brelse(bp2);
    80002dac:	855e                	mv	a0,s7
    80002dae:	fffff097          	auipc	ra,0xfffff
    80002db2:	64c080e7          	jalr	1612(ra) # 800023fa <brelse>
        bfree(ip->dev, a[j]);
    80002db6:	000aa583          	lw	a1,0(s5)
    80002dba:	0009a503          	lw	a0,0(s3)
    80002dbe:	fffff097          	auipc	ra,0xfffff
    80002dc2:	752080e7          	jalr	1874(ra) # 80002510 <bfree>
        a[j] = 0;
    80002dc6:	000aa023          	sw	zero,0(s5)
    for(j = 0; j < NINDIRECT; j++){
    80002dca:	0a11                	addi	s4,s4,4
    80002dcc:	036a0263          	beq	s4,s6,80002df0 <itrunc+0x136>
      if(a[j]){
    80002dd0:	8ad2                	mv	s5,s4
    80002dd2:	000a2583          	lw	a1,0(s4)
    80002dd6:	d9f5                	beqz	a1,80002dca <itrunc+0x110>
        struct buf *bp2 = bread(ip->dev, a[j]);
    80002dd8:	0009a503          	lw	a0,0(s3)
    80002ddc:	fffff097          	auipc	ra,0xfffff
    80002de0:	4ee080e7          	jalr	1262(ra) # 800022ca <bread>
    80002de4:	8baa                	mv	s7,a0
        for(int k = 0; k < NINDIRECT; k++){
    80002de6:	05850493          	addi	s1,a0,88
    80002dea:	45850913          	addi	s2,a0,1112
    80002dee:	b775                	j	80002d9a <itrunc+0xe0>
    brelse(bp);
    80002df0:	8562                	mv	a0,s8
    80002df2:	fffff097          	auipc	ra,0xfffff
    80002df6:	608080e7          	jalr	1544(ra) # 800023fa <brelse>
    bfree(ip->dev, ip->addrs[NDIRECT+1]);
    80002dfa:	0809a583          	lw	a1,128(s3)
    80002dfe:	0009a503          	lw	a0,0(s3)
    80002e02:	fffff097          	auipc	ra,0xfffff
    80002e06:	70e080e7          	jalr	1806(ra) # 80002510 <bfree>
    ip->addrs[NDIRECT+1] = 0;
    80002e0a:	0809a023          	sw	zero,128(s3)
    80002e0e:	bde5                	j	80002d06 <itrunc+0x4c>

0000000080002e10 <iput>:
{
  ...
  acquire(&itable.lock);
    80002e1e:	0000f517          	auipc	a0,0xf
    80002e22:	42a50513          	addi	a0,a0,1066 # 80012248 <itable>
    80002e26:	00003097          	auipc	ra,0x3
    80002e2a:	55e080e7          	jalr	1374(ra) # 80006384 <acquire>
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    80002e2e:	4498                	lw	a4,8(s1)
    80002e30:	4785                	li	a5,1
    80002e32:	02f70363          	beq	a4,a5,80002e58 <iput+0x48>
  ip->ref--;
    80002e36:	449c                	lw	a5,8(s1)
    80002e38:	37fd                	addiw	a5,a5,-1
    80002e3a:	c49c                	sw	a5,8(s1)
  release(&itable.lock);
    80002e3c:	0000f517          	auipc	a0,0xf
    80002e40:	40c50513          	addi	a0,a0,1036 # 80012248 <itable>
    80002e44:	00003097          	auipc	ra,0x3
    80002e48:	5f4080e7          	jalr	1524(ra) # 80006438 <release>
}
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80002e5a:	dff1                	beqz	a5,80002e36 <iput+0x26>
    80002e5c:	04a49783          	lh	a5,74(s1)
    80002e60:	fbf9                	bnez	a5,80002e36 <iput+0x26>
    acquiresleep(&ip->lock);
    80002e62:	01048913          	addi	s2,s1,16
    80002e66:	854a                	mv	a0,s2
    80002e68:	00001097          	auipc	ra,0x1
    80002e6c:	ab0080e7          	jalr	-1360(ra) # 80003918 <acquiresleep>
    release(&itable.lock);
    80002e70:	0000f517          	auipc	a0,0xf
    80002e74:	3d850513          	addi	a0,a0,984 # 80012248 <itable>
    80002e78:	00003097          	auipc	ra,0x3
    80002e7c:	5c0080e7          	jalr	1472(ra) # 80006438 <release>
    itrunc(ip);
    80002e80:	8526                	mv	a0,s1
    80002e82:	00000097          	auipc	ra,0x0
    80002e86:	e38080e7          	jalr	-456(ra) # 80002cba <itrunc>
    ip->type = 0;
    80002e8a:	04049223          	sh	zero,68(s1)
    iupdate(ip);
    80002e8e:	8526                	mv	a0,s1
    80002e90:	00000097          	auipc	ra,0x0
    80002e94:	c50080e7          	jalr	-944(ra) # 80002ae0 <iupdate>
    ip->valid = 0;
    80002e98:	0404a023          	sw	zero,64(s1)
    releasesleep(&ip->lock);
    80002e9c:	854a                	mv	a0,s2
    80002e9e:	00001097          	auipc	ra,0x1
    80002ea2:	ad0080e7          	jalr	-1328(ra) # 8000396e <releasesleep>
    acquire(&itable.lock);
    80002ea6:	0000f517          	auipc	a0,0xf
    80002eaa:	3a250513          	addi	a0,a0,930 # 80012248 <itable>
    80002eae:	00003097          	auipc	ra,0x3
    80002eb2:	4d6080e7          	jalr	1238(ra) # 80006384 <acquire>
    80002eb6:	b741                	j	80002e36 <iput+0x26>

0000000080002eb8 <iunlockput>:
{
  ...
  iunlock(ip);
    ...
    80002ec8:	daa080e7          	jalr	-598(ra) # 80002c6e <iunlock>
  iput(ip);
    80002ecc:	8526                	mv	a0,s1
    80002ece:	00000097          	auipc	ra,0x0
    80002ed2:	f42080e7          	jalr	-190(ra) # 80002e10 <iput>
}
...
stati(struct inode *ip, struct stat *st)
{
    ...
    80002ee2:	e422                	sd	s0,8(sp)
    80002ee4:	0800                	addi	s0,sp,16
  st->dev = ip->dev;
    80002ee6:	411c                	lw	a5,0(a0)
    80002ee8:	c19c                	sw	a5,0(a1)
  st->ino = ip->inum;
    80002eea:	415c                	lw	a5,4(a0)
    80002eec:	c1dc                	sw	a5,4(a1)
  st->type = ip->type;
    80002eee:	04451783          	lh	a5,68(a0)
    80002ef2:	00f59423          	sh	a5,8(a1)
  st->nlink = ip->nlink;
    80002ef6:	04a51783          	lh	a5,74(a0)
    80002efa:	00f59523          	sh	a5,10(a1)
  st->size = ip->size;
    80002efe:	04c56783          	lwu	a5,76(a0)
    80002f02:	e99c                	sd	a5,16(a1)
}
    80002f04:	6422                	ld	s0,8(sp)
    80002f06:	0141                	addi	sp,sp,16
    80002f08:	8082                	ret

0000000080002f0a <readi>:
readi(struct inode *ip, int user_dst, uint64 dst, uint off, uint n)
{
  ...
  if(off > ip->size || off + n < off)
    80002f0a:	457c                	lw	a5,76(a0)
    80002f0c:	0ed7e963          	bltu	a5,a3,80002ffe <readi+0xf4>
{
    80002f10:	7159                	addi	sp,sp,-112
    80002f12:	f486                	sd	ra,104(sp)
    80002f14:	f0a2                	sd	s0,96(sp)
    80002f16:	eca6                	sd	s1,88(sp)
    80002f18:	e8ca                	sd	s2,80(sp)
    80002f1a:	e4ce                	sd	s3,72(sp)
    80002f1c:	e0d2                	sd	s4,64(sp)
    80002f1e:	fc56                	sd	s5,56(sp)
    80002f20:	f85a                	sd	s6,48(sp)
    80002f22:	f45e                	sd	s7,40(sp)
    80002f24:	f062                	sd	s8,32(sp)
    80002f26:	ec66                	sd	s9,24(sp)
    80002f28:	e86a                	sd	s10,16(sp)
    80002f2a:	e46e                	sd	s11,8(sp)
    80002f2c:	1880                	addi	s0,sp,112
    80002f2e:	8b2a                	mv	s6,a0
    80002f30:	8bae                	mv	s7,a1
    80002f32:	8a32                	mv	s4,a2
    80002f34:	84b6                	mv	s1,a3
    80002f36:	8aba                	mv	s5,a4
  if(off > ip->size || off + n < off)
    80002f38:	9f35                	addw	a4,a4,a3
    return 0;
    80002f3a:	4501                	li	a0,0
  if(off > ip->size || off + n < off)
    80002f3c:	0ad76063          	bltu	a4,a3,80002fdc <readi+0xd2>
  if(off + n > ip->size)
    80002f40:	00e7f463          	bgeu	a5,a4,80002f48 <readi+0x3e>
    n = ip->size - off;
    80002f44:	40d78abb          	subw	s5,a5,a3

  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    80002f48:	0a0a8963          	beqz	s5,80002ffa <readi+0xf0>
    80002f4c:	4981                	li	s3,0
    uint addr = bmap(ip, off/BSIZE);
    if(addr == 0)
      break;
    bp = bread(ip->dev, addr);
    m = min(n - tot, BSIZE - off%BSIZE);
    80002f4e:	40000c93          	li	s9,1024
    if(either_copyout(user_dst, dst, bp->data + (off % BSIZE), m) == -1) {
    80002f52:	5c7d                	li	s8,-1
    80002f54:	a82d                	j	80002f8e <readi+0x84>
    80002f56:	020d1d93          	slli	s11,s10,0x20
    80002f5a:	020ddd93          	srli	s11,s11,0x20
    80002f5e:	05890613          	addi	a2,s2,88
    80002f62:	86ee                	mv	a3,s11
    80002f64:	963a                	add	a2,a2,a4
    80002f66:	85d2                	mv	a1,s4
    80002f68:	855e                	mv	a0,s7
    80002f6a:	fffff097          	auipc	ra,0xfffff
    80002f6e:	99a080e7          	jalr	-1638(ra) # 80001904 <either_copyout>
    80002f72:	05850d63          	beq	a0,s8,80002fcc <readi+0xc2>
      brelse(bp);
      tot = -1;
      break;
    }
    ...
    80002f7c:	482080e7          	jalr	1154(ra) # 800023fa <brelse>
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    80002f80:	013d09bb          	addw	s3,s10,s3
    80002f84:	009d04bb          	addw	s1,s10,s1
    80002f88:	9a6e                	add	s4,s4,s11
    80002f8a:	0559f763          	bgeu	s3,s5,80002fd8 <readi+0xce>
    uint addr = bmap(ip, off/BSIZE);
    80002f8e:	00a4d59b          	srliw	a1,s1,0xa
    80002f92:	855a                	mv	a0,s6
    80002f94:	fffff097          	auipc	ra,0xfffff
    80002f98:	72a080e7          	jalr	1834(ra) # 800026be <bmap>
    80002f9c:	0005059b          	sext.w	a1,a0
    if(addr == 0)
    80002fa0:	cd85                	beqz	a1,80002fd8 <readi+0xce>
    bp = bread(ip->dev, addr);
    80002fa2:	000b2503          	lw	a0,0(s6)
    80002fa6:	fffff097          	auipc	ra,0xfffff
    80002faa:	324080e7          	jalr	804(ra) # 800022ca <bread>
    80002fae:	892a                	mv	s2,a0
    m = min(n - tot, BSIZE - off%BSIZE);
    80002fb0:	3ff4f713          	andi	a4,s1,1023
    80002fb4:	40ec87bb          	subw	a5,s9,a4
    80002fb8:	413a86bb          	subw	a3,s5,s3
    80002fbc:	8d3e                	mv	s10,a5
    80002fbe:	2781                	sext.w	a5,a5
    80002fc0:	0006861b          	sext.w	a2,a3
    80002fc4:	f8f679e3          	bgeu	a2,a5,80002f56 <readi+0x4c>
    80002fc8:	8d36                	mv	s10,a3
    80002fca:	b771                	j	80002f56 <readi+0x4c>
      brelse(bp);
    80002fcc:	854a                	mv	a0,s2
    80002fce:	fffff097          	auipc	ra,0xfffff
    80002fd2:	42c080e7          	jalr	1068(ra) # 800023fa <brelse>
      tot = -1;
    80002fd6:	59fd                	li	s3,-1
  }
  return tot;
    80002fd8:	0009851b          	sext.w	a0,s3
}
    80002fdc:	70a6                	ld	ra,104(sp)
    80002fde:	7406                	ld	s0,96(sp)
    80002fe0:	64e6                	ld	s1,88(sp)
    80002fe2:	6946                	ld	s2,80(sp)
    80002fe4:	69a6                	ld	s3,72(sp)
    80002fe6:	6a06                	ld	s4,64(sp)
    80002fe8:	7ae2                	ld	s5,56(sp)
    80002fea:	7b42                	ld	s6,48(sp)
    80002fec:	7ba2                	ld	s7,40(sp)
    80002fee:	7c02                	ld	s8,32(sp)
    80002ff0:	6ce2                	ld	s9,24(sp)
    80002ff2:	6d42                	ld	s10,16(sp)
    80002ff4:	6da2                	ld	s11,8(sp)
    80002ff6:	6165                	addi	sp,sp,112
    80002ff8:	8082                	ret
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    80002ffa:	89d6                	mv	s3,s5
    80002ffc:	bff1                	j	80002fd8 <readi+0xce>
    return 0;
    80002ffe:	4501                	li	a0,0
}
    80003000:	8082                	ret

0000000080003002 <writei>:
writei(struct inode *ip, int user_src, uint64 src, uint off, uint n)
{
  ...
  if(off > ip->size || off + n < off)
    ...
    80003004:	10d7e963          	bltu	a5,a3,80003116 <writei+0x114>
{
    ...
    80003012:	e4ce                	sd	s3,72(sp)
    80003014:	e0d2                	sd	s4,64(sp)
    80003016:	fc56                	sd	s5,56(sp)
    80003018:	f85a                	sd	s6,48(sp)
    8000301a:	f45e                	sd	s7,40(sp)
    8000301c:	f062                	sd	s8,32(sp)
    8000301e:	ec66                	sd	s9,24(sp)
    80003020:	e86a                	sd	s10,16(sp)
    80003022:	e46e                	sd	s11,8(sp)
    80003024:	1880                	addi	s0,sp,112
    80003026:	8aaa                	mv	s5,a0
    80003028:	8bae                	mv	s7,a1
    8000302a:	8a32                	mv	s4,a2
    8000302c:	8936                	mv	s2,a3
    8000302e:	8b3a                	mv	s6,a4
  if(off > ip->size || off + n < off)
    80003030:	9f35                	addw	a4,a4,a3
    80003032:	0ed76463          	bltu	a4,a3,8000311a <writei+0x118>
    return -1;
  if(off + n > MAXFILE*BSIZE)
    80003036:	040437b7          	lui	a5,0x4043
    8000303a:	c0078793          	addi	a5,a5,-1024 # 4042c00 <_entry-0x7bfbd400>
    8000303e:	0ee7e063          	bltu	a5,a4,8000311e <writei+0x11c>
    return -1;

  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    80003042:	0c0b0863          	beqz	s6,80003112 <writei+0x110>
    80003046:	4981                	li	s3,0
    uint addr = bmap(ip, off/BSIZE);
    if(addr == 0)
      break;
    bp = bread(ip->dev, addr);
    m = min(n - tot, BSIZE - off%BSIZE);
    80003048:	40000c93          	li	s9,1024
    if(either_copyin(bp->data + (off % BSIZE), user_src, src, m) == -1) {
    8000304c:	5c7d                	li	s8,-1
    8000304e:	a091                	j	80003092 <writei+0x90>
    80003050:	020d1d93          	slli	s11,s10,0x20
    80003054:	020ddd93          	srli	s11,s11,0x20
    80003058:	05848513          	addi	a0,s1,88
    8000305c:	86ee                	mv	a3,s11
    8000305e:	8652                	mv	a2,s4
    80003060:	85de                	mv	a1,s7
    80003062:	953a                	add	a0,a0,a4
    80003064:	fffff097          	auipc	ra,0xfffff
    80003068:	8f6080e7          	jalr	-1802(ra) # 8000195a <either_copyin>
    8000306c:	07850263          	beq	a0,s8,800030d0 <writei+0xce>
      brelse(bp);
      break;
    }
    log_write(bp);
    ...
    80003076:	788080e7          	jalr	1928(ra) # 800037fa <log_write>
    brelse(bp);
    8000307a:	8526                	mv	a0,s1
    8000307c:	fffff097          	auipc	ra,0xfffff
    80003080:	37e080e7          	jalr	894(ra) # 800023fa <brelse>
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    80003084:	013d09bb          	addw	s3,s10,s3
    80003088:	012d093b          	addw	s2,s10,s2
    8000308c:	9a6e                	add	s4,s4,s11
    8000308e:	0569f663          	bgeu	s3,s6,800030da <writei+0xd8>
    uint addr = bmap(ip, off/BSIZE);
    80003092:	00a9559b          	srliw	a1,s2,0xa
    80003096:	8556                	mv	a0,s5
    80003098:	fffff097          	auipc	ra,0xfffff
    8000309c:	626080e7          	jalr	1574(ra) # 800026be <bmap>
    800030a0:	0005059b          	sext.w	a1,a0
    if(addr == 0)
    800030a4:	c99d                	beqz	a1,800030da <writei+0xd8>
    bp = bread(ip->dev, addr);
    800030a6:	000aa503          	lw	a0,0(s5)
    800030aa:	fffff097          	auipc	ra,0xfffff
    800030ae:	220080e7          	jalr	544(ra) # 800022ca <bread>
    800030b2:	84aa                	mv	s1,a0
    m = min(n - tot, BSIZE - off%BSIZE);
    800030b4:	3ff97713          	andi	a4,s2,1023
    800030b8:	40ec87bb          	subw	a5,s9,a4
    800030bc:	413b06bb          	subw	a3,s6,s3
    800030c0:	8d3e                	mv	s10,a5
    800030c2:	2781                	sext.w	a5,a5
    800030c4:	0006861b          	sext.w	a2,a3
    800030c8:	f8f674e3          	bgeu	a2,a5,80003050 <writei+0x4e>
    800030cc:	8d36                	mv	s10,a3
    800030ce:	b749                	j	80003050 <writei+0x4e>
      brelse(bp);
    800030d0:	8526                	mv	a0,s1
    800030d2:	fffff097          	auipc	ra,0xfffff
    800030d6:	328080e7          	jalr	808(ra) # 800023fa <brelse>
  }

  if(off > ip->size)
    800030da:	04caa783          	lw	a5,76(s5)
    800030de:	0127f463          	bgeu	a5,s2,800030e6 <writei+0xe4>
    ip->size = off;
    800030e2:	052aa623          	sw	s2,76(s5)

  // write the i-node back to disk even if the size didn't change
  // because the loop above might have called bmap() and added a new
  // block to ip->addrs[].
  iupdate(ip);
    800030e6:	8556                	mv	a0,s5
    800030e8:	00000097          	auipc	ra,0x0
    800030ec:	9f8080e7          	jalr	-1544(ra) # 80002ae0 <iupdate>

  return tot;
    800030f0:	0009851b          	sext.w	a0,s3
}
    ...
    80003100:	7ae2                	ld	s5,56(sp)
    80003102:	7b42                	ld	s6,48(sp)
    80003104:	7ba2                	ld	s7,40(sp)
    80003106:	7c02                	ld	s8,32(sp)
    80003108:	6ce2                	ld	s9,24(sp)
    8000310a:	6d42                	ld	s10,16(sp)
    8000310c:	6da2                	ld	s11,8(sp)
    8000310e:	6165                	addi	sp,sp,112
    80003110:	8082                	ret
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    80003112:	89da                	mv	s3,s6
    80003114:	bfc9                	j	800030e6 <writei+0xe4>
    return -1;
    ...
    8000311c:	bfe1                	j	800030f4 <writei+0xf2>
    return -1;
    8000311e:	557d                	li	a0,-1
    80003120:	bfd1                	j	800030f4 <writei+0xf2>

0000000080003122 <namecmp>:
...
namecmp(const char *s, const char *t)
{
  ...
  return strncmp(s, t, DIRSIZ);
    ...
    80003130:	11e080e7          	jalr	286(ra) # 8000024a <strncmp>
}
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  if(dp->type != T_DIR)
    8000314c:	04451703          	lh	a4,68(a0)
    80003150:	4785                	li	a5,1
    80003152:	00f71a63          	bne	a4,a5,80003166 <dirlookup+0x2a>
    80003156:	892a                	mv	s2,a0
    80003158:	89ae                	mv	s3,a1
    8000315a:	8a32                	mv	s4,a2
    panic("dirlookup not DIR");

  for(off = 0; off < dp->size; off += sizeof(de)){
    8000315c:	457c                	lw	a5,76(a0)
    8000315e:	4481                	li	s1,0
      inum = de.inum;
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    80003162:	e79d                	bnez	a5,80003190 <dirlookup+0x54>
    80003164:	a8a5                	j	800031dc <dirlookup+0xa0>
    panic("dirlookup not DIR");
    80003166:	00005517          	auipc	a0,0x5
    8000316a:	41250513          	addi	a0,a0,1042 # 80008578 <syscalls+0x1a8>
    8000316e:	00003097          	auipc	ra,0x3
    80003172:	cde080e7          	jalr	-802(ra) # 80005e4c <panic>
      panic("dirlookup read");
    80003176:	00005517          	auipc	a0,0x5
    8000317a:	41a50513          	addi	a0,a0,1050 # 80008590 <syscalls+0x1c0>
    8000317e:	00003097          	auipc	ra,0x3
    80003182:	cce080e7          	jalr	-818(ra) # 80005e4c <panic>
  for(off = 0; off < dp->size; off += sizeof(de)){
    80003186:	24c1                	addiw	s1,s1,16
    80003188:	04c92783          	lw	a5,76(s2)
    8000318c:	04f4f763          	bgeu	s1,a5,800031da <dirlookup+0x9e>
    ...
    800031a0:	d6e080e7          	jalr	-658(ra) # 80002f0a <readi>
    800031a4:	47c1                	li	a5,16
    800031a6:	fcf518e3          	bne	a0,a5,80003176 <dirlookup+0x3a>
    if(de.inum == 0)
    800031aa:	fc045783          	lhu	a5,-64(s0)
    800031ae:	dfe1                	beqz	a5,80003186 <dirlookup+0x4a>
    if(namecmp(name, de.name) == 0){
    800031b0:	fc240593          	addi	a1,s0,-62
    800031b4:	854e                	mv	a0,s3
    800031b6:	00000097          	auipc	ra,0x0
    800031ba:	f6c080e7          	jalr	-148(ra) # 80003122 <namecmp>
    800031be:	f561                	bnez	a0,80003186 <dirlookup+0x4a>
      if(poff)
    800031c0:	000a0463          	beqz	s4,800031c8 <dirlookup+0x8c>
        *poff = off;
    800031c4:	009a2023          	sw	s1,0(s4)
      return iget(dp->dev, inum);
    800031c8:	fc045583          	lhu	a1,-64(s0)
    800031cc:	00092503          	lw	a0,0(s2)
    800031d0:	fffff097          	auipc	ra,0xfffff
    800031d4:	6a2080e7          	jalr	1698(ra) # 80002872 <iget>
    800031d8:	a011                	j	800031dc <dirlookup+0xa0>
  return 0;
...
namex(char *path, int nameiparent, char *name)
{
    ...
    800031f4:	e0ca                	sd	s2,64(sp)
    800031f6:	fc4e                	sd	s3,56(sp)
    800031f8:	f852                	sd	s4,48(sp)
    800031fa:	f456                	sd	s5,40(sp)
    800031fc:	f05a                	sd	s6,32(sp)
    800031fe:	ec5e                	sd	s7,24(sp)
    80003200:	e862                	sd	s8,16(sp)
    80003202:	e466                	sd	s9,8(sp)
    80003204:	e06a                	sd	s10,0(sp)
  ...
  if(*path == '/')
    ...
    80003216:	02f70363          	beq	a4,a5,8000323c <namex+0x50>
    ip = iget(ROOTDEV, ROOTINO);
  else
    ip = idup(myproc()->cwd);
    8000321a:	ffffe097          	auipc	ra,0xffffe
    8000321e:	c3a080e7          	jalr	-966(ra) # 80000e54 <myproc>
    80003222:	15053503          	ld	a0,336(a0)
    80003226:	00000097          	auipc	ra,0x0
    8000322a:	948080e7          	jalr	-1720(ra) # 80002b6e <idup>
    8000322e:	8a2a                	mv	s4,a0
  while(*path == '/')
    80003230:	02f00913          	li	s2,47
  if(len >= DIRSIZ)
    80003234:	4cb5                	li	s9,13
  len = path - s;
    80003236:	4b81                	li	s7,0

  while((path = skipelem(path, name)) != 0){
    ilock(ip);
    if(ip->type != T_DIR){
    80003238:	4c05                	li	s8,1
    8000323a:	a87d                	j	800032f8 <namex+0x10c>
    ip = iget(ROOTDEV, ROOTINO);
    8000323c:	4585                	li	a1,1
    8000323e:	4505                	li	a0,1
    80003240:	fffff097          	auipc	ra,0xfffff
    80003244:	632080e7          	jalr	1586(ra) # 80002872 <iget>
    80003248:	8a2a                	mv	s4,a0
    8000324a:	b7dd                	j	80003230 <namex+0x44>
      iunlockput(ip);
    8000324c:	8552                	mv	a0,s4
    8000324e:	00000097          	auipc	ra,0x0
    80003252:	c6a080e7          	jalr	-918(ra) # 80002eb8 <iunlockput>
      return 0;
  ...
  return ip;
    ...
    80003270:	6d02                	ld	s10,0(sp)
    80003272:	6125                	addi	sp,sp,96
    80003274:	8082                	ret
      iunlock(ip);
    80003276:	8552                	mv	a0,s4
    80003278:	00000097          	auipc	ra,0x0
    8000327c:	9f6080e7          	jalr	-1546(ra) # 80002c6e <iunlock>
      return ip;
    80003280:	bfe1                	j	80003258 <namex+0x6c>
      iunlockput(ip);
    80003282:	8552                	mv	a0,s4
    80003284:	00000097          	auipc	ra,0x0
    80003288:	c34080e7          	jalr	-972(ra) # 80002eb8 <iunlockput>
      return 0;
    8000328c:	8a4e                	mv	s4,s3
    8000328e:	b7e9                	j	80003258 <namex+0x6c>
  len = path - s;
    80003290:	40998633          	sub	a2,s3,s1
    80003294:	00060d1b          	sext.w	s10,a2
  if(len >= DIRSIZ)
    80003298:	09acd863          	bge	s9,s10,80003328 <namex+0x13c>
    memmove(name, s, DIRSIZ);
    8000329c:	4639                	li	a2,14
    8000329e:	85a6                	mv	a1,s1
    800032a0:	8556                	mv	a0,s5
    800032a2:	ffffd097          	auipc	ra,0xffffd
    800032a6:	f34080e7          	jalr	-204(ra) # 800001d6 <memmove>
    800032aa:	84ce                	mv	s1,s3
  while(*path == '/')
    800032ac:	0004c783          	lbu	a5,0(s1)
    800032b0:	01279763          	bne	a5,s2,800032be <namex+0xd2>
    path++;
    800032b4:	0485                	addi	s1,s1,1
  while(*path == '/')
    800032b6:	0004c783          	lbu	a5,0(s1)
    800032ba:	ff278de3          	beq	a5,s2,800032b4 <namex+0xc8>
    ilock(ip);
    800032be:	8552                	mv	a0,s4
    800032c0:	00000097          	auipc	ra,0x0
    800032c4:	8ec080e7          	jalr	-1812(ra) # 80002bac <ilock>
    if(ip->type != T_DIR){
    800032c8:	044a1783          	lh	a5,68(s4)
    800032cc:	f98790e3          	bne	a5,s8,8000324c <namex+0x60>
    if(nameiparent && *path == '\0'){
    800032d0:	000b0563          	beqz	s6,800032da <namex+0xee>
    800032d4:	0004c783          	lbu	a5,0(s1)
    800032d8:	dfd9                	beqz	a5,80003276 <namex+0x8a>
    if((next = dirlookup(ip, name, 0)) == 0){
    800032da:	865e                	mv	a2,s7
    800032dc:	85d6                	mv	a1,s5
    800032de:	8552                	mv	a0,s4
    800032e0:	00000097          	auipc	ra,0x0
    800032e4:	e5c080e7          	jalr	-420(ra) # 8000313c <dirlookup>
    800032e8:	89aa                	mv	s3,a0
    800032ea:	dd41                	beqz	a0,80003282 <namex+0x96>
    iunlockput(ip);
    800032ec:	8552                	mv	a0,s4
    800032ee:	00000097          	auipc	ra,0x0
    800032f2:	bca080e7          	jalr	-1078(ra) # 80002eb8 <iunlockput>
    ip = next;
    800032f6:	8a4e                	mv	s4,s3
  while(*path == '/')
    800032f8:	0004c783          	lbu	a5,0(s1)
    800032fc:	01279763          	bne	a5,s2,8000330a <namex+0x11e>
    path++;
    80003300:	0485                	addi	s1,s1,1
  while(*path == '/')
    80003302:	0004c783          	lbu	a5,0(s1)
    80003306:	ff278de3          	beq	a5,s2,80003300 <namex+0x114>
  if(*path == 0)
    8000330a:	cb9d                	beqz	a5,80003340 <namex+0x154>
  while(*path != '/' && *path != 0)
    8000330c:	0004c783          	lbu	a5,0(s1)
    80003310:	89a6                	mv	s3,s1
  len = path - s;
    80003312:	8d5e                	mv	s10,s7
    80003314:	865e                	mv	a2,s7
  while(*path != '/' && *path != 0)
    80003316:	01278963          	beq	a5,s2,80003328 <namex+0x13c>
    8000331a:	dbbd                	beqz	a5,80003290 <namex+0xa4>
    path++;
    8000331c:	0985                	addi	s3,s3,1
  while(*path != '/' && *path != 0)
    8000331e:	0009c783          	lbu	a5,0(s3)
    80003322:	ff279ce3          	bne	a5,s2,8000331a <namex+0x12e>
    80003326:	b7ad                	j	80003290 <namex+0xa4>
    memmove(name, s, len);
    80003328:	2601                	sext.w	a2,a2
    8000332a:	85a6                	mv	a1,s1
    8000332c:	8556                	mv	a0,s5
    8000332e:	ffffd097          	auipc	ra,0xffffd
    80003332:	ea8080e7          	jalr	-344(ra) # 800001d6 <memmove>
    name[len] = 0;
    80003336:	9d56                	add	s10,s10,s5
    80003338:	000d0023          	sb	zero,0(s10)
    8000333c:	84ce                	mv	s1,s3
    8000333e:	b7bd                	j	800032ac <namex+0xc0>
  if(nameiparent){
    80003340:	f00b0ce3          	beqz	s6,80003258 <namex+0x6c>
    iput(ip);
    80003344:	8552                	mv	a0,s4
    80003346:	00000097          	auipc	ra,0x0
    8000334a:	aca080e7          	jalr	-1334(ra) # 80002e10 <iput>
    return 0;
    8000334e:	4a01                	li	s4,0
    80003350:	b721                	j	80003258 <namex+0x6c>

0000000080003352 <dirlink>:
{
    ...
    80003360:	0080                	addi	s0,sp,64
    80003362:	892a                	mv	s2,a0
    80003364:	8a2e                	mv	s4,a1
    80003366:	89b2                	mv	s3,a2
  if((ip = dirlookup(dp, name, 0)) != 0){
    80003368:	4601                	li	a2,0
    8000336a:	00000097          	auipc	ra,0x0
    8000336e:	dd2080e7          	jalr	-558(ra) # 8000313c <dirlookup>
    80003372:	e93d                	bnez	a0,800033e8 <dirlink+0x96>
  for(off = 0; off < dp->size; off += sizeof(de)){
    80003374:	04c92483          	lw	s1,76(s2)
    80003378:	c49d                	beqz	s1,800033a6 <dirlink+0x54>
    ...
    8000338c:	b82080e7          	jalr	-1150(ra) # 80002f0a <readi>
    80003390:	47c1                	li	a5,16
    80003392:	06f51163          	bne	a0,a5,800033f4 <dirlink+0xa2>
    if(de.inum == 0)
    80003396:	fc045783          	lhu	a5,-64(s0)
    8000339a:	c791                	beqz	a5,800033a6 <dirlink+0x54>
  for(off = 0; off < dp->size; off += sizeof(de)){
    8000339c:	24c1                	addiw	s1,s1,16
    8000339e:	04c92783          	lw	a5,76(s2)
    800033a2:	fcf4ede3          	bltu	s1,a5,8000337c <dirlink+0x2a>
  strncpy(de.name, name, DIRSIZ);
    800033a6:	4639                	li	a2,14
    800033a8:	85d2                	mv	a1,s4
    800033aa:	fc240513          	addi	a0,s0,-62
    800033ae:	ffffd097          	auipc	ra,0xffffd
    800033b2:	ed8080e7          	jalr	-296(ra) # 80000286 <strncpy>
  de.inum = inum;
    800033b6:	fd341023          	sh	s3,-64(s0)
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    800033ca:	c3c080e7          	jalr	-964(ra) # 80003002 <writei>
    800033ce:	1541                	addi	a0,a0,-16
    800033d0:	00a03533          	snez	a0,a0
    800033d4:	40a00533          	neg	a0,a0
}
    ...
    800033e2:	6a42                	ld	s4,16(sp)
    800033e4:	6121                	addi	sp,sp,64
    800033e6:	8082                	ret
    iput(ip);
    800033e8:	00000097          	auipc	ra,0x0
    800033ec:	a28080e7          	jalr	-1496(ra) # 80002e10 <iput>
    return -1;
    800033f0:	557d                	li	a0,-1
    800033f2:	b7dd                	j	800033d8 <dirlink+0x86>
      panic("dirlink read");
    800033f4:	00005517          	auipc	a0,0x5
    800033f8:	1ac50513          	addi	a0,a0,428 # 800085a0 <syscalls+0x1d0>
    800033fc:	00003097          	auipc	ra,0x3
    80003400:	a50080e7          	jalr	-1456(ra) # 80005e4c <panic>

0000000080003404 <namei>:
...
namei(char *path)
{
  ...
  return namex(path, 0, name);
    8000340c:	fe040613          	addi	a2,s0,-32
    80003410:	4581                	li	a1,0
    80003412:	00000097          	auipc	ra,0x0
    80003416:	dda080e7          	jalr	-550(ra) # 800031ec <namex>
}
...
nameiparent(char *path, char *name)
{
    ...
    8000342a:	862e                	mv	a2,a1
  return namex(path, 1, name);
    8000342c:	4585                	li	a1,1
    8000342e:	00000097          	auipc	ra,0x0
    80003432:	dbe080e7          	jalr	-578(ra) # 800031ec <namex>
}
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    8000344a:	00011917          	auipc	s2,0x11
    8000344e:	8a690913          	addi	s2,s2,-1882 # 80013cf0 <log>
    80003452:	01892583          	lw	a1,24(s2)
    80003456:	02892503          	lw	a0,40(s2)
    8000345a:	fffff097          	auipc	ra,0xfffff
    8000345e:	e70080e7          	jalr	-400(ra) # 800022ca <bread>
    80003462:	84aa                	mv	s1,a0
  struct logheader *hb = (struct logheader *) (buf->data);
  int i;
  hb->n = log.lh.n;
    80003464:	02c92683          	lw	a3,44(s2)
    80003468:	cd34                	sw	a3,88(a0)
  for (i = 0; i < log.lh.n; i++) {
    8000346a:	02d05863          	blez	a3,8000349a <write_head+0x5c>
    8000346e:	00011797          	auipc	a5,0x11
    80003472:	8b278793          	addi	a5,a5,-1870 # 80013d20 <log+0x30>
    80003476:	05c50713          	addi	a4,a0,92
    8000347a:	36fd                	addiw	a3,a3,-1
    8000347c:	02069613          	slli	a2,a3,0x20
    80003480:	01e65693          	srli	a3,a2,0x1e
    80003484:	00011617          	auipc	a2,0x11
    80003488:	8a060613          	addi	a2,a2,-1888 # 80013d24 <log+0x34>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003496:	fed79ce3          	bne	a5,a3,8000348e <write_head+0x50>
  }
  bwrite(buf);
    8000349a:	8526                	mv	a0,s1
    8000349c:	fffff097          	auipc	ra,0xfffff
    800034a0:	f20080e7          	jalr	-224(ra) # 800023bc <bwrite>
  brelse(buf);
    800034a4:	8526                	mv	a0,s1
    800034a6:	fffff097          	auipc	ra,0xfffff
    800034aa:	f54080e7          	jalr	-172(ra) # 800023fa <brelse>
}
...
00000000800034ba <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    800034ba:	00011797          	auipc	a5,0x11
    800034be:	8627a783          	lw	a5,-1950(a5) # 80013d1c <log+0x2c>
    800034c2:	0af05d63          	blez	a5,8000357c <install_trans+0xc2>
{
    ...
    800034dc:	00011a97          	auipc	s5,0x11
    800034e0:	844a8a93          	addi	s5,s5,-1980 # 80013d20 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    800034e4:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    800034e6:	00011997          	auipc	s3,0x11
    800034ea:	80a98993          	addi	s3,s3,-2038 # 80013cf0 <log>
    800034ee:	a00d                	j	80003510 <install_trans+0x56>
    brelse(lbuf);
    800034f0:	854a                	mv	a0,s2
    800034f2:	fffff097          	auipc	ra,0xfffff
    800034f6:	f08080e7          	jalr	-248(ra) # 800023fa <brelse>
    brelse(dbuf);
    800034fa:	8526                	mv	a0,s1
    800034fc:	fffff097          	auipc	ra,0xfffff
    80003500:	efe080e7          	jalr	-258(ra) # 800023fa <brelse>
  for (tail = 0; tail < log.lh.n; tail++) {
    80003504:	2a05                	addiw	s4,s4,1
    80003506:	0a91                	addi	s5,s5,4
    80003508:	02c9a783          	lw	a5,44(s3)
    8000350c:	04fa5e63          	bge	s4,a5,80003568 <install_trans+0xae>
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    80003510:	0189a583          	lw	a1,24(s3)
    80003514:	014585bb          	addw	a1,a1,s4
    80003518:	2585                	addiw	a1,a1,1
    8000351a:	0289a503          	lw	a0,40(s3)
    8000351e:	fffff097          	auipc	ra,0xfffff
    80003522:	dac080e7          	jalr	-596(ra) # 800022ca <bread>
    80003526:	892a                	mv	s2,a0
    struct buf *dbuf = bread(log.dev, log.lh.block[tail]); // read dst
    80003528:	000aa583          	lw	a1,0(s5)
    8000352c:	0289a503          	lw	a0,40(s3)
    80003530:	fffff097          	auipc	ra,0xfffff
    80003534:	d9a080e7          	jalr	-614(ra) # 800022ca <bread>
    80003538:	84aa                	mv	s1,a0
    memmove(dbuf->data, lbuf->data, BSIZE);  // copy block to dst
    8000353a:	40000613          	li	a2,1024
    8000353e:	05890593          	addi	a1,s2,88
    80003542:	05850513          	addi	a0,a0,88
    80003546:	ffffd097          	auipc	ra,0xffffd
    8000354a:	c90080e7          	jalr	-880(ra) # 800001d6 <memmove>
    bwrite(dbuf);  // write dst to disk
    8000354e:	8526                	mv	a0,s1
    80003550:	fffff097          	auipc	ra,0xfffff
    80003554:	e6c080e7          	jalr	-404(ra) # 800023bc <bwrite>
    if(recovering == 0)
    80003558:	f80b1ce3          	bnez	s6,800034f0 <install_trans+0x36>
      bunpin(dbuf);
    8000355c:	8526                	mv	a0,s1
    8000355e:	fffff097          	auipc	ra,0xfffff
    80003562:	f76080e7          	jalr	-138(ra) # 800024d4 <bunpin>
...
000000008000357e <initlog>:
{
  ...
  initlock(&log.lock, "log");
    80003590:	00010497          	auipc	s1,0x10
    80003594:	76048493          	addi	s1,s1,1888 # 80013cf0 <log>
    80003598:	00005597          	auipc	a1,0x5
    8000359c:	01858593          	addi	a1,a1,24 # 800085b0 <syscalls+0x1e0>
    800035a0:	8526                	mv	a0,s1
    800035a2:	00003097          	auipc	ra,0x3
    800035a6:	d52080e7          	jalr	-686(ra) # 800062f4 <initlock>
  ...
  struct buf *buf = bread(log.dev, log.start);
    ...
    800035c0:	d0e080e7          	jalr	-754(ra) # 800022ca <bread>
  log.lh.n = lh->n;
    800035c4:	4d34                	lw	a3,88(a0)
    800035c6:	d4d4                	sw	a3,44(s1)
  for (i = 0; i < log.lh.n; i++) {
    800035c8:	02d05663          	blez	a3,800035f4 <initlog+0x76>
    800035cc:	05c50793          	addi	a5,a0,92
    800035d0:	00010717          	auipc	a4,0x10
    800035d4:	75070713          	addi	a4,a4,1872 # 80013d20 <log+0x30>
    800035d8:	36fd                	addiw	a3,a3,-1
    800035da:	02069613          	slli	a2,a3,0x20
    800035de:	01e65693          	srli	a3,a2,0x1e
    800035e2:	06050613          	addi	a2,a0,96
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800035f0:	fed79ce3          	bne	a5,a3,800035e8 <initlog+0x6a>
  brelse(buf);
    800035f4:	fffff097          	auipc	ra,0xfffff
    800035f8:	e06080e7          	jalr	-506(ra) # 800023fa <brelse>
...
recover_from_log(void)
{
  ...
  install_trans(1); // if committed, copy from log to disk
    ...
    80003602:	ebc080e7          	jalr	-324(ra) # 800034ba <install_trans>
  log.lh.n = 0;
    80003606:	00010797          	auipc	a5,0x10
    8000360a:	7007ab23          	sw	zero,1814(a5) # 80013d1c <log+0x2c>
  write_head(); // clear the log
    8000360e:	00000097          	auipc	ra,0x0
    80003612:	e30080e7          	jalr	-464(ra) # 8000343e <write_head>
}
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    80003630:	00010517          	auipc	a0,0x10
    80003634:	6c050513          	addi	a0,a0,1728 # 80013cf0 <log>
    80003638:	00003097          	auipc	ra,0x3
    8000363c:	d4c080e7          	jalr	-692(ra) # 80006384 <acquire>
  while(1){
    if(log.committing){
    80003640:	00010497          	auipc	s1,0x10
    80003644:	6b048493          	addi	s1,s1,1712 # 80013cf0 <log>
      sleep(&log, &log.lock);
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
    80003648:	4979                	li	s2,30
    8000364a:	a039                	j	80003658 <begin_op+0x34>
      sleep(&log, &log.lock);
    8000364c:	85a6                	mv	a1,s1
    8000364e:	8526                	mv	a0,s1
    80003650:	ffffe097          	auipc	ra,0xffffe
    80003654:	eac080e7          	jalr	-340(ra) # 800014fc <sleep>
    if(log.committing){
    80003658:	50dc                	lw	a5,36(s1)
    8000365a:	fbed                	bnez	a5,8000364c <begin_op+0x28>
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
    8000365c:	5098                	lw	a4,32(s1)
    8000365e:	2705                	addiw	a4,a4,1
    ...
    80003672:	00f95963          	bge	s2,a5,80003684 <begin_op+0x60>
      // this op might exhaust log space; wait for commit.
      sleep(&log, &log.lock);
    80003676:	85a6                	mv	a1,s1
    80003678:	8526                	mv	a0,s1
    8000367a:	ffffe097          	auipc	ra,0xffffe
    8000367e:	e82080e7          	jalr	-382(ra) # 800014fc <sleep>
    80003682:	bfd9                	j	80003658 <begin_op+0x34>
    } else {
      log.outstanding += 1;
    80003684:	00010517          	auipc	a0,0x10
    80003688:	66c50513          	addi	a0,a0,1644 # 80013cf0 <log>
    8000368c:	d114                	sw	a3,32(a0)
      release(&log.lock);
    8000368e:	00003097          	auipc	ra,0x3
    80003692:	daa080e7          	jalr	-598(ra) # 80006438 <release>
      break;
    }
  }
}
...
end_op(void)
{
  ...
  acquire(&log.lock);
    800036b4:	00010497          	auipc	s1,0x10
    800036b8:	63c48493          	addi	s1,s1,1596 # 80013cf0 <log>
    800036bc:	8526                	mv	a0,s1
    800036be:	00003097          	auipc	ra,0x3
    800036c2:	cc6080e7          	jalr	-826(ra) # 80006384 <acquire>
  log.outstanding -= 1;
  ...
  if(log.committing)
    ...
    800036d2:	e7b9                	bnez	a5,80003720 <end_op+0x7e>
    panic("log.committing");
  if(log.outstanding == 0){
    800036d4:	04091e63          	bnez	s2,80003730 <end_op+0x8e>
    do_commit = 1;
    log.committing = 1;
    800036d8:	00010497          	auipc	s1,0x10
    800036dc:	61848493          	addi	s1,s1,1560 # 80013cf0 <log>
  ...
  release(&log.lock);
    ...
    800036ea:	d52080e7          	jalr	-686(ra) # 80006438 <release>
}
...
commit()
{
  if (log.lh.n > 0) {
    ...
    acquire(&log.lock);
    800036f4:	00010497          	auipc	s1,0x10
    800036f8:	5fc48493          	addi	s1,s1,1532 # 80013cf0 <log>
    800036fc:	8526                	mv	a0,s1
    800036fe:	00003097          	auipc	ra,0x3
    80003702:	c86080e7          	jalr	-890(ra) # 80006384 <acquire>
    log.committing = 0;
    80003706:	0204a223          	sw	zero,36(s1)
    wakeup(&log);
    8000370a:	8526                	mv	a0,s1
    8000370c:	ffffe097          	auipc	ra,0xffffe
    80003710:	e54080e7          	jalr	-428(ra) # 80001560 <wakeup>
    release(&log.lock);
    80003714:	8526                	mv	a0,s1
    80003716:	00003097          	auipc	ra,0x3
    8000371a:	d22080e7          	jalr	-734(ra) # 80006438 <release>
}
    8000371e:	a03d                	j	8000374c <end_op+0xaa>
    panic("log.committing");
    80003720:	00005517          	auipc	a0,0x5
    80003724:	e9850513          	addi	a0,a0,-360 # 800085b8 <syscalls+0x1e8>
    80003728:	00002097          	auipc	ra,0x2
    8000372c:	724080e7          	jalr	1828(ra) # 80005e4c <panic>
    wakeup(&log);
    80003730:	00010497          	auipc	s1,0x10
    80003734:	5c048493          	addi	s1,s1,1472 # 80013cf0 <log>
    80003738:	8526                	mv	a0,s1
    8000373a:	ffffe097          	auipc	ra,0xffffe
    8000373e:	e26080e7          	jalr	-474(ra) # 80001560 <wakeup>
  release(&log.lock);
    80003742:	8526                	mv	a0,s1
    80003744:	00003097          	auipc	ra,0x3
    80003748:	cf4080e7          	jalr	-780(ra) # 80006438 <release>
}
    8000374c:	70e2                	ld	ra,56(sp)
    8000374e:	7442                	ld	s0,48(sp)
    80003750:	74a2                	ld	s1,40(sp)
    ...
    8000375c:	8082                	ret
  for (tail = 0; tail < log.lh.n; tail++) {
    8000375e:	00010a97          	auipc	s5,0x10
    80003762:	5c2a8a93          	addi	s5,s5,1474 # 80013d20 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    80003766:	00010a17          	auipc	s4,0x10
    8000376a:	58aa0a13          	addi	s4,s4,1418 # 80013cf0 <log>
    ...
    80003780:	b4e080e7          	jalr	-1202(ra) # 800022ca <bread>
    ...
    80003792:	b3c080e7          	jalr	-1220(ra) # 800022ca <bread>
    ...
    800037a8:	a32080e7          	jalr	-1486(ra) # 800001d6 <memmove>
    bwrite(to);  // write the log
    800037ac:	8526                	mv	a0,s1
    800037ae:	fffff097          	auipc	ra,0xfffff
    800037b2:	c0e080e7          	jalr	-1010(ra) # 800023bc <bwrite>
    brelse(from);
    800037b6:	854e                	mv	a0,s3
    800037b8:	fffff097          	auipc	ra,0xfffff
    800037bc:	c42080e7          	jalr	-958(ra) # 800023fa <brelse>
    brelse(to);
    800037c0:	8526                	mv	a0,s1
    800037c2:	fffff097          	auipc	ra,0xfffff
    800037c6:	c38080e7          	jalr	-968(ra) # 800023fa <brelse>
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    800037da:	c68080e7          	jalr	-920(ra) # 8000343e <write_head>
    install_trans(0); // Now install writes to home locations
    800037de:	4501                	li	a0,0
    800037e0:	00000097          	auipc	ra,0x0
    800037e4:	cda080e7          	jalr	-806(ra) # 800034ba <install_trans>
    log.lh.n = 0;
    800037e8:	00010797          	auipc	a5,0x10
    800037ec:	5207aa23          	sw	zero,1332(a5) # 80013d1c <log+0x2c>
    write_head();    // Erase the transaction from the log
    800037f0:	00000097          	auipc	ra,0x0
    800037f4:	c4e080e7          	jalr	-946(ra) # 8000343e <write_head>
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    80003808:	00010917          	auipc	s2,0x10
    8000380c:	4e890913          	addi	s2,s2,1256 # 80013cf0 <log>
    80003810:	854a                	mv	a0,s2
    80003812:	00003097          	auipc	ra,0x3
    80003816:	b72080e7          	jalr	-1166(ra) # 80006384 <acquire>
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
    8000381a:	02c92603          	lw	a2,44(s2)
    8000381e:	47f5                	li	a5,29
    80003820:	06c7c563          	blt	a5,a2,8000388a <log_write+0x90>
    80003824:	00010797          	auipc	a5,0x10
    80003828:	4e87a783          	lw	a5,1256(a5) # 80013d0c <log+0x1c>
    8000382c:	37fd                	addiw	a5,a5,-1
    8000382e:	04f65e63          	bge	a2,a5,8000388a <log_write+0x90>
    panic("too big a transaction");
  if (log.outstanding < 1)
    80003832:	00010797          	auipc	a5,0x10
    80003836:	4de7a783          	lw	a5,1246(a5) # 80013d10 <log+0x20>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003846:	00010717          	auipc	a4,0x10
    8000384a:	4da70713          	addi	a4,a4,1242 # 80013d20 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
  ...
  log.lh.block[i] = b->blockno;
    ...
    80003862:	00010797          	auipc	a5,0x10
    80003866:	48e78793          	addi	a5,a5,1166 # 80013cf0 <log>
    8000386a:	97b2                	add	a5,a5,a2
    8000386c:	44d8                	lw	a4,12(s1)
    8000386e:	cb98                	sw	a4,16(a5)
  if (i == log.lh.n) {  // Add new block to log?
    bpin(b);
    80003870:	8526                	mv	a0,s1
    80003872:	fffff097          	auipc	ra,0xfffff
    80003876:	c26080e7          	jalr	-986(ra) # 80002498 <bpin>
    log.lh.n++;
    8000387a:	00010717          	auipc	a4,0x10
    8000387e:	47670713          	addi	a4,a4,1142 # 80013cf0 <log>
    80003882:	575c                	lw	a5,44(a4)
    80003884:	2785                	addiw	a5,a5,1
    80003886:	d75c                	sw	a5,44(a4)
    80003888:	a82d                	j	800038c2 <log_write+0xc8>
    panic("too big a transaction");
    8000388a:	00005517          	auipc	a0,0x5
    8000388e:	d3e50513          	addi	a0,a0,-706 # 800085c8 <syscalls+0x1f8>
    80003892:	00002097          	auipc	ra,0x2
    80003896:	5ba080e7          	jalr	1466(ra) # 80005e4c <panic>
    panic("log_write outside of trans");
    8000389a:	00005517          	auipc	a0,0x5
    8000389e:	d4650513          	addi	a0,a0,-698 # 800085e0 <syscalls+0x210>
    800038a2:	00002097          	auipc	ra,0x2
    800038a6:	5aa080e7          	jalr	1450(ra) # 80005e4c <panic>
  log.lh.block[i] = b->blockno;
    800038aa:	00878693          	addi	a3,a5,8
    800038ae:	068a                	slli	a3,a3,0x2
    800038b0:	00010717          	auipc	a4,0x10
    800038b4:	44070713          	addi	a4,a4,1088 # 80013cf0 <log>
    800038b8:	9736                	add	a4,a4,a3
    800038ba:	44d4                	lw	a3,12(s1)
    800038bc:	cb14                	sw	a3,16(a4)
  if (i == log.lh.n) {  // Add new block to log?
    800038be:	faf609e3          	beq	a2,a5,80003870 <log_write+0x76>
  }
  release(&log.lock);
    800038c2:	00010517          	auipc	a0,0x10
    800038c6:	42e50513          	addi	a0,a0,1070 # 80013cf0 <log>
    800038ca:	00003097          	auipc	ra,0x3
    800038ce:	b6e080e7          	jalr	-1170(ra) # 80006438 <release>
}
...
00000000800038de <initsleeplock>:
#include "proc.h"
#include "sleeplock.h"
...
initsleeplock(struct sleeplock *lk, char *name)
{
    ...
    800038ec:	892e                	mv	s2,a1
  initlock(&lk->lk, "sleep lock");
    800038ee:	00005597          	auipc	a1,0x5
    800038f2:	d1258593          	addi	a1,a1,-750 # 80008600 <syscalls+0x230>
    800038f6:	0521                	addi	a0,a0,8
    800038f8:	00003097          	auipc	ra,0x3
    800038fc:	9fc080e7          	jalr	-1540(ra) # 800062f4 <initlock>
  lk->name = name;
    80003900:	0324b023          	sd	s2,32(s1)
  lk->locked = 0;
...
acquiresleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    80003930:	a58080e7          	jalr	-1448(ra) # 80006384 <acquire>
  while (lk->locked) {
    80003934:	409c                	lw	a5,0(s1)
    80003936:	cb89                	beqz	a5,80003948 <acquiresleep+0x30>
    sleep(lk, &lk->lk);
    80003938:	85ca                	mv	a1,s2
    8000393a:	8526                	mv	a0,s1
    8000393c:	ffffe097          	auipc	ra,0xffffe
    80003940:	bc0080e7          	jalr	-1088(ra) # 800014fc <sleep>
  while (lk->locked) {
    80003944:	409c                	lw	a5,0(s1)
    80003946:	fbed                	bnez	a5,80003938 <acquiresleep+0x20>
  }
  lk->locked = 1;
    80003948:	4785                	li	a5,1
    8000394a:	c09c                	sw	a5,0(s1)
  lk->pid = myproc()->pid;
    8000394c:	ffffd097          	auipc	ra,0xffffd
    80003950:	508080e7          	jalr	1288(ra) # 80000e54 <myproc>
    80003954:	591c                	lw	a5,48(a0)
    80003956:	d49c                	sw	a5,40(s1)
  release(&lk->lk);
    80003958:	854a                	mv	a0,s2
    8000395a:	00003097          	auipc	ra,0x3
    8000395e:	ade080e7          	jalr	-1314(ra) # 80006438 <release>
}
...
releasesleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    80003986:	a02080e7          	jalr	-1534(ra) # 80006384 <acquire>
  lk->locked = 0;
  ...
  wakeup(lk);
    ...
    80003998:	bcc080e7          	jalr	-1076(ra) # 80001560 <wakeup>
  release(&lk->lk);
    8000399c:	854a                	mv	a0,s2
    8000399e:	00003097          	auipc	ra,0x3
    800039a2:	a9a080e7          	jalr	-1382(ra) # 80006438 <release>
}
...
holdingsleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    800039c2:	00850913          	addi	s2,a0,8
    800039c6:	854a                	mv	a0,s2
    800039c8:	00003097          	auipc	ra,0x3
    800039cc:	9bc080e7          	jalr	-1604(ra) # 80006384 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
    800039d0:	409c                	lw	a5,0(s1)
    800039d2:	ef99                	bnez	a5,800039f0 <holdingsleep+0x3e>
    800039d4:	4481                	li	s1,0
  release(&lk->lk);
    800039d6:	854a                	mv	a0,s2
    800039d8:	00003097          	auipc	ra,0x3
    800039dc:	a60080e7          	jalr	-1440(ra) # 80006438 <release>
  return r;
}
    ...
    800039ee:	8082                	ret
  r = lk->locked && (lk->pid == myproc()->pid);
    800039f0:	0284a983          	lw	s3,40(s1)
    800039f4:	ffffd097          	auipc	ra,0xffffd
    800039f8:	460080e7          	jalr	1120(ra) # 80000e54 <myproc>
    800039fc:	5904                	lw	s1,48(a0)
    800039fe:	413484b3          	sub	s1,s1,s3
    80003a02:	0014b493          	seqz	s1,s1
    80003a06:	bfc1                	j	800039d6 <holdingsleep+0x24>

0000000080003a08 <fileinit>:
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    80003a14:	c0058593          	addi	a1,a1,-1024 # 80008610 <syscalls+0x240>
    80003a18:	00010517          	auipc	a0,0x10
    80003a1c:	42050513          	addi	a0,a0,1056 # 80013e38 <ftable>
    80003a20:	00003097          	auipc	ra,0x3
    80003a24:	8d4080e7          	jalr	-1836(ra) # 800062f4 <initlock>
}
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    80003a46:	942080e7          	jalr	-1726(ra) # 80006384 <acquire>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    80003a4a:	00010497          	auipc	s1,0x10
    80003a4e:	40648493          	addi	s1,s1,1030 # 80013e50 <ftable+0x18>
    80003a52:	00011717          	auipc	a4,0x11
    80003a56:	39e70713          	addi	a4,a4,926 # 80014df0 <disk>
    if(f->ref == 0){
    80003a5a:	40dc                	lw	a5,4(s1)
    80003a5c:	cf99                	beqz	a5,80003a7a <filealloc+0x4a>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    80003a5e:	02848493          	addi	s1,s1,40
    80003a62:	fee49ce3          	bne	s1,a4,80003a5a <filealloc+0x2a>
      f->ref = 1;
      release(&ftable.lock);
      return f;
    }
  ...
  release(&ftable.lock);
    80003a66:	00010517          	auipc	a0,0x10
    80003a6a:	3d250513          	addi	a0,a0,978 # 80013e38 <ftable>
    80003a6e:	00003097          	auipc	ra,0x3
    80003a72:	9ca080e7          	jalr	-1590(ra) # 80006438 <release>
  return 0;
    80003a76:	4481                	li	s1,0
    80003a78:	a819                	j	80003a8e <filealloc+0x5e>
      f->ref = 1;
    80003a7a:	4785                	li	a5,1
    80003a7c:	c0dc                	sw	a5,4(s1)
      release(&ftable.lock);
    80003a7e:	00010517          	auipc	a0,0x10
    80003a82:	3ba50513          	addi	a0,a0,954 # 80013e38 <ftable>
    80003a86:	00003097          	auipc	ra,0x3
    80003a8a:	9b2080e7          	jalr	-1614(ra) # 80006438 <release>
}
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    80003aa6:	00010517          	auipc	a0,0x10
    80003aaa:	39250513          	addi	a0,a0,914 # 80013e38 <ftable>
    80003aae:	00003097          	auipc	ra,0x3
    80003ab2:	8d6080e7          	jalr	-1834(ra) # 80006384 <acquire>
  if(f->ref < 1)
    80003ab6:	40dc                	lw	a5,4(s1)
    80003ab8:	02f05263          	blez	a5,80003adc <filedup+0x42>
    panic("filedup");
  f->ref++;
    80003abc:	2785                	addiw	a5,a5,1
    80003abe:	c0dc                	sw	a5,4(s1)
  release(&ftable.lock);
    80003ac0:	00010517          	auipc	a0,0x10
    80003ac4:	37850513          	addi	a0,a0,888 # 80013e38 <ftable>
    80003ac8:	00003097          	auipc	ra,0x3
    80003acc:	970080e7          	jalr	-1680(ra) # 80006438 <release>
  return f;
}
    ...
    80003ae0:	b3c50513          	addi	a0,a0,-1220 # 80008618 <syscalls+0x248>
    80003ae4:	00002097          	auipc	ra,0x2
    80003ae8:	368080e7          	jalr	872(ra) # 80005e4c <panic>

0000000080003aec <fileclose>:
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    80003b00:	00010517          	auipc	a0,0x10
    80003b04:	33850513          	addi	a0,a0,824 # 80013e38 <ftable>
    80003b08:	00003097          	auipc	ra,0x3
    80003b0c:	87c080e7          	jalr	-1924(ra) # 80006384 <acquire>
  if(f->ref < 1)
    80003b10:	40dc                	lw	a5,4(s1)
    80003b12:	06f05163          	blez	a5,80003b74 <fileclose+0x88>
    panic("fileclose");
  if(--f->ref > 0){
    80003b16:	37fd                	addiw	a5,a5,-1
    80003b18:	0007871b          	sext.w	a4,a5
    80003b1c:	c0dc                	sw	a5,4(s1)
    80003b1e:	06e04363          	bgtz	a4,80003b84 <fileclose+0x98>
    release(&ftable.lock);
    return;
  }
  ff = *f;
    80003b22:	0004a903          	lw	s2,0(s1)
    80003b26:	0094ca83          	lbu	s5,9(s1)
    80003b2a:	0104ba03          	ld	s4,16(s1)
    80003b2e:	0184b983          	ld	s3,24(s1)
  f->ref = 0;
    80003b32:	0004a223          	sw	zero,4(s1)
  f->type = FD_NONE;
    80003b36:	0004a023          	sw	zero,0(s1)
  release(&ftable.lock);
    80003b3a:	00010517          	auipc	a0,0x10
    80003b3e:	2fe50513          	addi	a0,a0,766 # 80013e38 <ftable>
    80003b42:	00003097          	auipc	ra,0x3
    80003b46:	8f6080e7          	jalr	-1802(ra) # 80006438 <release>

  if(ff.type == FD_PIPE){
    80003b4a:	4785                	li	a5,1
    80003b4c:	04f90d63          	beq	s2,a5,80003ba6 <fileclose+0xba>
    pipeclose(ff.pipe, ff.writable);
  } else if(ff.type == FD_INODE || ff.type == FD_DEVICE){
    80003b50:	3979                	addiw	s2,s2,-2
    80003b52:	4785                	li	a5,1
    80003b54:	0527e063          	bltu	a5,s2,80003b94 <fileclose+0xa8>
    begin_op();
    80003b58:	00000097          	auipc	ra,0x0
    80003b5c:	acc080e7          	jalr	-1332(ra) # 80003624 <begin_op>
    iput(ff.ip);
    80003b60:	854e                	mv	a0,s3
    80003b62:	fffff097          	auipc	ra,0xfffff
    80003b66:	2ae080e7          	jalr	686(ra) # 80002e10 <iput>
    end_op();
    80003b6a:	00000097          	auipc	ra,0x0
    80003b6e:	b38080e7          	jalr	-1224(ra) # 800036a2 <end_op>
    80003b72:	a00d                	j	80003b94 <fileclose+0xa8>
    panic("fileclose");
    80003b74:	00005517          	auipc	a0,0x5
    80003b78:	aac50513          	addi	a0,a0,-1364 # 80008620 <syscalls+0x250>
    80003b7c:	00002097          	auipc	ra,0x2
    80003b80:	2d0080e7          	jalr	720(ra) # 80005e4c <panic>
    release(&ftable.lock);
    80003b84:	00010517          	auipc	a0,0x10
    80003b88:	2b450513          	addi	a0,a0,692 # 80013e38 <ftable>
    80003b8c:	00003097          	auipc	ra,0x3
    80003b90:	8ac080e7          	jalr	-1876(ra) # 80006438 <release>
  }
}
    ...
    80003ba0:	6aa2                	ld	s5,8(sp)
    80003ba2:	6121                	addi	sp,sp,64
    80003ba4:	8082                	ret
    pipeclose(ff.pipe, ff.writable);
    80003ba6:	85d6                	mv	a1,s5
    80003ba8:	8552                	mv	a0,s4
    80003baa:	00000097          	auipc	ra,0x0
    80003bae:	34c080e7          	jalr	844(ra) # 80003ef6 <pipeclose>
    80003bb2:	b7cd                	j	80003b94 <fileclose+0xa8>

0000000080003bb4 <filestat>:
...
filestat(struct file *f, uint64 addr)
{
    ...
    80003bc0:	0880                	addi	s0,sp,80
    80003bc2:	84aa                	mv	s1,a0
    80003bc4:	89ae                	mv	s3,a1
  struct proc *p = myproc();
    80003bc6:	ffffd097          	auipc	ra,0xffffd
    80003bca:	28e080e7          	jalr	654(ra) # 80000e54 <myproc>
  struct stat st;
  
  if(f->type == FD_INODE || f->type == FD_DEVICE){
    80003bce:	409c                	lw	a5,0(s1)
    80003bd0:	37f9                	addiw	a5,a5,-2
    80003bd2:	4705                	li	a4,1
    80003bd4:	04f76763          	bltu	a4,a5,80003c22 <filestat+0x6e>
    80003bd8:	892a                	mv	s2,a0
    ilock(f->ip);
    80003bda:	6c88                	ld	a0,24(s1)
    80003bdc:	fffff097          	auipc	ra,0xfffff
    80003be0:	fd0080e7          	jalr	-48(ra) # 80002bac <ilock>
    stati(f->ip, &st);
    80003be4:	fb840593          	addi	a1,s0,-72
    80003be8:	6c88                	ld	a0,24(s1)
    80003bea:	fffff097          	auipc	ra,0xfffff
    80003bee:	2f6080e7          	jalr	758(ra) # 80002ee0 <stati>
    iunlock(f->ip);
    80003bf2:	6c88                	ld	a0,24(s1)
    80003bf4:	fffff097          	auipc	ra,0xfffff
    80003bf8:	07a080e7          	jalr	122(ra) # 80002c6e <iunlock>
    if(copyout(p->pagetable, addr, (char *)&st, sizeof(st)) < 0)
    80003bfc:	46e1                	li	a3,24
    80003bfe:	fb840613          	addi	a2,s0,-72
    80003c02:	85ce                	mv	a1,s3
    80003c04:	05093503          	ld	a0,80(s2)
    80003c08:	ffffd097          	auipc	ra,0xffffd
    80003c0c:	f0c080e7          	jalr	-244(ra) # 80000b14 <copyout>
    80003c10:	41f5551b          	sraiw	a0,a0,0x1f
      return -1;
    return 0;
  }
  return -1;
  ...
  return -1;
    ...
    80003c24:	bfc5                	j	80003c14 <filestat+0x60>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  if(f->readable == 0)
    80003c34:	00854783          	lbu	a5,8(a0)
    80003c38:	c3d5                	beqz	a5,80003cdc <fileread+0xb6>
    80003c3a:	84aa                	mv	s1,a0
    80003c3c:	89ae                	mv	s3,a1
    80003c3e:	8932                	mv	s2,a2
    return -1;

  if(f->type == FD_PIPE){
    80003c40:	411c                	lw	a5,0(a0)
    80003c42:	4705                	li	a4,1
    80003c44:	04e78963          	beq	a5,a4,80003c96 <fileread+0x70>
    r = piperead(f->pipe, addr, n);
  } else if(f->type == FD_DEVICE){
    80003c48:	470d                	li	a4,3
    80003c4a:	04e78d63          	beq	a5,a4,80003ca4 <fileread+0x7e>
    if(f->major < 0 || f->major >= NDEV || !devsw[f->major].read)
      return -1;
    r = devsw[f->major].read(1, addr, n);
  } else if(f->type == FD_INODE){
    80003c4e:	4709                	li	a4,2
    80003c50:	06e79e63          	bne	a5,a4,80003ccc <fileread+0xa6>
    ilock(f->ip);
    80003c54:	6d08                	ld	a0,24(a0)
    80003c56:	fffff097          	auipc	ra,0xfffff
    80003c5a:	f56080e7          	jalr	-170(ra) # 80002bac <ilock>
    if((r = readi(f->ip, 1, addr, f->off, n)) > 0)
    80003c5e:	874a                	mv	a4,s2
    80003c60:	5094                	lw	a3,32(s1)
    80003c62:	864e                	mv	a2,s3
    80003c64:	4585                	li	a1,1
    80003c66:	6c88                	ld	a0,24(s1)
    80003c68:	fffff097          	auipc	ra,0xfffff
    80003c6c:	2a2080e7          	jalr	674(ra) # 80002f0a <readi>
    80003c70:	892a                	mv	s2,a0
    80003c72:	00a05563          	blez	a0,80003c7c <fileread+0x56>
      f->off += r;
    80003c76:	509c                	lw	a5,32(s1)
    80003c78:	9fa9                	addw	a5,a5,a0
    80003c7a:	d09c                	sw	a5,32(s1)
    iunlock(f->ip);
    80003c7c:	6c88                	ld	a0,24(s1)
    80003c7e:	fffff097          	auipc	ra,0xfffff
    80003c82:	ff0080e7          	jalr	-16(ra) # 80002c6e <iunlock>
  } else {
    panic("fileread");
  }
  ...
  return r;
    ...
    80003c94:	8082                	ret
    r = piperead(f->pipe, addr, n);
    80003c96:	6908                	ld	a0,16(a0)
    80003c98:	00000097          	auipc	ra,0x0
    80003c9c:	3c6080e7          	jalr	966(ra) # 8000405e <piperead>
    80003ca0:	892a                	mv	s2,a0
    80003ca2:	b7d5                	j	80003c86 <fileread+0x60>
    if(f->major < 0 || f->major >= NDEV || !devsw[f->major].read)
    80003ca4:	02451783          	lh	a5,36(a0)
    80003ca8:	03079693          	slli	a3,a5,0x30
    80003cac:	92c1                	srli	a3,a3,0x30
    80003cae:	4725                	li	a4,9
    80003cb0:	02d76863          	bltu	a4,a3,80003ce0 <fileread+0xba>
    80003cb4:	0792                	slli	a5,a5,0x4
    80003cb6:	00010717          	auipc	a4,0x10
    80003cba:	0e270713          	addi	a4,a4,226 # 80013d98 <devsw>
    80003cbe:	97ba                	add	a5,a5,a4
    80003cc0:	639c                	ld	a5,0(a5)
    80003cc2:	c38d                	beqz	a5,80003ce4 <fileread+0xbe>
    r = devsw[f->major].read(1, addr, n);
    80003cc4:	4505                	li	a0,1
    80003cc6:	9782                	jalr	a5
    80003cc8:	892a                	mv	s2,a0
    80003cca:	bf75                	j	80003c86 <fileread+0x60>
    panic("fileread");
    80003ccc:	00005517          	auipc	a0,0x5
    80003cd0:	96450513          	addi	a0,a0,-1692 # 80008630 <syscalls+0x260>
    80003cd4:	00002097          	auipc	ra,0x2
    80003cd8:	178080e7          	jalr	376(ra) # 80005e4c <panic>
    return -1;
    80003cdc:	597d                	li	s2,-1
    80003cde:	b765                	j	80003c86 <fileread+0x60>
      return -1;
    80003ce0:	597d                	li	s2,-1
    80003ce2:	b755                	j	80003c86 <fileread+0x60>
    80003ce4:	597d                	li	s2,-1
    80003ce6:	b745                	j	80003c86 <fileread+0x60>

0000000080003ce8 <filewrite>:
...
filewrite(struct file *f, uint64 addr, int n)
{
    ...
    80003cfe:	0880                	addi	s0,sp,80
  int r, ret = 0;

  if(f->writable == 0)
    80003d00:	00954783          	lbu	a5,9(a0)
    80003d04:	10078663          	beqz	a5,80003e10 <filewrite+0x128>
  ...
  if(f->type == FD_PIPE){
    ...
    80003d12:	02e78263          	beq	a5,a4,80003d36 <filewrite+0x4e>
    ret = pipewrite(f->pipe, addr, n);
  } else if(f->type == FD_DEVICE){
    80003d16:	470d                	li	a4,3
    80003d18:	02e78663          	beq	a5,a4,80003d44 <filewrite+0x5c>
    if(f->major < 0 || f->major >= NDEV || !devsw[f->major].write)
      return -1;
    ret = devsw[f->major].write(1, addr, n);
  } else if(f->type == FD_INODE){
    80003d1c:	4709                	li	a4,2
    80003d1e:	0ee79163          	bne	a5,a4,80003e00 <filewrite+0x118>
    ...
    int i = 0;
    while(i < n){
    80003d22:	0ac05d63          	blez	a2,80003ddc <filewrite+0xf4>
    int i = 0;
    80003d26:	4981                	li	s3,0
    80003d28:	6b85                	lui	s7,0x1
    80003d2a:	c00b8b93          	addi	s7,s7,-1024 # c00 <_entry-0x7ffff400>
    80003d2e:	6c05                	lui	s8,0x1
    80003d30:	c00c0c1b          	addiw	s8,s8,-1024 # c00 <_entry-0x7ffff400>
    80003d34:	a861                	j	80003dcc <filewrite+0xe4>
    ret = pipewrite(f->pipe, addr, n);
    80003d36:	6908                	ld	a0,16(a0)
    80003d38:	00000097          	auipc	ra,0x0
    80003d3c:	22e080e7          	jalr	558(ra) # 80003f66 <pipewrite>
    80003d40:	8a2a                	mv	s4,a0
    80003d42:	a045                	j	80003de2 <filewrite+0xfa>
    if(f->major < 0 || f->major >= NDEV || !devsw[f->major].write)
    80003d44:	02451783          	lh	a5,36(a0)
    80003d48:	03079693          	slli	a3,a5,0x30
    80003d4c:	92c1                	srli	a3,a3,0x30
    80003d4e:	4725                	li	a4,9
    80003d50:	0cd76263          	bltu	a4,a3,80003e14 <filewrite+0x12c>
    80003d54:	0792                	slli	a5,a5,0x4
    80003d56:	00010717          	auipc	a4,0x10
    80003d5a:	04270713          	addi	a4,a4,66 # 80013d98 <devsw>
    80003d5e:	97ba                	add	a5,a5,a4
    80003d60:	679c                	ld	a5,8(a5)
    80003d62:	cbdd                	beqz	a5,80003e18 <filewrite+0x130>
    ret = devsw[f->major].write(1, addr, n);
    80003d64:	4505                	li	a0,1
    80003d66:	9782                	jalr	a5
    80003d68:	8a2a                	mv	s4,a0
    80003d6a:	a8a5                	j	80003de2 <filewrite+0xfa>
    80003d6c:	00048a9b          	sext.w	s5,s1
      int n1 = n - i;
      if(n1 > max)
        n1 = max;
    ...
    80003d74:	8b4080e7          	jalr	-1868(ra) # 80003624 <begin_op>
      ilock(f->ip);
    80003d78:	01893503          	ld	a0,24(s2)
    80003d7c:	fffff097          	auipc	ra,0xfffff
    80003d80:	e30080e7          	jalr	-464(ra) # 80002bac <ilock>
      if ((r = writei(f->ip, 1, addr + i, f->off, n1)) > 0)
    80003d84:	8756                	mv	a4,s5
    80003d86:	02092683          	lw	a3,32(s2)
    80003d8a:	01698633          	add	a2,s3,s6
    80003d8e:	4585                	li	a1,1
    80003d90:	01893503          	ld	a0,24(s2)
    80003d94:	fffff097          	auipc	ra,0xfffff
    80003d98:	26e080e7          	jalr	622(ra) # 80003002 <writei>
    80003d9c:	84aa                	mv	s1,a0
    80003d9e:	00a05763          	blez	a0,80003dac <filewrite+0xc4>
        f->off += r;
    80003da2:	02092783          	lw	a5,32(s2)
    80003da6:	9fa9                	addw	a5,a5,a0
    80003da8:	02f92023          	sw	a5,32(s2)
      iunlock(f->ip);
    80003dac:	01893503          	ld	a0,24(s2)
    80003db0:	fffff097          	auipc	ra,0xfffff
    80003db4:	ebe080e7          	jalr	-322(ra) # 80002c6e <iunlock>
      end_op();
    80003db8:	00000097          	auipc	ra,0x0
    80003dbc:	8ea080e7          	jalr	-1814(ra) # 800036a2 <end_op>

      if(r != n1){
    80003dc0:	009a9f63          	bne	s5,s1,80003dde <filewrite+0xf6>
        // error from writei
        break;
      }
      i += r;
    80003dc4:	013489bb          	addw	s3,s1,s3
    while(i < n){
    80003dc8:	0149db63          	bge	s3,s4,80003dde <filewrite+0xf6>
      int n1 = n - i;
    80003dcc:	413a04bb          	subw	s1,s4,s3
    80003dd0:	0004879b          	sext.w	a5,s1
    80003dd4:	f8fbdce3          	bge	s7,a5,80003d6c <filewrite+0x84>
    80003dd8:	84e2                	mv	s1,s8
    80003dda:	bf49                	j	80003d6c <filewrite+0x84>
    int i = 0;
    80003ddc:	4981                	li	s3,0
    }
    ret = (i == n ? n : -1);
    80003dde:	013a1f63          	bne	s4,s3,80003dfc <filewrite+0x114>
  } else {
    panic("filewrite");
  }
  ...
  return ret;
    ...
    80003df4:	6ba2                	ld	s7,8(sp)
    80003df6:	6c02                	ld	s8,0(sp)
    80003df8:	6161                	addi	sp,sp,80
    80003dfa:	8082                	ret
    ret = (i == n ? n : -1);
    80003dfc:	5a7d                	li	s4,-1
    80003dfe:	b7d5                	j	80003de2 <filewrite+0xfa>
    panic("filewrite");
    80003e00:	00005517          	auipc	a0,0x5
    80003e04:	84050513          	addi	a0,a0,-1984 # 80008640 <syscalls+0x270>
    80003e08:	00002097          	auipc	ra,0x2
    80003e0c:	044080e7          	jalr	68(ra) # 80005e4c <panic>
    return -1;
    80003e10:	5a7d                	li	s4,-1
    80003e12:	bfc1                	j	80003de2 <filewrite+0xfa>
      return -1;
    80003e14:	5a7d                	li	s4,-1
    80003e16:	b7f1                	j	80003de2 <filewrite+0xfa>
    80003e18:	5a7d                	li	s4,-1
    80003e1a:	b7e1                	j	80003de2 <filewrite+0xfa>

0000000080003e1c <pipealloc>:
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  if((*f0 = filealloc()) == 0 || (*f1 = filealloc()) == 0)
    ...
    80003e3c:	bf8080e7          	jalr	-1032(ra) # 80003a30 <filealloc>
    80003e40:	e088                	sd	a0,0(s1)
    80003e42:	c551                	beqz	a0,80003ece <pipealloc+0xb2>
    80003e44:	00000097          	auipc	ra,0x0
    80003e48:	bec080e7          	jalr	-1044(ra) # 80003a30 <filealloc>
    80003e4c:	00aa3023          	sd	a0,0(s4)
    80003e50:	c92d                	beqz	a0,80003ec2 <pipealloc+0xa6>
    goto bad;
  if((pi = (struct pipe*)kalloc()) == 0)
    80003e52:	ffffc097          	auipc	ra,0xffffc
    80003e56:	2c8080e7          	jalr	712(ra) # 8000011a <kalloc>
    80003e5a:	892a                	mv	s2,a0
    80003e5c:	c125                	beqz	a0,80003ebc <pipealloc+0xa0>
    goto bad;
  pi->readopen = 1;
    80003e5e:	4985                	li	s3,1
    80003e60:	23352023          	sw	s3,544(a0)
  pi->writeopen = 1;
    80003e64:	23352223          	sw	s3,548(a0)
  pi->nwrite = 0;
    80003e68:	20052e23          	sw	zero,540(a0)
  pi->nread = 0;
    80003e6c:	20052c23          	sw	zero,536(a0)
  initlock(&pi->lock, "pipe");
    80003e70:	00004597          	auipc	a1,0x4
    80003e74:	7e058593          	addi	a1,a1,2016 # 80008650 <syscalls+0x280>
    80003e78:	00002097          	auipc	ra,0x2
    80003e7c:	47c080e7          	jalr	1148(ra) # 800062f4 <initlock>
  (*f0)->type = FD_PIPE;
    80003e80:	609c                	ld	a5,0(s1)
    80003e82:	0137a023          	sw	s3,0(a5)
  (*f0)->readable = 1;
    80003e86:	609c                	ld	a5,0(s1)
    80003e88:	01378423          	sb	s3,8(a5)
  (*f0)->writable = 0;
    80003e8c:	609c                	ld	a5,0(s1)
    80003e8e:	000784a3          	sb	zero,9(a5)
  (*f0)->pipe = pi;
    80003e92:	609c                	ld	a5,0(s1)
    80003e94:	0127b823          	sd	s2,16(a5)
  (*f1)->type = FD_PIPE;
    80003e98:	000a3783          	ld	a5,0(s4)
    80003e9c:	0137a023          	sw	s3,0(a5)
  (*f1)->readable = 0;
    80003ea0:	000a3783          	ld	a5,0(s4)
    80003ea4:	00078423          	sb	zero,8(a5)
  (*f1)->writable = 1;
    80003ea8:	000a3783          	ld	a5,0(s4)
    80003eac:	013784a3          	sb	s3,9(a5)
  (*f1)->pipe = pi;
    80003eb0:	000a3783          	ld	a5,0(s4)
    80003eb4:	0127b823          	sd	s2,16(a5)
  return 0;
    80003eb8:	4501                	li	a0,0
    80003eba:	a025                	j	80003ee2 <pipealloc+0xc6>
 ...
 bad:
  ...
  if(*f0)
    ...
    80003ebe:	e501                	bnez	a0,80003ec6 <pipealloc+0xaa>
    80003ec0:	a039                	j	80003ece <pipealloc+0xb2>
    80003ec2:	6088                	ld	a0,0(s1)
    80003ec4:	c51d                	beqz	a0,80003ef2 <pipealloc+0xd6>
    fileclose(*f0);
    80003ec6:	00000097          	auipc	ra,0x0
    80003eca:	c26080e7          	jalr	-986(ra) # 80003aec <fileclose>
  if(*f1)
  ...
  if(*f1)
    80003ed4:	c799                	beqz	a5,80003ee2 <pipealloc+0xc6>
    fileclose(*f1);
    80003ed6:	853e                	mv	a0,a5
    80003ed8:	00000097          	auipc	ra,0x0
    80003edc:	c14080e7          	jalr	-1004(ra) # 80003aec <fileclose>
  return -1;
  ...
  return -1;
    ...
    80003ef4:	b7fd                	j	80003ee2 <pipealloc+0xc6>

0000000080003ef6 <pipeclose>:
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  acquire(&pi->lock);
    ...
    80003f0a:	47e080e7          	jalr	1150(ra) # 80006384 <acquire>
  if(writable){
    80003f0e:	02090d63          	beqz	s2,80003f48 <pipeclose+0x52>
    pi->writeopen = 0;
    80003f12:	2204a223          	sw	zero,548(s1)
    wakeup(&pi->nread);
    80003f16:	21848513          	addi	a0,s1,536
  ...
  if(pi->readopen == 0 && pi->writeopen == 0){
    80003f22:	2204b783          	ld	a5,544(s1)
    80003f26:	eb95                	bnez	a5,80003f5a <pipeclose+0x64>
    release(&pi->lock);
    80003f28:	8526                	mv	a0,s1
    80003f2a:	00002097          	auipc	ra,0x2
    80003f2e:	50e080e7          	jalr	1294(ra) # 80006438 <release>
    kfree((char*)pi);
    80003f32:	8526                	mv	a0,s1
    80003f34:	ffffc097          	auipc	ra,0xffffc
    80003f38:	0e8080e7          	jalr	232(ra) # 8000001c <kfree>
  } else
    release(&pi->lock);
}
    ...
    80003f46:	8082                	ret
    pi->readopen = 0;
    80003f48:	2204a023          	sw	zero,544(s1)
    wakeup(&pi->nwrite);
    80003f4c:	21c48513          	addi	a0,s1,540
    80003f50:	ffffd097          	auipc	ra,0xffffd
    80003f54:	610080e7          	jalr	1552(ra) # 80001560 <wakeup>
    80003f58:	b7e9                	j	80003f22 <pipeclose+0x2c>
    release(&pi->lock);
    80003f5a:	8526                	mv	a0,s1
    80003f5c:	00002097          	auipc	ra,0x2
    80003f60:	4dc080e7          	jalr	1244(ra) # 80006438 <release>
}
    80003f64:	bfe1                	j	80003f3c <pipeclose+0x46>

0000000080003f66 <pipewrite>:
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  struct proc *pr = myproc();
    ...
    80003f88:	ed0080e7          	jalr	-304(ra) # 80000e54 <myproc>
    80003f8c:	89aa                	mv	s3,a0

  acquire(&pi->lock);
    80003f8e:	8526                	mv	a0,s1
    80003f90:	00002097          	auipc	ra,0x2
    80003f94:	3f4080e7          	jalr	1012(ra) # 80006384 <acquire>
  while(i < n){
    80003f98:	0b405663          	blez	s4,80004044 <pipewrite+0xde>
  int i = 0;
    ...
    80003f9e:	5b7d                	li	s6,-1
      wakeup(&pi->nread);
    80003fa0:	21848c13          	addi	s8,s1,536
      sleep(&pi->nwrite, &pi->lock);
    80003fa4:	21c48b93          	addi	s7,s1,540
    80003fa8:	a089                	j	80003fea <pipewrite+0x84>
      release(&pi->lock);
    80003faa:	8526                	mv	a0,s1
    80003fac:	00002097          	auipc	ra,0x2
    80003fb0:	48c080e7          	jalr	1164(ra) # 80006438 <release>
      return -1;
  ...
  return i;
    ...
    80003fcc:	6125                	addi	sp,sp,96
    80003fce:	8082                	ret
      wakeup(&pi->nread);
    80003fd0:	8562                	mv	a0,s8
    80003fd2:	ffffd097          	auipc	ra,0xffffd
    80003fd6:	58e080e7          	jalr	1422(ra) # 80001560 <wakeup>
      sleep(&pi->nwrite, &pi->lock);
    80003fda:	85a6                	mv	a1,s1
    80003fdc:	855e                	mv	a0,s7
    80003fde:	ffffd097          	auipc	ra,0xffffd
    80003fe2:	51e080e7          	jalr	1310(ra) # 800014fc <sleep>
  while(i < n){
    80003fe6:	07495063          	bge	s2,s4,80004046 <pipewrite+0xe0>
    if(pi->readopen == 0 || killed(pr)){
    80003fea:	2204a783          	lw	a5,544(s1)
    80003fee:	dfd5                	beqz	a5,80003faa <pipewrite+0x44>
    80003ff0:	854e                	mv	a0,s3
    80003ff2:	ffffd097          	auipc	ra,0xffffd
    80003ff6:	7b2080e7          	jalr	1970(ra) # 800017a4 <killed>
    80003ffa:	f945                	bnez	a0,80003faa <pipewrite+0x44>
    if(pi->nwrite == pi->nread + PIPESIZE){ //DOC: pipewrite-full
    80003ffc:	2184a783          	lw	a5,536(s1)
    80004000:	21c4a703          	lw	a4,540(s1)
    80004004:	2007879b          	addiw	a5,a5,512
    80004008:	fcf704e3          	beq	a4,a5,80003fd0 <pipewrite+0x6a>
      if(copyin(pr->pagetable, &ch, addr + i, 1) == -1)
    8000400c:	4685                	li	a3,1
    8000400e:	01590633          	add	a2,s2,s5
    80004012:	faf40593          	addi	a1,s0,-81
    80004016:	0509b503          	ld	a0,80(s3)
    8000401a:	ffffd097          	auipc	ra,0xffffd
    8000401e:	b86080e7          	jalr	-1146(ra) # 80000ba0 <copyin>
    80004022:	03650263          	beq	a0,s6,80004046 <pipewrite+0xe0>
      pi->data[pi->nwrite++ % PIPESIZE] = ch;
    80004026:	21c4a783          	lw	a5,540(s1)
    8000402a:	0017871b          	addiw	a4,a5,1
    8000402e:	20e4ae23          	sw	a4,540(s1)
    80004032:	1ff7f793          	andi	a5,a5,511
    80004036:	97a6                	add	a5,a5,s1
    80004038:	faf44703          	lbu	a4,-81(s0)
    8000403c:	00e78c23          	sb	a4,24(a5)
      i++;
    80004040:	2905                	addiw	s2,s2,1
    80004042:	b755                	j	80003fe6 <pipewrite+0x80>
  int i = 0;
  ...
  release(&pi->lock);
    ...
    80004058:	3e4080e7          	jalr	996(ra) # 80006438 <release>
  return i;
    8000405c:	bfa9                	j	80003fb6 <pipewrite+0x50>
...
piperead(struct pipe *pi, uint64 addr, int n)
{
    ...
    80004066:	f84a                	sd	s2,48(sp)
    80004068:	f44e                	sd	s3,40(sp)
    8000406a:	f052                	sd	s4,32(sp)
    8000406c:	ec56                	sd	s5,24(sp)
    8000406e:	e85a                	sd	s6,16(sp)
    80004070:	0880                	addi	s0,sp,80
    80004072:	84aa                	mv	s1,a0
    80004074:	892e                	mv	s2,a1
    80004076:	8ab2                	mv	s5,a2
  int i;
  struct proc *pr = myproc();
    80004078:	ffffd097          	auipc	ra,0xffffd
    8000407c:	ddc080e7          	jalr	-548(ra) # 80000e54 <myproc>
  ...
  acquire(&pi->lock);
    ...
    80004088:	300080e7          	jalr	768(ra) # 80006384 <acquire>
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    8000408c:	2184a703          	lw	a4,536(s1)
    80004090:	21c4a783          	lw	a5,540(s1)
    if(killed(pr)){
      release(&pi->lock);
      return -1;
    }
    sleep(&pi->nread, &pi->lock); //DOC: piperead-sleep
    80004094:	21848993          	addi	s3,s1,536
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    80004098:	02f71763          	bne	a4,a5,800040c6 <piperead+0x68>
    8000409c:	2244a783          	lw	a5,548(s1)
    800040a0:	c39d                	beqz	a5,800040c6 <piperead+0x68>
    if(killed(pr)){
    800040a2:	8552                	mv	a0,s4
    800040a4:	ffffd097          	auipc	ra,0xffffd
    800040a8:	700080e7          	jalr	1792(ra) # 800017a4 <killed>
    800040ac:	e949                	bnez	a0,8000413e <piperead+0xe0>
    sleep(&pi->nread, &pi->lock); //DOC: piperead-sleep
    800040ae:	85a6                	mv	a1,s1
    800040b0:	854e                	mv	a0,s3
    800040b2:	ffffd097          	auipc	ra,0xffffd
    800040b6:	44a080e7          	jalr	1098(ra) # 800014fc <sleep>
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    800040ba:	2184a703          	lw	a4,536(s1)
    800040be:	21c4a783          	lw	a5,540(s1)
    800040c2:	fcf70de3          	beq	a4,a5,8000409c <piperead+0x3e>
  }
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    ...
    800040c8:	5b7d                	li	s6,-1
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    800040ca:	05505463          	blez	s5,80004112 <piperead+0xb4>
    if(pi->nread == pi->nwrite)
    800040ce:	2184a783          	lw	a5,536(s1)
    800040d2:	21c4a703          	lw	a4,540(s1)
    800040d6:	02f70e63          	beq	a4,a5,80004112 <piperead+0xb4>
    ch = pi->data[pi->nread++ % PIPESIZE];
    ...
    80004100:	a18080e7          	jalr	-1512(ra) # 80000b14 <copyout>
    80004104:	01650763          	beq	a0,s6,80004112 <piperead+0xb4>
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    80004108:	2985                	addiw	s3,s3,1
    8000410a:	0905                	addi	s2,s2,1
    8000410c:	fd3a91e3          	bne	s5,s3,800040ce <piperead+0x70>
    80004110:	89d6                	mv	s3,s5
      break;
  }
  wakeup(&pi->nwrite);  //DOC: piperead-wakeup
    80004112:	21c48513          	addi	a0,s1,540
    80004116:	ffffd097          	auipc	ra,0xffffd
    8000411a:	44a080e7          	jalr	1098(ra) # 80001560 <wakeup>
  release(&pi->lock);
    8000411e:	8526                	mv	a0,s1
    80004120:	00002097          	auipc	ra,0x2
    80004124:	318080e7          	jalr	792(ra) # 80006438 <release>
  return i;
}
    ...
    80004134:	7a02                	ld	s4,32(sp)
    80004136:	6ae2                	ld	s5,24(sp)
    80004138:	6b42                	ld	s6,16(sp)
    8000413a:	6161                	addi	sp,sp,80
    8000413c:	8082                	ret
      release(&pi->lock);
    8000413e:	8526                	mv	a0,s1
    80004140:	00002097          	auipc	ra,0x2
    80004144:	2f8080e7          	jalr	760(ra) # 80006438 <release>
      return -1;
    80004148:	59fd                	li	s3,-1
    8000414a:	bff9                	j	80004128 <piperead+0xca>

000000008000414c <flags2perm>:
#include "elf.h"
...
int flags2perm(int flags)
{
    ...
    int perm = 0;
    if(flags & 0x1)
    80004154:	8905                	andi	a0,a0,1
    80004156:	050e                	slli	a0,a0,0x3
      perm = PTE_X;
    if(flags & 0x2)
    80004158:	8b89                	andi	a5,a5,2
    8000415a:	c399                	beqz	a5,80004160 <flags2perm+0x14>
      perm |= PTE_W;
    8000415c:	00456513          	ori	a0,a0,4
    return perm;
}
    80004160:	6422                	ld	s0,8(sp)
...
exec(char *path, char **argv)
{
  ...
  struct proc *p = myproc();
    ...
    8000419c:	cbc080e7          	jalr	-836(ra) # 80000e54 <myproc>
    800041a0:	84aa                	mv	s1,a0

  begin_op();
    800041a2:	fffff097          	auipc	ra,0xfffff
    800041a6:	482080e7          	jalr	1154(ra) # 80003624 <begin_op>

  if((ip = namei(path)) == 0){
    800041aa:	854a                	mv	a0,s2
    800041ac:	fffff097          	auipc	ra,0xfffff
    800041b0:	258080e7          	jalr	600(ra) # 80003404 <namei>
  ...
  ilock(ip);
    ...
    800041bc:	9f4080e7          	jalr	-1548(ra) # 80002bac <ilock>
  ...
  if(readi(ip, 0, (uint64)&elf, 0, sizeof(elf)) != sizeof(elf))
    ...
    800041d2:	d3c080e7          	jalr	-708(ra) # 80002f0a <readi>
 ...
 bad:
  ...
  if(ip){
    ...
    800041f4:	cc8080e7          	jalr	-824(ra) # 80002eb8 <iunlockput>
    end_op();
    800041f8:	fffff097          	auipc	ra,0xfffff
    800041fc:	4aa080e7          	jalr	1194(ra) # 800036a2 <end_op>
  }
  return -1;
    ...
    8000422e:	478080e7          	jalr	1144(ra) # 800036a2 <end_op>
    return -1;
  ...
  if((pagetable = proc_pagetable(p)) == 0)
    ...
    8000423c:	ce0080e7          	jalr	-800(ra) # 80000f18 <proc_pagetable>
...
loadseg(pagetable_t pagetable, uint64 va, struct inode *ip, uint offset, uint sz)
{
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80004262:	ac3d                	j	800044a0 <exec+0x33a>
    pa = walkaddr(pagetable, va + i);
    if(pa == 0)
      panic("loadseg: address should exist");
    80004264:	00004517          	auipc	a0,0x4
    80004268:	3f450513          	addi	a0,a0,1012 # 80008658 <syscalls+0x288>
    8000426c:	00002097          	auipc	ra,0x2
    80004270:	be0080e7          	jalr	-1056(ra) # 80005e4c <panic>
    if(sz - i < PGSIZE)
      n = sz - i;
    else
      n = PGSIZE;
    ...
    80004282:	c8c080e7          	jalr	-884(ra) # 80002f0a <readi>
    80004286:	2501                	sext.w	a0,a0
    80004288:	1aa91963          	bne	s2,a0,8000443a <exec+0x2d4>
  for(i = 0; i < sz; i += PGSIZE){
    8000428c:	009d84bb          	addw	s1,s11,s1
    80004290:	013d09bb          	addw	s3,s10,s3
    80004294:	1f74f663          	bgeu	s1,s7,80004480 <exec+0x31a>
    pa = walkaddr(pagetable, va + i);
    ...
    800042a6:	262080e7          	jalr	610(ra) # 80000504 <walkaddr>
  ...
  iunlockput(ip);
    ...
    800042c0:	bfc080e7          	jalr	-1028(ra) # 80002eb8 <iunlockput>
  end_op();
    800042c4:	fffff097          	auipc	ra,0xfffff
    800042c8:	3de080e7          	jalr	990(ra) # 800036a2 <end_op>
  p = myproc();
    800042cc:	ffffd097          	auipc	ra,0xffffd
    800042d0:	b88080e7          	jalr	-1144(ra) # 80000e54 <myproc>
    800042d4:	8baa                	mv	s7,a0
  uint64 oldsz = p->sz;
    800042d6:	04853d03          	ld	s10,72(a0)
  sz = PGROUNDUP(sz);
    800042da:	6785                	lui	a5,0x1
    800042dc:	17fd                	addi	a5,a5,-1 # fff <_entry-0x7ffff001>
    800042de:	97ca                	add	a5,a5,s2
    800042e0:	777d                	lui	a4,0xfffff
    800042e2:	8ff9                	and	a5,a5,a4
    800042e4:	def43c23          	sd	a5,-520(s0)
  if((sz1 = uvmalloc(pagetable, sz, sz + 2*PGSIZE, PTE_W)) == 0)
    800042e8:	4691                	li	a3,4
    800042ea:	6609                	lui	a2,0x2
    800042ec:	963e                	add	a2,a2,a5
    800042ee:	85be                	mv	a1,a5
    800042f0:	855a                	mv	a0,s6
    800042f2:	ffffc097          	auipc	ra,0xffffc
    800042f6:	5c6080e7          	jalr	1478(ra) # 800008b8 <uvmalloc>
    800042fa:	8c2a                	mv	s8,a0
  ip = 0;
    800042fc:	4a81                	li	s5,0
  if((sz1 = uvmalloc(pagetable, sz, sz + 2*PGSIZE, PTE_W)) == 0)
    800042fe:	12050e63          	beqz	a0,8000443a <exec+0x2d4>
  uvmclear(pagetable, sz-2*PGSIZE);
    80004302:	75f9                	lui	a1,0xffffe
    80004304:	95aa                	add	a1,a1,a0
    80004306:	855a                	mv	a0,s6
    80004308:	ffffc097          	auipc	ra,0xffffc
    8000430c:	7da080e7          	jalr	2010(ra) # 80000ae2 <uvmclear>
  stackbase = sp - PGSIZE;
    80004310:	7afd                	lui	s5,0xfffff
    80004312:	9ae2                	add	s5,s5,s8
  for(argc = 0; argv[argc]; argc++) {
    80004314:	df043783          	ld	a5,-528(s0)
    80004318:	6388                	ld	a0,0(a5)
    8000431a:	c925                	beqz	a0,8000438a <exec+0x224>
    8000431c:	e9040993          	addi	s3,s0,-368
    80004320:	f9040c93          	addi	s9,s0,-112
  sp = sz;
    80004324:	8962                	mv	s2,s8
  for(argc = 0; argv[argc]; argc++) {
    80004326:	4481                	li	s1,0
    sp -= strlen(argv[argc]) + 1;
    80004328:	ffffc097          	auipc	ra,0xffffc
    8000432c:	fce080e7          	jalr	-50(ra) # 800002f6 <strlen>
    80004330:	0015079b          	addiw	a5,a0,1
    80004334:	40f907b3          	sub	a5,s2,a5
    sp -= sp % 16; // riscv sp must be 16-byte aligned
    80004338:	ff07f913          	andi	s2,a5,-16
    if(sp < stackbase)
    8000433c:	13596663          	bltu	s2,s5,80004468 <exec+0x302>
    if(copyout(pagetable, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
    80004340:	df043d83          	ld	s11,-528(s0)
    80004344:	000dba03          	ld	s4,0(s11) # 1000 <_entry-0x7ffff000>
    80004348:	8552                	mv	a0,s4
    8000434a:	ffffc097          	auipc	ra,0xffffc
    8000434e:	fac080e7          	jalr	-84(ra) # 800002f6 <strlen>
    80004352:	0015069b          	addiw	a3,a0,1
    80004356:	8652                	mv	a2,s4
    80004358:	85ca                	mv	a1,s2
    8000435a:	855a                	mv	a0,s6
    8000435c:	ffffc097          	auipc	ra,0xffffc
    80004360:	7b8080e7          	jalr	1976(ra) # 80000b14 <copyout>
    80004364:	10054663          	bltz	a0,80004470 <exec+0x30a>
    ustack[argc] = sp;
    80004368:	0129b023          	sd	s2,0(s3)
  for(argc = 0; argv[argc]; argc++) {
    8000436c:	0485                	addi	s1,s1,1
    8000436e:	008d8793          	addi	a5,s11,8
    80004372:	def43823          	sd	a5,-528(s0)
    80004376:	008db503          	ld	a0,8(s11)
    8000437a:	c911                	beqz	a0,8000438e <exec+0x228>
    if(argc >= MAXARG)
    8000437c:	09a1                	addi	s3,s3,8
    8000437e:	fb3c95e3          	bne	s9,s3,80004328 <exec+0x1c2>
  sz = sz1;
    80004382:	df843c23          	sd	s8,-520(s0)
  ip = 0;
    80004386:	4a81                	li	s5,0
    80004388:	a84d                	j	8000443a <exec+0x2d4>
  sp = sz;
    8000438a:	8962                	mv	s2,s8
  for(argc = 0; argv[argc]; argc++) {
    8000438c:	4481                	li	s1,0
  ustack[argc] = 0;
    8000438e:	00349793          	slli	a5,s1,0x3
    80004392:	f9078793          	addi	a5,a5,-112
    80004396:	97a2                	add	a5,a5,s0
    80004398:	f007b023          	sd	zero,-256(a5)
  sp -= (argc+1) * sizeof(uint64);
    8000439c:	00148693          	addi	a3,s1,1
    800043a0:	068e                	slli	a3,a3,0x3
    800043a2:	40d90933          	sub	s2,s2,a3
  sp -= sp % 16;
    800043a6:	ff097913          	andi	s2,s2,-16
  if(sp < stackbase)
    800043aa:	01597663          	bgeu	s2,s5,800043b6 <exec+0x250>
  sz = sz1;
    800043ae:	df843c23          	sd	s8,-520(s0)
  ip = 0;
    800043b2:	4a81                	li	s5,0
    800043b4:	a059                	j	8000443a <exec+0x2d4>
  if(copyout(pagetable, sp, (char *)ustack, (argc+1)*sizeof(uint64)) < 0)
    800043b6:	e9040613          	addi	a2,s0,-368
    800043ba:	85ca                	mv	a1,s2
    800043bc:	855a                	mv	a0,s6
    800043be:	ffffc097          	auipc	ra,0xffffc
    800043c2:	756080e7          	jalr	1878(ra) # 80000b14 <copyout>
    800043c6:	0a054963          	bltz	a0,80004478 <exec+0x312>
  p->trapframe->a1 = sp;
    800043ca:	058bb783          	ld	a5,88(s7)
    800043ce:	0727bc23          	sd	s2,120(a5)
  for(last=s=path; *s; s++)
    800043d2:	de843783          	ld	a5,-536(s0)
    800043d6:	0007c703          	lbu	a4,0(a5)
    800043da:	cf11                	beqz	a4,800043f6 <exec+0x290>
    800043dc:	0785                	addi	a5,a5,1
    if(*s == '/')
    800043de:	02f00693          	li	a3,47
    800043e2:	a039                	j	800043f0 <exec+0x28a>
      last = s+1;
    800043e4:	def43423          	sd	a5,-536(s0)
  for(last=s=path; *s; s++)
    800043e8:	0785                	addi	a5,a5,1
    800043ea:	fff7c703          	lbu	a4,-1(a5)
    800043ee:	c701                	beqz	a4,800043f6 <exec+0x290>
    if(*s == '/')
    800043f0:	fed71ce3          	bne	a4,a3,800043e8 <exec+0x282>
    800043f4:	bfc5                	j	800043e4 <exec+0x27e>
  safestrcpy(p->name, last, sizeof(p->name));
    800043f6:	4641                	li	a2,16
    800043f8:	de843583          	ld	a1,-536(s0)
    800043fc:	158b8513          	addi	a0,s7,344
    80004400:	ffffc097          	auipc	ra,0xffffc
    80004404:	ec4080e7          	jalr	-316(ra) # 800002c4 <safestrcpy>
  oldpagetable = p->pagetable;
    80004408:	050bb503          	ld	a0,80(s7)
  p->pagetable = pagetable;
    8000440c:	056bb823          	sd	s6,80(s7)
  p->sz = sz;
    80004410:	058bb423          	sd	s8,72(s7)
  p->trapframe->epc = elf.entry;  // initial program counter = main
    80004414:	058bb783          	ld	a5,88(s7)
    80004418:	e6843703          	ld	a4,-408(s0)
    8000441c:	ef98                	sd	a4,24(a5)
  p->trapframe->sp = sp; // initial stack pointer
    8000441e:	058bb783          	ld	a5,88(s7)
    80004422:	0327b823          	sd	s2,48(a5)
  proc_freepagetable(oldpagetable, oldsz);
    80004426:	85ea                	mv	a1,s10
    80004428:	ffffd097          	auipc	ra,0xffffd
    8000442c:	b8c080e7          	jalr	-1140(ra) # 80000fb4 <proc_freepagetable>
  return argc; // this ends up in a0, the first argument to main(argc, argv)
    80004430:	0004851b          	sext.w	a0,s1
    80004434:	b3f9                	j	80004202 <exec+0x9c>
    80004436:	df243c23          	sd	s2,-520(s0)
    proc_freepagetable(pagetable, sz);
    8000443a:	df843583          	ld	a1,-520(s0)
    8000443e:	855a                	mv	a0,s6
    80004440:	ffffd097          	auipc	ra,0xffffd
    80004444:	b74080e7          	jalr	-1164(ra) # 80000fb4 <proc_freepagetable>
  if(ip){
    80004448:	da0a93e3          	bnez	s5,800041ee <exec+0x88>
  return -1;
    8000444c:	557d                	li	a0,-1
    8000444e:	bb55                	j	80004202 <exec+0x9c>
    80004450:	df243c23          	sd	s2,-520(s0)
    80004454:	b7dd                	j	8000443a <exec+0x2d4>
    80004456:	df243c23          	sd	s2,-520(s0)
    8000445a:	b7c5                	j	8000443a <exec+0x2d4>
    8000445c:	df243c23          	sd	s2,-520(s0)
    80004460:	bfe9                	j	8000443a <exec+0x2d4>
    80004462:	df243c23          	sd	s2,-520(s0)
    80004466:	bfd1                	j	8000443a <exec+0x2d4>
  sz = sz1;
    80004468:	df843c23          	sd	s8,-520(s0)
  ip = 0;
    8000446c:	4a81                	li	s5,0
    8000446e:	b7f1                	j	8000443a <exec+0x2d4>
  sz = sz1;
    80004470:	df843c23          	sd	s8,-520(s0)
  ip = 0;
    80004474:	4a81                	li	s5,0
    80004476:	b7d1                	j	8000443a <exec+0x2d4>
  sz = sz1;
    80004478:	df843c23          	sd	s8,-520(s0)
  ip = 0;
    8000447c:	4a81                	li	s5,0
    8000447e:	bf75                	j	8000443a <exec+0x2d4>
    if((sz1 = uvmalloc(pagetable, sz, ph.vaddr + ph.memsz, flags2perm(ph.flags))) == 0)
    80004480:	df843903          	ld	s2,-520(s0)
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    80004484:	e0843783          	ld	a5,-504(s0)
    80004488:	0017869b          	addiw	a3,a5,1
    8000448c:	e0d43423          	sd	a3,-504(s0)
    80004490:	e0043783          	ld	a5,-512(s0)
    80004494:	0387879b          	addiw	a5,a5,56
    80004498:	e8845703          	lhu	a4,-376(s0)
    8000449c:	e0e6dfe3          	bge	a3,a4,800042ba <exec+0x154>
    if(readi(ip, 0, (uint64)&ph, off, sizeof(ph)) != sizeof(ph))
    800044a0:	2781                	sext.w	a5,a5
    800044a2:	e0f43023          	sd	a5,-512(s0)
    800044a6:	03800713          	li	a4,56
    800044aa:	86be                	mv	a3,a5
    800044ac:	e1840613          	addi	a2,s0,-488
    800044b0:	4581                	li	a1,0
    800044b2:	8556                	mv	a0,s5
    800044b4:	fffff097          	auipc	ra,0xfffff
    800044b8:	a56080e7          	jalr	-1450(ra) # 80002f0a <readi>
    800044bc:	03800793          	li	a5,56
    800044c0:	f6f51be3          	bne	a0,a5,80004436 <exec+0x2d0>
    if(ph.type != ELF_PROG_LOAD)
    800044c4:	e1842783          	lw	a5,-488(s0)
    800044c8:	4705                	li	a4,1
    800044ca:	fae79de3          	bne	a5,a4,80004484 <exec+0x31e>
    if(ph.memsz < ph.filesz)
    800044ce:	e4043483          	ld	s1,-448(s0)
    800044d2:	e3843783          	ld	a5,-456(s0)
    800044d6:	f6f4ede3          	bltu	s1,a5,80004450 <exec+0x2ea>
    if(ph.vaddr + ph.memsz < ph.vaddr)
    800044da:	e2843783          	ld	a5,-472(s0)
    800044de:	94be                	add	s1,s1,a5
    800044e0:	f6f4ebe3          	bltu	s1,a5,80004456 <exec+0x2f0>
    if(ph.vaddr % PGSIZE != 0)
    800044e4:	de043703          	ld	a4,-544(s0)
    800044e8:	8ff9                	and	a5,a5,a4
    800044ea:	fbad                	bnez	a5,8000445c <exec+0x2f6>
    if((sz1 = uvmalloc(pagetable, sz, ph.vaddr + ph.memsz, flags2perm(ph.flags))) == 0)
    800044ec:	e1c42503          	lw	a0,-484(s0)
    800044f0:	00000097          	auipc	ra,0x0
    800044f4:	c5c080e7          	jalr	-932(ra) # 8000414c <flags2perm>
    800044f8:	86aa                	mv	a3,a0
    800044fa:	8626                	mv	a2,s1
    800044fc:	85ca                	mv	a1,s2
    800044fe:	855a                	mv	a0,s6
    80004500:	ffffc097          	auipc	ra,0xffffc
    80004504:	3b8080e7          	jalr	952(ra) # 800008b8 <uvmalloc>
    80004508:	dea43c23          	sd	a0,-520(s0)
    8000450c:	d939                	beqz	a0,80004462 <exec+0x2fc>
    if(loadseg(pagetable, ph.vaddr, ip, ph.off, ph.filesz) < 0)
    8000450e:	e2843c03          	ld	s8,-472(s0)
    80004512:	e2042c83          	lw	s9,-480(s0)
    80004516:	e3842b83          	lw	s7,-456(s0)
  for(i = 0; i < sz; i += PGSIZE){
    8000451a:	f60b83e3          	beqz	s7,80004480 <exec+0x31a>
    8000451e:	89de                	mv	s3,s7
    80004520:	4481                	li	s1,0
    80004522:	bb9d                	j	80004298 <exec+0x132>
...
create(char *path, short type, short major, short minor)
{
    ...
    80004534:	e85a                	sd	s6,16(sp)
    80004536:	0880                	addi	s0,sp,80
    80004538:	8b2e                	mv	s6,a1
    8000453a:	89b2                	mv	s3,a2
    8000453c:	8936                	mv	s2,a3
  struct inode *ip, *dp;
  char name[DIRSIZ];
  ...
  if((dp = nameiparent(path, name)) == 0)
    ...
    80004546:	ee0080e7          	jalr	-288(ra) # 80003422 <nameiparent>
    8000454a:	84aa                	mv	s1,a0
    8000454c:	14050f63          	beqz	a0,800046aa <create+0x186>
    return 0;

  ilock(dp);
    80004550:	ffffe097          	auipc	ra,0xffffe
    80004554:	65c080e7          	jalr	1628(ra) # 80002bac <ilock>
  ...
  if((ip = dirlookup(dp, name, 0)) != 0){
    ...
    80004564:	bdc080e7          	jalr	-1060(ra) # 8000313c <dirlookup>
    80004568:	8aaa                	mv	s5,a0
    8000456a:	c931                	beqz	a0,800045be <create+0x9a>
    iunlockput(dp);
    8000456c:	8526                	mv	a0,s1
    8000456e:	fffff097          	auipc	ra,0xfffff
    80004572:	94a080e7          	jalr	-1718(ra) # 80002eb8 <iunlockput>
    ilock(ip);
    80004576:	8556                	mv	a0,s5
    80004578:	ffffe097          	auipc	ra,0xffffe
    8000457c:	634080e7          	jalr	1588(ra) # 80002bac <ilock>
    if(type == T_FILE && (ip->type == T_FILE || ip->type == T_DEVICE))
    80004580:	000b059b          	sext.w	a1,s6
    80004584:	4789                	li	a5,2
    80004586:	02f59563          	bne	a1,a5,800045b0 <create+0x8c>
    8000458a:	044ad783          	lhu	a5,68(s5) # fffffffffffff044 <end+0xffffffff7ffe1ed4>
    8000458e:	37f9                	addiw	a5,a5,-2
    80004590:	17c2                	slli	a5,a5,0x30
    80004592:	93c1                	srli	a5,a5,0x30
    80004594:	4705                	li	a4,1
    80004596:	00f76d63          	bltu	a4,a5,800045b0 <create+0x8c>
  ip->nlink = 0;
  iupdate(ip);
  iunlockput(ip);
  iunlockput(dp);
  return 0;
    ...
    800045b6:	906080e7          	jalr	-1786(ra) # 80002eb8 <iunlockput>
    return 0;
    800045ba:	4a81                	li	s5,0
    800045bc:	bff9                	j	8000459a <create+0x76>
  if((ip = ialloc(dp->dev, type)) == 0){
    800045be:	85da                	mv	a1,s6
    800045c0:	4088                	lw	a0,0(s1)
    800045c2:	ffffe097          	auipc	ra,0xffffe
    800045c6:	44c080e7          	jalr	1100(ra) # 80002a0e <ialloc>
    800045ca:	8a2a                	mv	s4,a0
    800045cc:	c539                	beqz	a0,8000461a <create+0xf6>
  ilock(ip);
    800045ce:	ffffe097          	auipc	ra,0xffffe
    800045d2:	5de080e7          	jalr	1502(ra) # 80002bac <ilock>
  ip->major = major;
    800045d6:	053a1323          	sh	s3,70(s4)
  ip->minor = minor;
    800045da:	052a1423          	sh	s2,72(s4)
  ip->nlink = 1;
    800045de:	4905                	li	s2,1
    800045e0:	052a1523          	sh	s2,74(s4)
  iupdate(ip);
    800045e4:	8552                	mv	a0,s4
    800045e6:	ffffe097          	auipc	ra,0xffffe
    800045ea:	4fa080e7          	jalr	1274(ra) # 80002ae0 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
    800045ee:	000b059b          	sext.w	a1,s6
    800045f2:	03258b63          	beq	a1,s2,80004628 <create+0x104>
  if(dirlink(dp, name, ip->inum) < 0)
    800045f6:	004a2603          	lw	a2,4(s4)
    800045fa:	fb040593          	addi	a1,s0,-80
    800045fe:	8526                	mv	a0,s1
    80004600:	fffff097          	auipc	ra,0xfffff
    80004604:	d52080e7          	jalr	-686(ra) # 80003352 <dirlink>
    80004608:	06054f63          	bltz	a0,80004686 <create+0x162>
  iunlockput(dp);
    8000460c:	8526                	mv	a0,s1
    8000460e:	fffff097          	auipc	ra,0xfffff
    80004612:	8aa080e7          	jalr	-1878(ra) # 80002eb8 <iunlockput>
  return ip;
    80004616:	8ad2                	mv	s5,s4
    80004618:	b749                	j	8000459a <create+0x76>
    iunlockput(dp);
    8000461a:	8526                	mv	a0,s1
    8000461c:	fffff097          	auipc	ra,0xfffff
    80004620:	89c080e7          	jalr	-1892(ra) # 80002eb8 <iunlockput>
    return 0;
    80004624:	8ad2                	mv	s5,s4
    80004626:	bf95                	j	8000459a <create+0x76>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
    80004628:	004a2603          	lw	a2,4(s4)
    8000462c:	00004597          	auipc	a1,0x4
    80004630:	04c58593          	addi	a1,a1,76 # 80008678 <syscalls+0x2a8>
    80004634:	8552                	mv	a0,s4
    80004636:	fffff097          	auipc	ra,0xfffff
    8000463a:	d1c080e7          	jalr	-740(ra) # 80003352 <dirlink>
    8000463e:	04054463          	bltz	a0,80004686 <create+0x162>
    80004642:	40d0                	lw	a2,4(s1)
    80004644:	00004597          	auipc	a1,0x4
    80004648:	03c58593          	addi	a1,a1,60 # 80008680 <syscalls+0x2b0>
    8000464c:	8552                	mv	a0,s4
    8000464e:	fffff097          	auipc	ra,0xfffff
    80004652:	d04080e7          	jalr	-764(ra) # 80003352 <dirlink>
    80004656:	02054863          	bltz	a0,80004686 <create+0x162>
  if(dirlink(dp, name, ip->inum) < 0)
    8000465a:	004a2603          	lw	a2,4(s4)
    8000465e:	fb040593          	addi	a1,s0,-80
    80004662:	8526                	mv	a0,s1
    80004664:	fffff097          	auipc	ra,0xfffff
    80004668:	cee080e7          	jalr	-786(ra) # 80003352 <dirlink>
    8000466c:	00054d63          	bltz	a0,80004686 <create+0x162>
    dp->nlink++;  // for ".."
    80004670:	04a4d783          	lhu	a5,74(s1)
    80004674:	2785                	addiw	a5,a5,1
    80004676:	04f49523          	sh	a5,74(s1)
    iupdate(dp);
    8000467a:	8526                	mv	a0,s1
    8000467c:	ffffe097          	auipc	ra,0xffffe
    80004680:	464080e7          	jalr	1124(ra) # 80002ae0 <iupdate>
    80004684:	b761                	j	8000460c <create+0xe8>
  ip->nlink = 0;
    80004686:	040a1523          	sh	zero,74(s4)
  iupdate(ip);
    8000468a:	8552                	mv	a0,s4
    8000468c:	ffffe097          	auipc	ra,0xffffe
    80004690:	454080e7          	jalr	1108(ra) # 80002ae0 <iupdate>
  iunlockput(ip);
    80004694:	8552                	mv	a0,s4
    80004696:	fffff097          	auipc	ra,0xfffff
    8000469a:	822080e7          	jalr	-2014(ra) # 80002eb8 <iunlockput>
  iunlockput(dp);
    8000469e:	8526                	mv	a0,s1
    800046a0:	fffff097          	auipc	ra,0xfffff
    800046a4:	818080e7          	jalr	-2024(ra) # 80002eb8 <iunlockput>
  return 0;
    800046a8:	bdcd                	j	8000459a <create+0x76>
    return 0;
    800046aa:	8aaa                	mv	s5,a0
    800046ac:	b5fd                	j	8000459a <create+0x76>

00000000800046ae <argfd>:
{
    800046ae:	7179                	addi	sp,sp,-48
    800046b0:	f406                	sd	ra,40(sp)
    800046b2:	f022                	sd	s0,32(sp)
    800046b4:	ec26                	sd	s1,24(sp)
    800046b6:	e84a                	sd	s2,16(sp)
    800046b8:	1800                	addi	s0,sp,48
    800046ba:	892e                	mv	s2,a1
    800046bc:	84b2                	mv	s1,a2
  argint(n, &fd);
    800046be:	fdc40593          	addi	a1,s0,-36
    800046c2:	ffffe097          	auipc	ra,0xffffe
    800046c6:	8a8080e7          	jalr	-1880(ra) # 80001f6a <argint>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
    800046ca:	fdc42703          	lw	a4,-36(s0)
    800046ce:	47bd                	li	a5,15
    800046d0:	02e7eb63          	bltu	a5,a4,80004706 <argfd+0x58>
    800046d4:	ffffc097          	auipc	ra,0xffffc
    800046d8:	780080e7          	jalr	1920(ra) # 80000e54 <myproc>
    800046dc:	fdc42703          	lw	a4,-36(s0)
    800046e0:	01a70793          	addi	a5,a4,26 # fffffffffffff01a <end+0xffffffff7ffe1eaa>
    800046e4:	078e                	slli	a5,a5,0x3
    800046e6:	953e                	add	a0,a0,a5
    800046e8:	611c                	ld	a5,0(a0)
    800046ea:	c385                	beqz	a5,8000470a <argfd+0x5c>
  if(pfd)
    800046ec:	00090463          	beqz	s2,800046f4 <argfd+0x46>
    *pfd = fd;
    800046f0:	00e92023          	sw	a4,0(s2)
  return 0;
    800046f4:	4501                	li	a0,0
  if(pf)
    800046f6:	c091                	beqz	s1,800046fa <argfd+0x4c>
    *pf = f;
    ...
    80004708:	bfcd                	j	800046fa <argfd+0x4c>
    8000470a:	557d                	li	a0,-1
    8000470c:	b7fd                	j	800046fa <argfd+0x4c>

000000008000470e <fdalloc>:
{
  ...
  struct proc *p = myproc();
    ...
    8000471e:	73a080e7          	jalr	1850(ra) # 80000e54 <myproc>
    80004722:	862a                	mv	a2,a0
  for(fd = 0; fd < NOFILE; fd++){
    80004724:	0d050793          	addi	a5,a0,208
    80004728:	4501                	li	a0,0
    8000472a:	46c1                	li	a3,16
    if(p->ofile[fd] == 0){
    8000472c:	6398                	ld	a4,0(a5)
    8000472e:	cb19                	beqz	a4,80004744 <fdalloc+0x36>
  for(fd = 0; fd < NOFILE; fd++){
    80004730:	2505                	addiw	a0,a0,1
    80004732:	07a1                	addi	a5,a5,8
    80004734:	fed51ce3          	bne	a0,a3,8000472c <fdalloc+0x1e>
  return -1;
    ...
    80004742:	8082                	ret
      p->ofile[fd] = f;
    80004744:	01a50793          	addi	a5,a0,26
    80004748:	078e                	slli	a5,a5,0x3
    8000474a:	963e                	add	a2,a2,a5
    8000474c:	e204                	sd	s1,0(a2)
      return fd;
    8000474e:	b7f5                	j	8000473a <fdalloc+0x2c>

0000000080004750 <sys_symlink>:
{
    80004750:	712d                	addi	sp,sp,-288
    80004752:	ee06                	sd	ra,280(sp)
    80004754:	ea22                	sd	s0,272(sp)
    80004756:	e626                	sd	s1,264(sp)
    80004758:	1200                	addi	s0,sp,288
  if(argstr(0, target, MAXPATH) < 0 || argstr(1, path, MAXPATH) < 0)
    8000475a:	08000613          	li	a2,128
    8000475e:	f6040593          	addi	a1,s0,-160
    80004762:	4501                	li	a0,0
    80004764:	ffffe097          	auipc	ra,0xffffe
    80004768:	846080e7          	jalr	-1978(ra) # 80001faa <argstr>
    return -1;
    8000476c:	57fd                	li	a5,-1
  if(argstr(0, target, MAXPATH) < 0 || argstr(1, path, MAXPATH) < 0)
    8000476e:	06054a63          	bltz	a0,800047e2 <sys_symlink+0x92>
    80004772:	08000613          	li	a2,128
    80004776:	ee040593          	addi	a1,s0,-288
    8000477a:	4505                	li	a0,1
    8000477c:	ffffe097          	auipc	ra,0xffffe
    80004780:	82e080e7          	jalr	-2002(ra) # 80001faa <argstr>
    return -1;
    80004784:	57fd                	li	a5,-1
  if(argstr(0, target, MAXPATH) < 0 || argstr(1, path, MAXPATH) < 0)
    80004786:	04054e63          	bltz	a0,800047e2 <sys_symlink+0x92>
  begin_op();
    8000478a:	fffff097          	auipc	ra,0xfffff
    8000478e:	e9a080e7          	jalr	-358(ra) # 80003624 <begin_op>
  ip = create(path, T_SYMLINK, 0, 0);
    80004792:	4681                	li	a3,0
    80004794:	4601                	li	a2,0
    80004796:	4591                	li	a1,4
    80004798:	ee040513          	addi	a0,s0,-288
    8000479c:	00000097          	auipc	ra,0x0
    800047a0:	d88080e7          	jalr	-632(ra) # 80004524 <create>
    800047a4:	84aa                	mv	s1,a0
  if(ip == 0){
    800047a6:	c521                	beqz	a0,800047ee <sys_symlink+0x9e>
  if(writei(ip, 0, (uint64)target, 0, MAXPATH) != MAXPATH){
    800047a8:	08000713          	li	a4,128
    800047ac:	4681                	li	a3,0
    800047ae:	f6040613          	addi	a2,s0,-160
    800047b2:	4581                	li	a1,0
    800047b4:	fffff097          	auipc	ra,0xfffff
    800047b8:	84e080e7          	jalr	-1970(ra) # 80003002 <writei>
    800047bc:	08000793          	li	a5,128
    800047c0:	02f51d63          	bne	a0,a5,800047fa <sys_symlink+0xaa>
  iupdate(ip);
    800047c4:	8526                	mv	a0,s1
    800047c6:	ffffe097          	auipc	ra,0xffffe
    800047ca:	31a080e7          	jalr	794(ra) # 80002ae0 <iupdate>
  iunlockput(ip);
    800047ce:	8526                	mv	a0,s1
    800047d0:	ffffe097          	auipc	ra,0xffffe
    800047d4:	6e8080e7          	jalr	1768(ra) # 80002eb8 <iunlockput>
  end_op();
    800047d8:	fffff097          	auipc	ra,0xfffff
    800047dc:	eca080e7          	jalr	-310(ra) # 800036a2 <end_op>
  return 0;
    800047e0:	4781                	li	a5,0
}
    800047e2:	853e                	mv	a0,a5
    800047e4:	60f2                	ld	ra,280(sp)
    800047e6:	6452                	ld	s0,272(sp)
    800047e8:	64b2                	ld	s1,264(sp)
    800047ea:	6115                	addi	sp,sp,288
    800047ec:	8082                	ret
    end_op();
    800047ee:	fffff097          	auipc	ra,0xfffff
    800047f2:	eb4080e7          	jalr	-332(ra) # 800036a2 <end_op>
    return -1;
    800047f6:	57fd                	li	a5,-1
    800047f8:	b7ed                	j	800047e2 <sys_symlink+0x92>
    end_op();
    800047fa:	fffff097          	auipc	ra,0xfffff
    800047fe:	ea8080e7          	jalr	-344(ra) # 800036a2 <end_op>
    return -1;
    80004802:	57fd                	li	a5,-1
    80004804:	bff9                	j	800047e2 <sys_symlink+0x92>
...
0000000080004806 <sys_dup>:
{
  ...
  if(argfd(0, 0, &f) < 0)
    ...
    8000481e:	e94080e7          	jalr	-364(ra) # 800046ae <argfd>
    return -1;
  ...
  if((fd=fdalloc(f)) < 0)
    ...
    80004832:	ee0080e7          	jalr	-288(ra) # 8000470e <fdalloc>
  ...
  filedup(f);
    ...
    80004844:	25a080e7          	jalr	602(ra) # 80003a9a <filedup>
  return fd;
...
0000000080004858 <sys_read>:
{
  ...
  return fileread(f, p, n);
    ...
    800048a4:	386080e7          	jalr	902(ra) # 80003c26 <fileread>
}
...
00000000800048b0 <sys_write>:
{
  ...
  return filewrite(f, p, n);
    ...
    800048fc:	3f0080e7          	jalr	1008(ra) # 80003ce8 <filewrite>
}
...
0000000080004908 <sys_close>:
{
  ...
  if(argfd(0, &fd, &f) < 0)
    ...
    8000491e:	d94080e7          	jalr	-620(ra) # 800046ae <argfd>
    return -1;
  ...
  myproc()->ofile[fd] = 0;
    ...
    8000492c:	52c080e7          	jalr	1324(ra) # 80000e54 <myproc>
  ...
  fileclose(f);
    ...
    80004946:	1aa080e7          	jalr	426(ra) # 80003aec <fileclose>
  return 0;
...
0000000080004956 <sys_fstat>:
{
  ...
  return filestat(f, st);
    ...
    80004990:	228080e7          	jalr	552(ra) # 80003bb4 <filestat>
}
...
000000008000499c <sys_link>:
{
  ...
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    ...
    800049b6:	5f8080e7          	jalr	1528(ra) # 80001faa <argstr>
    return -1;
  ...
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    ...
    800049ce:	5e0080e7          	jalr	1504(ra) # 80001faa <argstr>
    return -1;
  ...
  return 0;
    ...
    80004a8c:	430080e7          	jalr	1072(ra) # 80002eb8 <iunlockput>
    end_op();
    80004a90:	fffff097          	auipc	ra,0xfffff
    80004a94:	c12080e7          	jalr	-1006(ra) # 800036a2 <end_op>
    return -1;
    ...
    80004aa2:	41a080e7          	jalr	1050(ra) # 80002eb8 <iunlockput>
  ilock(ip);
    80004aa6:	8526                	mv	a0,s1
    80004aa8:	ffffe097          	auipc	ra,0xffffe
    80004aac:	104080e7          	jalr	260(ra) # 80002bac <ilock>
  ip->nlink--;
  ...
  iupdate(ip);
    ...
    80004ac0:	024080e7          	jalr	36(ra) # 80002ae0 <iupdate>
  iunlockput(ip);
    80004ac4:	8526                	mv	a0,s1
    80004ac6:	ffffe097          	auipc	ra,0xffffe
    80004aca:	3f2080e7          	jalr	1010(ra) # 80002eb8 <iunlockput>
  end_op();
    80004ace:	fffff097          	auipc	ra,0xfffff
    80004ad2:	bd4080e7          	jalr	-1068(ra) # 800036a2 <end_op>
  return -1;
...
0000000080004ae6 <sys_unlink>:
{
  ...
  memset(&de, 0, sizeof(de));
    ...
    80004b9c:	5e2080e7          	jalr	1506(ra) # 8000017a <memset>
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    80004bb2:	454080e7          	jalr	1108(ra) # 80003002 <writei>
  ...
  iunlockput(dp);
    ...
    80004bcc:	2f0080e7          	jalr	752(ra) # 80002eb8 <iunlockput>
  ip->nlink--;
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    80004c36:	2d8080e7          	jalr	728(ra) # 80002f0a <readi>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    80004c56:	a4e50513          	addi	a0,a0,-1458 # 800086a0 <syscalls+0x2d0>
    80004c5a:	00001097          	auipc	ra,0x1
    80004c5e:	1f2080e7          	jalr	498(ra) # 80005e4c <panic>
    panic("unlink: writei");
    80004c62:	00004517          	auipc	a0,0x4
    80004c66:	a5650513          	addi	a0,a0,-1450 # 800086b8 <syscalls+0x2e8>
    80004c6a:	00001097          	auipc	ra,0x1
    80004c6e:	1e2080e7          	jalr	482(ra) # 80005e4c <panic>
    dp->nlink--;
    ...
    80004c82:	e62080e7          	jalr	-414(ra) # 80002ae0 <iupdate>
    ...
    80004c92:	22a080e7          	jalr	554(ra) # 80002eb8 <iunlockput>
  iunlockput(dp);
    80004c96:	8526                	mv	a0,s1
    80004c98:	ffffe097          	auipc	ra,0xffffe
    80004c9c:	220080e7          	jalr	544(ra) # 80002eb8 <iunlockput>
  end_op();
    80004ca0:	fffff097          	auipc	ra,0xfffff
    80004ca4:	a02080e7          	jalr	-1534(ra) # 800036a2 <end_op>
  return -1;
...
sys_open(void)
{
  ...
  argint(1, &omode);
    ...
    80004cd0:	29e080e7          	jalr	670(ra) # 80001f6a <argint>
  if((n = argstr(0, path, MAXPATH)) < 0)
    80004cd4:	08000613          	li	a2,128
    80004cd8:	f5040593          	addi	a1,s0,-176
    80004cdc:	4501                	li	a0,0
    80004cde:	ffffd097          	auipc	ra,0xffffd
    80004ce2:	2cc080e7          	jalr	716(ra) # 80001faa <argstr>
    return -1;
    80004ce6:	597d                	li	s2,-1
  if((n = argstr(0, path, MAXPATH)) < 0)
    80004ce8:	1a054463          	bltz	a0,80004e90 <sys_open+0x1d8>

  begin_op();
    80004cec:	fffff097          	auipc	ra,0xfffff
    80004cf0:	938080e7          	jalr	-1736(ra) # 80003624 <begin_op>

  if(omode & O_CREATE){
    80004cf4:	f4c42783          	lw	a5,-180(s0)
    80004cf8:	2007f793          	andi	a5,a5,512
    80004cfc:	cfcd                	beqz	a5,80004db6 <sys_open+0xfe>
    ip = create(path, T_FILE, 0, 0);
    80004cfe:	4681                	li	a3,0
    80004d00:	4601                	li	a2,0
    80004d02:	4589                	li	a1,2
    80004d04:	f5040513          	addi	a0,s0,-176
    80004d08:	00000097          	auipc	ra,0x0
    80004d0c:	81c080e7          	jalr	-2020(ra) # 80004524 <create>
    80004d10:	84aa                	mv	s1,a0
    if(ip == 0){
    80004d12:	cd41                	beqz	a0,80004daa <sys_open+0xf2>
      return -1;
    }
  }
  ...
  while(ip->type == T_SYMLINK && !(omode & O_NOFOLLOW)){
    80004d14:	04449783          	lh	a5,68(s1)
    80004d18:	0007869b          	sext.w	a3,a5
    80004d1c:	4711                	li	a4,4
    80004d1e:	492d                	li	s2,11
    80004d20:	4991                	li	s3,4
    80004d22:	06e69063          	bne	a3,a4,80004d82 <sys_open+0xca>
    80004d26:	f4c42783          	lw	a5,-180(s0)
    80004d2a:	8bc1                	andi	a5,a5,16
    80004d2c:	ebcd                	bnez	a5,80004dde <sys_open+0x126>
    if((n = readi(ip, 0, (uint64)path, 0, MAXPATH)) != MAXPATH){
    80004d2e:	08000713          	li	a4,128
    80004d32:	4681                	li	a3,0
    80004d34:	f5040613          	addi	a2,s0,-176
    80004d38:	4581                	li	a1,0
    80004d3a:	8526                	mv	a0,s1
    80004d3c:	ffffe097          	auipc	ra,0xffffe
    80004d40:	1ce080e7          	jalr	462(ra) # 80002f0a <readi>
    80004d44:	08000793          	li	a5,128
    80004d48:	12f51463          	bne	a0,a5,80004e70 <sys_open+0x1b8>
      iunlockput(ip);
      end_op();
      return -1;
    }
    ...
    80004d52:	16a080e7          	jalr	362(ra) # 80002eb8 <iunlockput>
    if((ip = namei(path)) == 0 || ++cnt > 10){
    80004d56:	f5040513          	addi	a0,s0,-176
    80004d5a:	ffffe097          	auipc	ra,0xffffe
    80004d5e:	6aa080e7          	jalr	1706(ra) # 80003404 <namei>
    80004d62:	84aa                	mv	s1,a0
    80004d64:	12050163          	beqz	a0,80004e86 <sys_open+0x1ce>
    80004d68:	397d                	addiw	s2,s2,-1
    80004d6a:	10090e63          	beqz	s2,80004e86 <sys_open+0x1ce>
      end_op();
      return -1;
    }
    ilock(ip);
    80004d6e:	ffffe097          	auipc	ra,0xffffe
    80004d72:	e3e080e7          	jalr	-450(ra) # 80002bac <ilock>
  while(ip->type == T_SYMLINK && !(omode & O_NOFOLLOW)){
    80004d76:	04449783          	lh	a5,68(s1)
    80004d7a:	0007871b          	sext.w	a4,a5
    80004d7e:	fb3704e3          	beq	a4,s3,80004d26 <sys_open+0x6e>
  }

  if(ip->type == T_DEVICE && (ip->major < 0 || ip->major >= NDEV)){
    80004d82:	2781                	sext.w	a5,a5
    80004d84:	470d                	li	a4,3
    80004d86:	04e79c63          	bne	a5,a4,80004dde <sys_open+0x126>
    80004d8a:	0464d703          	lhu	a4,70(s1)
    80004d8e:	47a5                	li	a5,9
    80004d90:	04e7f763          	bgeu	a5,a4,80004dde <sys_open+0x126>
    iunlockput(ip);
    80004d94:	8526                	mv	a0,s1
    80004d96:	ffffe097          	auipc	ra,0xffffe
    80004d9a:	122080e7          	jalr	290(ra) # 80002eb8 <iunlockput>
    end_op();
    80004d9e:	fffff097          	auipc	ra,0xfffff
    80004da2:	904080e7          	jalr	-1788(ra) # 800036a2 <end_op>
    return -1;
    80004da6:	597d                	li	s2,-1
    80004da8:	a0e5                	j	80004e90 <sys_open+0x1d8>
      end_op();
    80004daa:	fffff097          	auipc	ra,0xfffff
    80004dae:	8f8080e7          	jalr	-1800(ra) # 800036a2 <end_op>
      return -1;
    80004db2:	597d                	li	s2,-1
    80004db4:	a8f1                	j	80004e90 <sys_open+0x1d8>
    if((ip = namei(path)) == 0){
    80004db6:	f5040513          	addi	a0,s0,-176
    80004dba:	ffffe097          	auipc	ra,0xffffe
    80004dbe:	64a080e7          	jalr	1610(ra) # 80003404 <namei>
    80004dc2:	84aa                	mv	s1,a0
    80004dc4:	c549                	beqz	a0,80004e4e <sys_open+0x196>
    ilock(ip);
    80004dc6:	ffffe097          	auipc	ra,0xffffe
    80004dca:	de6080e7          	jalr	-538(ra) # 80002bac <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
    80004dce:	04449703          	lh	a4,68(s1)
    80004dd2:	4785                	li	a5,1
    80004dd4:	f4f710e3          	bne	a4,a5,80004d14 <sys_open+0x5c>
    80004dd8:	f4c42783          	lw	a5,-180(s0)
    80004ddc:	efbd                	bnez	a5,80004e5a <sys_open+0x1a2>
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
    80004dde:	fffff097          	auipc	ra,0xfffff
    80004de2:	c52080e7          	jalr	-942(ra) # 80003a30 <filealloc>
    80004de6:	89aa                	mv	s3,a0
    80004de8:	cd71                	beqz	a0,80004ec4 <sys_open+0x20c>
    80004dea:	00000097          	auipc	ra,0x0
    80004dee:	924080e7          	jalr	-1756(ra) # 8000470e <fdalloc>
    80004df2:	892a                	mv	s2,a0
    80004df4:	0c054363          	bltz	a0,80004eba <sys_open+0x202>
    iunlockput(ip);
    end_op();
    return -1;
  }
  ...
  if(ip->type == T_DEVICE){
    ...
    80004dfe:	0af70163          	beq	a4,a5,80004ea0 <sys_open+0x1e8>
    f->type = FD_DEVICE;
    f->major = ip->major;
  } else {
    f->type = FD_INODE;
    80004e02:	4789                	li	a5,2
    80004e04:	00f9a023          	sw	a5,0(s3)
    f->off = 0;
    80004e08:	0209a023          	sw	zero,32(s3)
  }
  f->ip = ip;
    80004e0c:	0099bc23          	sd	s1,24(s3)
  f->readable = !(omode & O_WRONLY);
    80004e10:	f4c42783          	lw	a5,-180(s0)
    80004e14:	0017c713          	xori	a4,a5,1
    80004e18:	8b05                	andi	a4,a4,1
    80004e1a:	00e98423          	sb	a4,8(s3)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
    80004e1e:	0037f713          	andi	a4,a5,3
    80004e22:	00e03733          	snez	a4,a4
    80004e26:	00e984a3          	sb	a4,9(s3)

  if((omode & O_TRUNC) && ip->type == T_FILE){
    80004e2a:	4007f793          	andi	a5,a5,1024
    80004e2e:	c791                	beqz	a5,80004e3a <sys_open+0x182>
    80004e30:	04449703          	lh	a4,68(s1)
    80004e34:	4789                	li	a5,2
    80004e36:	06f70c63          	beq	a4,a5,80004eae <sys_open+0x1f6>
    itrunc(ip);
  }
  ...
  iunlock(ip);
    ...
    80004e40:	e32080e7          	jalr	-462(ra) # 80002c6e <iunlock>
  end_op();
    80004e44:	fffff097          	auipc	ra,0xfffff
    80004e48:	85e080e7          	jalr	-1954(ra) # 800036a2 <end_op>

  return fd;
    80004e4c:	a091                	j	80004e90 <sys_open+0x1d8>
      end_op();
    80004e4e:	fffff097          	auipc	ra,0xfffff
    80004e52:	854080e7          	jalr	-1964(ra) # 800036a2 <end_op>
      return -1;
    80004e56:	597d                	li	s2,-1
    80004e58:	a825                	j	80004e90 <sys_open+0x1d8>
      iunlockput(ip);
    80004e5a:	8526                	mv	a0,s1
    80004e5c:	ffffe097          	auipc	ra,0xffffe
    80004e60:	05c080e7          	jalr	92(ra) # 80002eb8 <iunlockput>
      end_op();
    80004e64:	fffff097          	auipc	ra,0xfffff
    80004e68:	83e080e7          	jalr	-1986(ra) # 800036a2 <end_op>
      return -1;
    80004e6c:	597d                	li	s2,-1
    80004e6e:	a00d                	j	80004e90 <sys_open+0x1d8>
      iunlockput(ip);
    80004e70:	8526                	mv	a0,s1
    80004e72:	ffffe097          	auipc	ra,0xffffe
    80004e76:	046080e7          	jalr	70(ra) # 80002eb8 <iunlockput>
      end_op();
    80004e7a:	fffff097          	auipc	ra,0xfffff
    80004e7e:	828080e7          	jalr	-2008(ra) # 800036a2 <end_op>
      return -1;
    80004e82:	597d                	li	s2,-1
    80004e84:	a031                	j	80004e90 <sys_open+0x1d8>
      end_op();
    80004e86:	fffff097          	auipc	ra,0xfffff
    80004e8a:	81c080e7          	jalr	-2020(ra) # 800036a2 <end_op>
      return -1;
    80004e8e:	597d                	li	s2,-1
}
    80004e90:	854a                	mv	a0,s2
    80004e92:	70ea                	ld	ra,184(sp)
    80004e94:	744a                	ld	s0,176(sp)
    80004e96:	74aa                	ld	s1,168(sp)
    80004e98:	790a                	ld	s2,160(sp)
    80004e9a:	69ea                	ld	s3,152(sp)
    80004e9c:	6129                	addi	sp,sp,192
    80004e9e:	8082                	ret
    f->type = FD_DEVICE;
    ...
    80004eac:	b785                	j	80004e0c <sys_open+0x154>
    itrunc(ip);
    80004eae:	8526                	mv	a0,s1
    80004eb0:	ffffe097          	auipc	ra,0xffffe
    80004eb4:	e0a080e7          	jalr	-502(ra) # 80002cba <itrunc>
    80004eb8:	b749                	j	80004e3a <sys_open+0x182>
      fileclose(f);
    80004eba:	854e                	mv	a0,s3
    80004ebc:	fffff097          	auipc	ra,0xfffff
    80004ec0:	c30080e7          	jalr	-976(ra) # 80003aec <fileclose>
    iunlockput(ip);
    80004ec4:	8526                	mv	a0,s1
    80004ec6:	ffffe097          	auipc	ra,0xffffe
    80004eca:	ff2080e7          	jalr	-14(ra) # 80002eb8 <iunlockput>
    end_op();
    80004ece:	ffffe097          	auipc	ra,0xffffe
    80004ed2:	7d4080e7          	jalr	2004(ra) # 800036a2 <end_op>
    return -1;
    80004ed6:	597d                	li	s2,-1
    80004ed8:	bf65                	j	80004e90 <sys_open+0x1d8>

0000000080004eda <sys_mkdir>:

uint64
sys_mkdir(void)
{
    80004eda:	7175                	addi	sp,sp,-144
    80004edc:	e506                	sd	ra,136(sp)
    80004ede:	e122                	sd	s0,128(sp)
    80004ee0:	0900                	addi	s0,sp,144
  char path[MAXPATH];
  struct inode *ip;

  begin_op();
    80004ee2:	ffffe097          	auipc	ra,0xffffe
    80004ee6:	742080e7          	jalr	1858(ra) # 80003624 <begin_op>
  if(argstr(0, path, MAXPATH) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
    ...
    80004ef8:	0b6080e7          	jalr	182(ra) # 80001faa <argstr>
    80004efc:	02054963          	bltz	a0,80004f2e <sys_mkdir+0x54>
    80004f00:	4681                	li	a3,0
    80004f02:	4601                	li	a2,0
    80004f04:	4585                	li	a1,1
    80004f06:	f7040513          	addi	a0,s0,-144
    80004f0a:	fffff097          	auipc	ra,0xfffff
    80004f0e:	61a080e7          	jalr	1562(ra) # 80004524 <create>
    80004f12:	cd11                	beqz	a0,80004f2e <sys_mkdir+0x54>
    end_op();
    return -1;
  }
  iunlockput(ip);
    80004f14:	ffffe097          	auipc	ra,0xffffe
    80004f18:	fa4080e7          	jalr	-92(ra) # 80002eb8 <iunlockput>
  end_op();
    80004f1c:	ffffe097          	auipc	ra,0xffffe
    80004f20:	786080e7          	jalr	1926(ra) # 800036a2 <end_op>
  return 0;
    ...
    80004f32:	774080e7          	jalr	1908(ra) # 800036a2 <end_op>
    return -1;
    80004f36:	557d                	li	a0,-1
    80004f38:	b7fd                	j	80004f26 <sys_mkdir+0x4c>
...
sys_mknod(void)
{
    80004f3a:	7135                	addi	sp,sp,-160
    80004f3c:	ed06                	sd	ra,152(sp)
    80004f3e:	e922                	sd	s0,144(sp)
    80004f40:	1100                	addi	s0,sp,160
  struct inode *ip;
  char path[MAXPATH];
  int major, minor;
  ...
  begin_op();
    ...
    80004f46:	6e2080e7          	jalr	1762(ra) # 80003624 <begin_op>
  argint(1, &major);
    80004f4a:	f6c40593          	addi	a1,s0,-148
    80004f4e:	4505                	li	a0,1
    80004f50:	ffffd097          	auipc	ra,0xffffd
    80004f54:	01a080e7          	jalr	26(ra) # 80001f6a <argint>
  argint(2, &minor);
    80004f58:	f6840593          	addi	a1,s0,-152
    80004f5c:	4509                	li	a0,2
    80004f5e:	ffffd097          	auipc	ra,0xffffd
    80004f62:	00c080e7          	jalr	12(ra) # 80001f6a <argint>
  if((argstr(0, path, MAXPATH)) < 0 ||
    80004f66:	08000613          	li	a2,128
    80004f6a:	f7040593          	addi	a1,s0,-144
    80004f6e:	4501                	li	a0,0
    80004f70:	ffffd097          	auipc	ra,0xffffd
    80004f74:	03a080e7          	jalr	58(ra) # 80001faa <argstr>
    80004f78:	02054b63          	bltz	a0,80004fae <sys_mknod+0x74>
    ...
    80004f8e:	59a080e7          	jalr	1434(ra) # 80004524 <create>
  if((argstr(0, path, MAXPATH)) < 0 ||
    80004f92:	cd11                	beqz	a0,80004fae <sys_mknod+0x74>
    end_op();
    return -1;
  }
  iunlockput(ip);
    80004f94:	ffffe097          	auipc	ra,0xffffe
    80004f98:	f24080e7          	jalr	-220(ra) # 80002eb8 <iunlockput>
  end_op();
    80004f9c:	ffffe097          	auipc	ra,0xffffe
    80004fa0:	706080e7          	jalr	1798(ra) # 800036a2 <end_op>
  return 0;
    ...
    80004fb2:	6f4080e7          	jalr	1780(ra) # 800036a2 <end_op>
    return -1;
    80004fb6:	557d                	li	a0,-1
    80004fb8:	b7fd                	j	80004fa6 <sys_mknod+0x6c>

0000000080004fba <sys_chdir>:

uint64
sys_chdir(void)
{
    80004fba:	7135                	addi	sp,sp,-160
    80004fbc:	ed06                	sd	ra,152(sp)
    80004fbe:	e922                	sd	s0,144(sp)
  ...
  struct proc *p = myproc();
    ...
    80004fca:	e8e080e7          	jalr	-370(ra) # 80000e54 <myproc>
    80004fce:	892a                	mv	s2,a0
  
  begin_op();
    80004fd0:	ffffe097          	auipc	ra,0xffffe
    80004fd4:	654080e7          	jalr	1620(ra) # 80003624 <begin_op>
  if(argstr(0, path, MAXPATH) < 0 || (ip = namei(path)) == 0){
    ...
    80004fe6:	fc8080e7          	jalr	-56(ra) # 80001faa <argstr>
    80004fea:	04054b63          	bltz	a0,80005040 <sys_chdir+0x86>
    80004fee:	f6040513          	addi	a0,s0,-160
    80004ff2:	ffffe097          	auipc	ra,0xffffe
    80004ff6:	412080e7          	jalr	1042(ra) # 80003404 <namei>
    80004ffa:	84aa                	mv	s1,a0
    80004ffc:	c131                	beqz	a0,80005040 <sys_chdir+0x86>
    end_op();
    return -1;
  }
  ilock(ip);
    80004ffe:	ffffe097          	auipc	ra,0xffffe
    80005002:	bae080e7          	jalr	-1106(ra) # 80002bac <ilock>
  if(ip->type != T_DIR){
    80005006:	04449703          	lh	a4,68(s1)
    8000500a:	4785                	li	a5,1
    8000500c:	04f71063          	bne	a4,a5,8000504c <sys_chdir+0x92>
    iunlockput(ip);
    end_op();
    return -1;
  }
  iunlock(ip);
    ...
    80005016:	c5c080e7          	jalr	-932(ra) # 80002c6e <iunlock>
  iput(p->cwd);
    8000501a:	15093503          	ld	a0,336(s2)
    8000501e:	ffffe097          	auipc	ra,0xffffe
    80005022:	df2080e7          	jalr	-526(ra) # 80002e10 <iput>
  end_op();
    80005026:	ffffe097          	auipc	ra,0xffffe
    8000502a:	67c080e7          	jalr	1660(ra) # 800036a2 <end_op>
  p->cwd = ip;
    8000502e:	14993823          	sd	s1,336(s2)
  return 0;
    ...
    8000503a:	690a                	ld	s2,128(sp)
    8000503c:	610d                	addi	sp,sp,160
    8000503e:	8082                	ret
    end_op();
    80005040:	ffffe097          	auipc	ra,0xffffe
    80005044:	662080e7          	jalr	1634(ra) # 800036a2 <end_op>
    return -1;
    80005048:	557d                	li	a0,-1
    8000504a:	b7ed                	j	80005034 <sys_chdir+0x7a>
    iunlockput(ip);
    8000504c:	8526                	mv	a0,s1
    8000504e:	ffffe097          	auipc	ra,0xffffe
    80005052:	e6a080e7          	jalr	-406(ra) # 80002eb8 <iunlockput>
    end_op();
    80005056:	ffffe097          	auipc	ra,0xffffe
    8000505a:	64c080e7          	jalr	1612(ra) # 800036a2 <end_op>
    return -1;
    8000505e:	557d                	li	a0,-1
    80005060:	bfd1                	j	80005034 <sys_chdir+0x7a>
...
sys_exec(void)
{
    80005062:	7145                	addi	sp,sp,-464
    80005064:	e786                	sd	ra,456(sp)
    80005066:	e3a2                	sd	s0,448(sp)
    80005068:	ff26                	sd	s1,440(sp)
    8000506a:	fb4a                	sd	s2,432(sp)
    8000506c:	f74e                	sd	s3,424(sp)
    8000506e:	f352                	sd	s4,416(sp)
    80005070:	ef56                	sd	s5,408(sp)
    80005072:	0b80                	addi	s0,sp,464
  char path[MAXPATH], *argv[MAXARG];
  int i;
  uint64 uargv, uarg;

  argaddr(1, &uargv);
    80005074:	e3840593          	addi	a1,s0,-456
    80005078:	4505                	li	a0,1
    8000507a:	ffffd097          	auipc	ra,0xffffd
    8000507e:	f10080e7          	jalr	-240(ra) # 80001f8a <argaddr>
  if(argstr(0, path, MAXPATH) < 0) {
    80005082:	08000613          	li	a2,128
    80005086:	f4040593          	addi	a1,s0,-192
    8000508a:	4501                	li	a0,0
    8000508c:	ffffd097          	auipc	ra,0xffffd
    80005090:	f1e080e7          	jalr	-226(ra) # 80001faa <argstr>
    80005094:	87aa                	mv	a5,a0
    return -1;
    80005096:	557d                	li	a0,-1
  if(argstr(0, path, MAXPATH) < 0) {
    80005098:	0c07c363          	bltz	a5,8000515e <sys_exec+0xfc>
  }
  memset(argv, 0, sizeof(argv));
    8000509c:	10000613          	li	a2,256
    800050a0:	4581                	li	a1,0
    800050a2:	e4040513          	addi	a0,s0,-448
    800050a6:	ffffb097          	auipc	ra,0xffffb
    800050aa:	0d4080e7          	jalr	212(ra) # 8000017a <memset>
  for(i=0;; i++){
    if(i >= NELEM(argv)){
    800050ae:	e4040493          	addi	s1,s0,-448
  memset(argv, 0, sizeof(argv));
    800050b2:	89a6                	mv	s3,s1
    800050b4:	4901                	li	s2,0
    if(i >= NELEM(argv)){
    800050b6:	02000a13          	li	s4,32
    800050ba:	00090a9b          	sext.w	s5,s2
      goto bad;
    }
    if(fetchaddr(uargv+sizeof(uint64)*i, (uint64*)&uarg) < 0){
    800050be:	00391513          	slli	a0,s2,0x3
    800050c2:	e3040593          	addi	a1,s0,-464
    800050c6:	e3843783          	ld	a5,-456(s0)
    800050ca:	953e                	add	a0,a0,a5
    800050cc:	ffffd097          	auipc	ra,0xffffd
    800050d0:	e00080e7          	jalr	-512(ra) # 80001ecc <fetchaddr>
    800050d4:	02054a63          	bltz	a0,80005108 <sys_exec+0xa6>
      goto bad;
    }
    if(uarg == 0){
    800050d8:	e3043783          	ld	a5,-464(s0)
    800050dc:	c3b9                	beqz	a5,80005122 <sys_exec+0xc0>
      argv[i] = 0;
      break;
    }
    argv[i] = kalloc();
    ...
    if(argv[i] == 0)
    800050ec:	cd11                	beqz	a0,80005108 <sys_exec+0xa6>
      goto bad;
    if(fetchstr(uarg, argv[i], PGSIZE) < 0)
    800050ee:	6605                	lui	a2,0x1
    800050f0:	e3043503          	ld	a0,-464(s0)
    800050f4:	ffffd097          	auipc	ra,0xffffd
    800050f8:	e2a080e7          	jalr	-470(ra) # 80001f1e <fetchstr>
    800050fc:	00054663          	bltz	a0,80005108 <sys_exec+0xa6>
    if(i >= NELEM(argv)){
    80005100:	0905                	addi	s2,s2,1
    80005102:	09a1                	addi	s3,s3,8
    80005104:	fb491be3          	bne	s2,s4,800050ba <sys_exec+0x58>
    kfree(argv[i]);
 ...
 bad:
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80005108:	f4040913          	addi	s2,s0,-192
    8000510c:	6088                	ld	a0,0(s1)
    8000510e:	c539                	beqz	a0,8000515c <sys_exec+0xfa>
    kfree(argv[i]);
    80005110:	ffffb097          	auipc	ra,0xffffb
    80005114:	f0c080e7          	jalr	-244(ra) # 8000001c <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80005118:	04a1                	addi	s1,s1,8
    8000511a:	ff2499e3          	bne	s1,s2,8000510c <sys_exec+0xaa>
  return -1;
    8000511e:	557d                	li	a0,-1
    80005120:	a83d                	j	8000515e <sys_exec+0xfc>
      argv[i] = 0;
    80005122:	0a8e                	slli	s5,s5,0x3
    80005124:	fc0a8793          	addi	a5,s5,-64
    80005128:	00878ab3          	add	s5,a5,s0
    8000512c:	e80ab023          	sd	zero,-384(s5)
  int ret = exec(path, argv);
    80005130:	e4040593          	addi	a1,s0,-448
    80005134:	f4040513          	addi	a0,s0,-192
    80005138:	fffff097          	auipc	ra,0xfffff
    8000513c:	02e080e7          	jalr	46(ra) # 80004166 <exec>
    80005140:	892a                	mv	s2,a0
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80005142:	f4040993          	addi	s3,s0,-192
    80005146:	6088                	ld	a0,0(s1)
    80005148:	c901                	beqz	a0,80005158 <sys_exec+0xf6>
    kfree(argv[i]);
    8000514a:	ffffb097          	auipc	ra,0xffffb
    8000514e:	ed2080e7          	jalr	-302(ra) # 8000001c <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80005152:	04a1                	addi	s1,s1,8
    80005154:	ff3499e3          	bne	s1,s3,80005146 <sys_exec+0xe4>
  return ret;
    80005158:	854a                	mv	a0,s2
    8000515a:	a011                	j	8000515e <sys_exec+0xfc>
  return -1;
    8000515c:	557d                	li	a0,-1
}
    8000515e:	60be                	ld	ra,456(sp)
    80005160:	641e                	ld	s0,448(sp)
    80005162:	74fa                	ld	s1,440(sp)
    80005164:	795a                	ld	s2,432(sp)
    80005166:	79ba                	ld	s3,424(sp)
    80005168:	7a1a                	ld	s4,416(sp)
    8000516a:	6afa                	ld	s5,408(sp)
    8000516c:	6179                	addi	sp,sp,464
    8000516e:	8082                	ret

0000000080005170 <sys_pipe>:

uint64
sys_pipe(void)
{
    80005170:	7139                	addi	sp,sp,-64
    80005172:	fc06                	sd	ra,56(sp)
    80005174:	f822                	sd	s0,48(sp)
    80005176:	f426                	sd	s1,40(sp)
  ...
  struct proc *p = myproc();
    ...
    8000517e:	cda080e7          	jalr	-806(ra) # 80000e54 <myproc>
    80005182:	84aa                	mv	s1,a0

  argaddr(0, &fdarray);
    80005184:	fd840593          	addi	a1,s0,-40
    80005188:	4501                	li	a0,0
    8000518a:	ffffd097          	auipc	ra,0xffffd
    8000518e:	e00080e7          	jalr	-512(ra) # 80001f8a <argaddr>
  if(pipealloc(&rf, &wf) < 0)
    80005192:	fc840593          	addi	a1,s0,-56
    80005196:	fd040513          	addi	a0,s0,-48
    8000519a:	fffff097          	auipc	ra,0xfffff
    8000519e:	c82080e7          	jalr	-894(ra) # 80003e1c <pipealloc>
    return -1;
    800051a2:	57fd                	li	a5,-1
  if(pipealloc(&rf, &wf) < 0)
    800051a4:	0c054463          	bltz	a0,8000526c <sys_pipe+0xfc>
  fd0 = -1;
    800051a8:	fcf42223          	sw	a5,-60(s0)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    800051ac:	fd043503          	ld	a0,-48(s0)
    800051b0:	fffff097          	auipc	ra,0xfffff
    800051b4:	55e080e7          	jalr	1374(ra) # 8000470e <fdalloc>
    800051b8:	fca42223          	sw	a0,-60(s0)
    800051bc:	08054b63          	bltz	a0,80005252 <sys_pipe+0xe2>
    800051c0:	fc843503          	ld	a0,-56(s0)
    800051c4:	fffff097          	auipc	ra,0xfffff
    800051c8:	54a080e7          	jalr	1354(ra) # 8000470e <fdalloc>
    800051cc:	fca42023          	sw	a0,-64(s0)
    800051d0:	06054863          	bltz	a0,80005240 <sys_pipe+0xd0>
      p->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    ...
    800051e4:	934080e7          	jalr	-1740(ra) # 80000b14 <copyout>
    800051e8:	02054063          	bltz	a0,80005208 <sys_pipe+0x98>
     copyout(p->pagetable, fdarray+sizeof(fd0), (char *)&fd1, sizeof(fd1)) < 0){
    800051ec:	4691                	li	a3,4
    800051ee:	fc040613          	addi	a2,s0,-64
    800051f2:	fd843583          	ld	a1,-40(s0)
    800051f6:	0591                	addi	a1,a1,4
    800051f8:	68a8                	ld	a0,80(s1)
    800051fa:	ffffc097          	auipc	ra,0xffffc
    800051fe:	91a080e7          	jalr	-1766(ra) # 80000b14 <copyout>
    p->ofile[fd1] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    80005204:	06055463          	bgez	a0,8000526c <sys_pipe+0xfc>
    p->ofile[fd0] = 0;
    ...
    8000522c:	8c4080e7          	jalr	-1852(ra) # 80003aec <fileclose>
    fileclose(wf);
    80005230:	fc843503          	ld	a0,-56(s0)
    80005234:	fffff097          	auipc	ra,0xfffff
    80005238:	8b8080e7          	jalr	-1864(ra) # 80003aec <fileclose>
    return -1;
    8000523c:	57fd                	li	a5,-1
    8000523e:	a03d                	j	8000526c <sys_pipe+0xfc>
    if(fd0 >= 0)
    80005240:	fc442783          	lw	a5,-60(s0)
    80005244:	0007c763          	bltz	a5,80005252 <sys_pipe+0xe2>
      p->ofile[fd0] = 0;
    ...
    8000525a:	896080e7          	jalr	-1898(ra) # 80003aec <fileclose>
    fileclose(wf);
    8000525e:	fc843503          	ld	a0,-56(s0)
    80005262:	fffff097          	auipc	ra,0xfffff
    80005266:	88a080e7          	jalr	-1910(ra) # 80003aec <fileclose>
    return -1;
...
0000000080005280 <kernelvec>:
    ...
    800052c0:	ad9fc0ef          	jal	ra,80001d98 <kerneltrap>
...
free_desc(int i)
{
  ...
  if(i >= NUM)
    ...
    panic("free_desc 1");
  if(disk.free[i])
    800053e4:	00010797          	auipc	a5,0x10
    800053e8:	a0c78793          	addi	a5,a5,-1524 # 80014df0 <disk>
  ...
  disk.desc[i].addr = 0;
    ...
    800053f8:	00010797          	auipc	a5,0x10
    800053fc:	9f878793          	addi	a5,a5,-1544 # 80014df0 <disk>
  ...
  wakeup(&disk.free[0]);
    80005420:	00010517          	auipc	a0,0x10
    80005424:	9e850513          	addi	a0,a0,-1560 # 80014e08 <disk+0x18>
    80005428:	ffffc097          	auipc	ra,0xffffc
    8000542c:	138080e7          	jalr	312(ra) # 80001560 <wakeup>
}
    ...
    8000543c:	29050513          	addi	a0,a0,656 # 800086c8 <syscalls+0x2f8>
    80005440:	00001097          	auipc	ra,0x1
    80005444:	a0c080e7          	jalr	-1524(ra) # 80005e4c <panic>
    panic("free_desc 2");
    80005448:	00003517          	auipc	a0,0x3
    8000544c:	29050513          	addi	a0,a0,656 # 800086d8 <syscalls+0x308>
...
0000000080005458 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    80005468:	28458593          	addi	a1,a1,644 # 800086e8 <syscalls+0x318>
    8000546c:	00010517          	auipc	a0,0x10
    80005470:	aac50513          	addi	a0,a0,-1364 # 80014f18 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_DRIVER_FEATURES) = features;
    ...
    800054d4:	75f68693          	addi	a3,a3,1887 # ffffffffc7ffe75f <end+0xffffffff47fe15ef>
  ...
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
  ...
  disk.desc = kalloc();
    ...
    80005516:	00010497          	auipc	s1,0x10
    8000551a:	8da48493          	addi	s1,s1,-1830 # 80014df0 <disk>
  ...
  if(!disk.desc || !disk.avail || !disk.used)
    ...
    8000553a:	00010717          	auipc	a4,0x10
    8000553e:	8be73703          	ld	a4,-1858(a4) # 80014df8 <disk+0x8>
  ...
  memset(disk.avail, 0, PGSIZE);
    80005552:	00010497          	auipc	s1,0x10
    80005556:	89e48493          	addi	s1,s1,-1890 # 80014df0 <disk>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    80005672:	00010517          	auipc	a0,0x10
    80005676:	8a650513          	addi	a0,a0,-1882 # 80014f18 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    80005684:	44a1                	li	s1,8
      disk.free[i] = 0;
    80005686:	0000fb97          	auipc	s7,0xf
    8000568a:	76ab8b93          	addi	s7,s7,1898 # 80014df0 <disk>
  for(int i = 0; i < 3; i++){
  ...
  while(1){
    ...
    80005690:	00010c97          	auipc	s9,0x10
    80005694:	888c8c93          	addi	s9,s9,-1912 # 80014f18 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    800056b2:	0000f717          	auipc	a4,0xf
    800056b6:	73e70713          	addi	a4,a4,1854 # 80014df0 <disk>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    800056ea:	0000f517          	auipc	a0,0xf
    800056ee:	71e50513          	addi	a0,a0,1822 # 80014e08 <disk+0x18>
    800056f2:	ffffc097          	auipc	ra,0xffffc
    800056f6:	e0a080e7          	jalr	-502(ra) # 800014fc <sleep>
  for(int i = 0; i < 3; i++){
    800056fa:	f8040a13          	addi	s4,s0,-128
{
  ...
  if(write)
    8000570e:	0000f797          	auipc	a5,0xf
    80005712:	6e278793          	addi	a5,a5,1762 # 80014df0 <disk>
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    800057e4:	0000f917          	auipc	s2,0xf
    800057e8:	73490913          	addi	s2,s2,1844 # 80014f18 <disk+0x128>
  while(b->disk == 1) {
    ...
    800057fa:	d06080e7          	jalr	-762(ra) # 800014fc <sleep>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    80005810:	0000f797          	auipc	a5,0xf
    80005814:	5e078793          	addi	a5,a5,1504 # 80014df0 <disk>
    80005818:	97ba                	add	a5,a5,a4
    8000581a:	0007b423          	sd	zero,8(a5)
    int flag = disk.desc[i].flags;
    8000581e:	0000f997          	auipc	s3,0xf
    80005822:	5d298993          	addi	s3,s3,1490 # 80014df0 <disk>
  ...
  release(&disk.vdisk_lock);
    80005846:	0000f517          	auipc	a0,0xf
    8000584a:	6d250513          	addi	a0,a0,1746 # 80014f18 <disk+0x128>
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    8000587e:	0000f497          	auipc	s1,0xf
    80005882:	57248493          	addi	s1,s1,1394 # 80014df0 <disk>
    80005886:	0000f517          	auipc	a0,0xf
    8000588a:	69250513          	addi	a0,a0,1682 # 80014f18 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  while(disk.used_idx != disk.used->idx){
    ...
    800058e2:	c82080e7          	jalr	-894(ra) # 80001560 <wakeup>
  ...
  release(&disk.vdisk_lock);
    800058fe:	0000f517          	auipc	a0,0xf
    80005902:	61a50513          	addi	a0,a0,1562 # 80014f18 <disk+0x128>
    ...
    8000591c:	e9850513          	addi	a0,a0,-360 # 800087b0 <syscalls+0x3e0>
...
timerinit()
{
  ...
  *(uint64*)CLINT_MTIMECMP(id) = *(uint64*)CLINT_MTIME + interval;
  ...
  uint64 *scratch = &timer_scratch[id][0];
    ...
    8000595c:	0000f717          	auipc	a4,0xf
    80005960:	5d470713          	addi	a4,a4,1492 # 80014f30 <timer_scratch>
...
0000000080005998 <start>:
{
  ...
  x &= ~MSTATUS_MPP_MASK;
    ...
    800059a6:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7ffe168f>
...
consolewrite(int user_src, uint64 src, int n)
{
  ...
  for(i = 0; i < n; i++){
    ...
    80005a3a:	f24080e7          	jalr	-220(ra) # 8000195a <either_copyin>
...
consoleread(int user_dst, uint64 dst, int n)
{
  ...
  acquire(&cons.lock);
    ...
    80005a9a:	5da50513          	addi	a0,a0,1498 # 8001d070 <cons>
  ...
  while(n > 0){
    ...
    while(cons.r == cons.w){
    80005aa6:	00017497          	auipc	s1,0x17
    80005aaa:	5ca48493          	addi	s1,s1,1482 # 8001d070 <cons>
      if(killed(myproc())){
        release(&cons.lock);
        return -1;
      }
      sleep(&cons.r, &cons.lock);
    80005aae:	00017917          	auipc	s2,0x17
    80005ab2:	65a90913          	addi	s2,s2,1626 # 8001d108 <cons+0x98>
    }
  ...
  while(n > 0){
    ...
    80005ad8:	cd0080e7          	jalr	-816(ra) # 800017a4 <killed>
    ...
    80005ae6:	a1a080e7          	jalr	-1510(ra) # 800014fc <sleep>
    while(cons.r == cons.w){
    ...
    80005b22:	de6080e7          	jalr	-538(ra) # 80001904 <either_copyout>
  ...
  release(&cons.lock);
    80005b32:	00017517          	auipc	a0,0x17
    80005b36:	53e50513          	addi	a0,a0,1342 # 8001d070 <cons>
  ...
  return target - n;
    ...
    80005b46:	a811                	j	80005b5a <consoleread+0xea>
        release(&cons.lock);
    80005b48:	00017517          	auipc	a0,0x17
    80005b4c:	52850513          	addi	a0,a0,1320 # 8001d070 <cons>
    ...
    80005b7a:	fb677ce3          	bgeu	a4,s6,80005b32 <consoleread+0xc2>
        cons.r--;
    80005b7e:	00017717          	auipc	a4,0x17
    80005b82:	58f72523          	sw	a5,1418(a4) # 8001d108 <cons+0x98>
...
consoleintr(int c)
{
  ...
  acquire(&cons.lock);
    80005bd8:	00017517          	auipc	a0,0x17
    80005bdc:	49850513          	addi	a0,a0,1176 # 8001d070 <cons>
  ...
  case C('P'):  // Print process list.
    ...
    80005c02:	db2080e7          	jalr	-590(ra) # 800019b0 <procdump>
      }
    }
    break;
  }
  ...
  release(&cons.lock);
    80005c06:	00017517          	auipc	a0,0x17
    80005c0a:	46a50513          	addi	a0,a0,1130 # 8001d070 <cons>
  ...
  switch(c){
    ...
    80005c2a:	00017717          	auipc	a4,0x17
    80005c2e:	44670713          	addi	a4,a4,1094 # 8001d070 <cons>
    ...
    80005c54:	00017797          	auipc	a5,0x17
    80005c58:	41c78793          	addi	a5,a5,1052 # 8001d070 <cons>
    ...
    80005c82:	00017797          	auipc	a5,0x17
    80005c86:	4867a783          	lw	a5,1158(a5) # 8001d108 <cons+0x98>
    ...
    while(cons.e != cons.w &&
    80005c96:	00017717          	auipc	a4,0x17
    80005c9a:	3da70713          	addi	a4,a4,986 # 8001d070 <cons>
    80005c9e:	0a072783          	lw	a5,160(a4)
    80005ca2:	09c72703          	lw	a4,156(a4)
          cons.buf[(cons.e-1) % INPUT_BUF_SIZE] != '\n'){
    80005ca6:	00017497          	auipc	s1,0x17
    80005caa:	3ca48493          	addi	s1,s1,970 # 8001d070 <cons>
    while(cons.e != cons.w &&
    ...
    if(cons.e != cons.w){
    80005ce2:	00017717          	auipc	a4,0x17
    80005ce6:	38e70713          	addi	a4,a4,910 # 8001d070 <cons>
    ...
    80005cf8:	00017717          	auipc	a4,0x17
    80005cfc:	40f72c23          	sw	a5,1048(a4) # 8001d110 <cons+0xa0>
      consputc(BACKSPACE);
    ...
    80005d1a:	e72080e7          	jalr	-398(ra) # 80005b88 <consputc>
      cons.buf[cons.e++ % INPUT_BUF_SIZE] = c;
    80005d1e:	00017797          	auipc	a5,0x17
    80005d22:	35278793          	addi	a5,a5,850 # 8001d070 <cons>
    ...
    80005d3e:	00e78c23          	sb	a4,24(a5)
        cons.w = cons.e;
    80005d42:	00017797          	auipc	a5,0x17
    80005d46:	3cc7a523          	sw	a2,970(a5) # 8001d10c <cons+0x9c>
        wakeup(&cons.r);
    80005d4a:	00017517          	auipc	a0,0x17
    80005d4e:	3be50513          	addi	a0,a0,958 # 8001d108 <cons+0x98>
    80005d52:	ffffc097          	auipc	ra,0xffffc
    80005d56:	80e080e7          	jalr	-2034(ra) # 80001560 <wakeup>
...
consoleinit(void)
{
  ...
  initlock(&cons.lock, "cons");
    ...
    80005d68:	a6458593          	addi	a1,a1,-1436 # 800087c8 <syscalls+0x3f8>
    80005d6c:	00017517          	auipc	a0,0x17
    80005d70:	30450513          	addi	a0,a0,772 # 8001d070 <cons>
  ...
  devsw[CONSOLE].read = consoleread;
    80005d84:	0000e797          	auipc	a5,0xe
    80005d88:	01478793          	addi	a5,a5,20 # 80013d98 <devsw>
...
printint(int xx, int base, int sign)
{
  ...
  do {
    ...
    80005dca:	a3260613          	addi	a2,a2,-1486 # 800087f8 <digits>
...
panic(char *s)
{
  ...
  pr.locking = 0;
    80005e58:	00017797          	auipc	a5,0x17
    80005e5c:	2c07ac23          	sw	zero,728(a5) # 8001d130 <pr+0x18>
  printf("panic: ");
    80005e60:	00003517          	auipc	a0,0x3
    80005e64:	97050513          	addi	a0,a0,-1680 # 800087d0 <syscalls+0x400>
  ...
  panicked = 1; // freeze uart output from other CPUs
    ...
    80005e90:	a4f72823          	sw	a5,-1456(a4) # 800088dc <panicked>
  for(;;)
...
0000000080005e96 <printf>:
{
  ...
  locking = pr.locking;
    80005ec8:	00017d97          	auipc	s11,0x17
    80005ecc:	268dad83          	lw	s11,616(s11) # 8001d130 <pr+0x18>
  if(locking)
  ...
  consputc('x');
    ...
    80005ef8:	904b0b13          	addi	s6,s6,-1788 # 800087f8 <digits>
    switch(c){
    80005efc:	07300c93          	li	s9,115
    80005f00:	06400c13          	li	s8,100
    80005f04:	a82d                	j	80005f3e <printf+0xa8>
    acquire(&pr.lock);
    80005f06:	00017517          	auipc	a0,0x17
    80005f0a:	21250513          	addi	a0,a0,530 # 8001d118 <pr>
    ...
    80005f1c:	8c850513          	addi	a0,a0,-1848 # 800087e0 <syscalls+0x410>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    80006016:	7c648493          	addi	s1,s1,1990 # 800087d8 <syscalls+0x408>
      for(; *s; s++)
  ...
  if(locking)
    ...
    80006062:	8082                	ret
    release(&pr.lock);
    80006064:	00017517          	auipc	a0,0x17
    80006068:	0b450513          	addi	a0,a0,180 # 8001d118 <pr>
...
printfinit(void)
{
  ...
  initlock(&pr.lock, "pr");
    80006080:	00017497          	auipc	s1,0x17
    80006084:	09848493          	addi	s1,s1,152 # 8001d118 <pr>
    80006088:	00002597          	auipc	a1,0x2
    8000608c:	76858593          	addi	a1,a1,1896 # 800087f0 <syscalls+0x420>
...
uartinit(void)
{
  ...
  initlock(&uart_tx_lock, "uart");
    ...
    800060dc:	73858593          	addi	a1,a1,1848 # 80008810 <digits+0x18>
    800060e0:	00017517          	auipc	a0,0x17
    800060e4:	05850513          	addi	a0,a0,88 # 8001d138 <uart_tx_lock>
...
uartputc_sync(int c)
{
  ...
  if(panicked){
    ...
    80006110:	7d07a783          	lw	a5,2000(a5) # 800088dc <panicked>
    for(;;)
      ;
  }
...
uartstart()
{
  while(1){
    ...
    80006148:	79c7b783          	ld	a5,1948(a5) # 800088e0 <uart_tx_r>
    8000614c:	00002717          	auipc	a4,0x2
    80006150:	79c73703          	ld	a4,1948(a4) # 800088e8 <uart_tx_w>
    80006154:	06f70a63          	beq	a4,a5,800061c8 <uartstart+0x84>
{
    ...
    8000616e:	00017a17          	auipc	s4,0x17
    80006172:	fcaa0a13          	addi	s4,s4,-54 # 8001d138 <uart_tx_lock>
    uart_tx_r += 1;
    80006176:	00002497          	auipc	s1,0x2
    8000617a:	76a48493          	addi	s1,s1,1898 # 800088e0 <uart_tx_r>
    if(uart_tx_w == uart_tx_r){
    8000617e:	00002997          	auipc	s3,0x2
    80006182:	76a98993          	addi	s3,s3,1898 # 800088e8 <uart_tx_w>
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
    ...
    800061a4:	3c0080e7          	jalr	960(ra) # 80001560 <wakeup>
...
00000000800061ca <uartputc>:
{
  ...
  acquire(&uart_tx_lock);
    800061dc:	00017517          	auipc	a0,0x17
    800061e0:	f5c50513          	addi	a0,a0,-164 # 8001d138 <uart_tx_lock>
    800061e4:	00000097          	auipc	ra,0x0
    800061e8:	1a0080e7          	jalr	416(ra) # 80006384 <acquire>
  if(panicked){
    800061ec:	00002797          	auipc	a5,0x2
    800061f0:	6f07a783          	lw	a5,1776(a5) # 800088dc <panicked>
    800061f4:	e7c9                	bnez	a5,8000627e <uartputc+0xb4>
  while(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    800061f6:	00002717          	auipc	a4,0x2
    800061fa:	6f273703          	ld	a4,1778(a4) # 800088e8 <uart_tx_w>
    800061fe:	00002797          	auipc	a5,0x2
    80006202:	6e27b783          	ld	a5,1762(a5) # 800088e0 <uart_tx_r>
    80006206:	02078793          	addi	a5,a5,32
    sleep(&uart_tx_r, &uart_tx_lock);
    8000620a:	00017997          	auipc	s3,0x17
    8000620e:	f2e98993          	addi	s3,s3,-210 # 8001d138 <uart_tx_lock>
    80006212:	00002497          	auipc	s1,0x2
    80006216:	6ce48493          	addi	s1,s1,1742 # 800088e0 <uart_tx_r>
  while(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    8000621a:	00002917          	auipc	s2,0x2
    8000621e:	6ce90913          	addi	s2,s2,1742 # 800088e8 <uart_tx_w>
    ...
    8000622e:	2d2080e7          	jalr	722(ra) # 800014fc <sleep>
  while(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
  ...
  uart_tx_buf[uart_tx_w % UART_TX_BUF_SIZE] = c;
    80006240:	00017497          	auipc	s1,0x17
    80006244:	ef848493          	addi	s1,s1,-264 # 8001d138 <uart_tx_lock>
  ...
  uart_tx_w += 1;
    ...
    80006258:	68e7ba23          	sd	a4,1684(a5) # 800088e8 <uart_tx_w>
  uartstart();
...
uartintr(void)
{
  ...
  acquire(&uart_tx_lock);
    800062c6:	00017497          	auipc	s1,0x17
    800062ca:	e7248493          	addi	s1,s1,-398 # 8001d138 <uart_tx_lock>
...
0000000080006384 <acquire>:
{
  ...
  lk->cpu = mycpu();
    ...
    800063cc:	45050513          	addi	a0,a0,1104 # 80008818 <digits+0x20>
...
pop_off(void)
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    8000641c:	40850513          	addi	a0,a0,1032 # 80008820 <digits+0x28>
    80006420:	00000097          	auipc	ra,0x0
    80006424:	a2c080e7          	jalr	-1492(ra) # 80005e4c <panic>
    panic("pop_off");
    80006428:	00002517          	auipc	a0,0x2
    8000642c:	41050513          	addi	a0,a0,1040 # 80008838 <digits+0x40>
...
0000000080006438 <release>:
{
  ...
  pop_off();
    ...
    80006474:	3d050513          	addi	a0,a0,976 # 80008840 <digits+0x48>
